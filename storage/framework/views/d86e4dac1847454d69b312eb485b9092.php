        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="requestQuoteModalLabel">
                    <?php echo e(trans('plugins/fob-request-quote::request-quote.modal_title')); ?>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                    <?php echo e(trans('plugins/fob-request-quote::request-quote.cancel')); ?>

                </button>
                <button type="submit" class="btn btn-primary" id="submitQuoteBtn" form="requestQuoteForm">
                    <span class="spinner-border spinner-border-sm d-none me-2" role="status" aria-hidden="true"></span>
                    <?php echo e(trans('plugins/fob-request-quote::request-quote.submit')); ?>
    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.error === false) {
                ...
                errorMessage.textContent = data.message || '<?php echo e(trans('plugins/fob-request-quote::request-quote.error_message')); ?>';
                errorMessage.classList.remove('d-none');
            }
        })
        .catch(error => {
            errorMessage.textContent = '<?php echo e(trans('plugins/fob-request-quote::request-quote.error_message')); ?>';
            errorMessage.classList.remove('d-none');
        })
        .finally(() => {
            submitBtn.disabled = false;
...
</script><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/gropart/platform/plugins/fob-request-quote/resources/views/modal.blade.php ENDPATH**/ ?>