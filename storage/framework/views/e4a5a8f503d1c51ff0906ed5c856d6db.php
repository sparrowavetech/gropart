    ...
    <div class="product-content-box">
        <?php if(is_plugin_active('marketplace') && $product->store->id): ?>
            <div class="sold-by-meta">
                <a href="<?php echo e($product->store->url); ?>" tabindex="0"><?php echo e($product->store->name); ?></a>
                <?php if($product->store->is_verified): ?>
                    <img class="verified-store" src="<?php echo e(asset('/storage/stores/verified.png')); ?>" alt="Verified" style="max-height: 14px; vertical-align: middle;">
                <?php endif; ?>
                <?php if($product->store->shop_category): ?>
                    <?php
                    ...
                    ?>
                    <small class="badge bg-warning text-dark" style="font-size: 10px; padding: 2px 4px;"><?php echo e($categoryLabel); ?></small>
                <?php endif; ?>
            </div>
        <?php endif; ?>
        ...
        <?php if((bool) ($product->is_cod_eligible ?? false)): ?>
            <div class="product-cod-label mt-1">
                <span class="badge bg-success" style="background-color: #28a745 !important; color: white; padding: 2px 5px; font-size: 10px; border-radius: 4px;">
                    <i class="ti ti-truck"></i> <?php echo e(__('COD Available')); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/gropart/platform/themes/farmart-child/partials/ecommerce/product-item.blade.php ENDPATH**/ ?>