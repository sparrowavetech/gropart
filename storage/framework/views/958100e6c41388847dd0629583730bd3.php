...
<?php endif; ?>
        ...
        <?php if(
            ...
            <?php if (isset($component)) { $__componentOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::alert','data' => ['type' => 'warning','title' => 'Warning','important' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::alert'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'warning','title' => 'Warning','important' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
                <div class="mt-3 mb-0">
                    ...
                    <ul class="mt-3 mb-0 ps-2">
                        <?php if($memoryLimit && $memoryLimit < $requiredMemoryLimit): ?>
                            <li class="mb-2"><code>memory_limit</code>: <code><?php echo e($memoryLimit); ?>M</code> =>
                                <code><?php echo e($requiredMemoryLimit); ?>M</code>
                            </li>
                        <?php endif; ?>

                        <?php if($maximumExecutionTime && $maximumExecutionTime < $requiredMaximumExecutionTime): ?>
                            <li class="mb-2"><code>max_execution_time</code>: <code><?php echo e($maximumExecutionTime); ?></code>
                                => <code><?php echo e($requiredMaximumExecutionTime); ?></code></li>
                        <?php endif; ?>
                    </ul>
...
<?php endif; ?>
        ...
        <?php if(!$activated): ?>
            <?php if (isset($component)) { $__componentOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalecda78b9fe8916cbd83b85e55a8b7a1c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::alert','data' => ['type' => 'warning','title' => 'You haven\'t activated your license yet!','important' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::alert'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'warning','title' => 'You haven\'t activated your license yet!','important' => true]); ?>
                <p class="mt-3 mb-0">
...
<?php endif; ?>
        ...
        <?php if($isOutdated && $latestUpdate): ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        Latest changelog (<?php echo e(BaseHelper::formatDate($latestUpdate->releasedDate)); ?>)
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.body.index','data' => ['dir' => 'ltr']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['dir' => 'ltr']); ?>
                    <h3 class="text-success mb-4">
                        <?php echo e(trans('core/base::system.new_version_available', ['version' => $latestUpdate->version, 'date' => BaseHelper::formatDate($latestUpdate->releasedDate)])); ?>
...
<?php endif; ?>
        ...
        <?php if(request()->query('no-ajax') != 1): ?>
            <?php if (isset($component)) { $__componentOriginalc107e2f90dff5eb05519f33918d2c807 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc107e2f90dff5eb05519f33918d2c807 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.index','data' => ['class' => 'mb-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::card'); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>OneClick System Updater <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal61297c2b6766060b621d6f9a17b28154)): ?>
<?php $attributes = $__attributesOriginal61297c2b6766060b621d6f9a17b28154; ?>
<?php unset($__attributesOriginal61297c2b6766060b621d6f9a17b28154); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php if(!empty($latestUpdate)): ?>
                        <system-update-component
                            update-url="<?php echo e(route('system.updater.post')); ?>"
                            update-id="<?php echo e($latestUpdate->updateId); ?>"
                            version="<?php echo e($latestUpdate->version); ?>"
                            first-step="<?php echo e(SystemUpdaterStepEnum::firstStep()); ?>"
                            first-step-message="<?php echo e(SystemUpdaterStepEnum::DOWNLOAD()->message()); ?>"
                            last-step="<?php echo e(SystemUpdaterStepEnum::lastStep()); ?>"
                            :is-outdated="<?php echo e(Js::encode($isOutdated)); ?>"
                            :is-activated="<?php echo e(Js::encode($activated)); ?>"
                            v-slot="{ performUpdate }"
                        >
                            <?php if(!$isOutdated): ?>
                                <h3 class="text-success"><?php echo e(trans('core/base::system.system_up_to_date')); ?></h3>
                            <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::modal.action','data' => ['id' => 'system-updater-confirm-modal','type' => 'warning','title' => 'Are you sure?','description' => 'Your license has not been activated yet! You might not receive the latest updates.','submitButtonLabel' => 'Yes, update it!','submitButtonAttrs' => ['@click' => 'performUpdate'],'cancelButton' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'system-updater-confirm-modal','type' => 'warning','title' => 'Are you sure?','description' => 'Your license has not been activated yet! You might not receive the latest updates.','submit-button-label' => 'Yes, update it!','submit-button-attrs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['@click' => 'performUpdate']),'cancel-button' => true]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <p class="mb-0 text-success"><?php echo e(trans('core/base::system.system_up_to_date')); ?></p>
                    <?php endif; ?>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4fdb92edf089f19cd17d37829580c9a6)): ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Manual System Updater <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal61297c2b6766060b621d6f9a17b28154)): ?>
<?php $attributes = $__attributesOriginal61297c2b6766060b621d6f9a17b28154; ?>
<?php unset($__attributesOriginal61297c2b6766060b621d6f9a17b28154); ?>
...
<?php endif; ?>
                    ...
                    <form
                        action="<?php echo e(route('system.updater')); ?>?no-ajax=1&update_id=<?php echo e($latestUpdate->updateId); ?>&version=<?php echo e($latestUpdate->version); ?>"
                        method="POST"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::step.index','data' => ['vertical' => true,'counter' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['vertical' => true,'counter' => true]); ?>
                            <?php $__currentLoopData = SystemUpdaterStepEnum::labels(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($step === SystemUpdaterStepEnum::lastStep()) break; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::step.item','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <div class="h4 mb-2"><?php echo e($label); ?></div>
                                    <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['class' => 'mb-3','type' => 'submit','name' => 'step_name','value' => ''.e($step).'','color' => 'primary','dataUpdatingText' => 'Updating...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mb-3','type' => 'submit','name' => 'step_name','value' => ''.e($step).'','color' => 'primary','data-updating-text' => 'Updating...']); ?>
                                        <?php echo e(trans('core/base::system.run')); ?>
...
<?php endif; ?>
        ...
        <?php if(isset($isOutdated) && isset($latestUpdate) && !$isOutdated && $latestUpdate): ?>
            <?php if (isset($component)) { $__componentOriginalc107e2f90dff5eb05519f33918d2c807 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc107e2f90dff5eb05519f33918d2c807 = $attributes; } ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/gropart/platform/core/base/resources/views/system/updater.blade.php ENDPATH**/ ?>