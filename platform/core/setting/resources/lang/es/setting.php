...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Mostrar asistente de inicio',
            'show_get_started_helper' => 'Mostrar el asistente de configuración de inicio en el panel de control para nuevas instalaciones',
    ...
    'email' => [
        ...
        'sendgrid_key' => 'Clave API',
        'sendgrid_key_placeholder' => 'Ej: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Tu clave API de SendGrid',
        'default_locale' => 'Idioma predeterminado del correo electrónico',
        'default_locale_helper' => 'Seleccione el idioma predeterminado para los correos electrónicos de clientes. Cuando se establece en "Auto", el sistema usará el idioma predeterminado del sitio. Esto evita que los correos electrónicos de clientes se envíen en el idioma del panel del empleado.',
        'default_locale_auto' => 'Auto (usar idioma predeterminado del sitio)',
        ...
        'template_test' => 'Correo electrónico de prueba',
        'template_test_description' => 'Plantilla para correos electrónicos de prueba enviados desde la configuración de correo electrónico',
        'template_test_subject' => 'Correo electrónico de prueba de {{ site_title }}',
        'test_email_title' => 'Prueba de configuración de correo electrónico',
        'test_email_message' => 'Este es un correo electrónico de prueba enviado desde :site_title para verificar que la configuración de correo electrónico está correctamente configurada.',
        'test_email_success_message' => 'Si recibió este correo electrónico, significa que su configuración SMTP está funcionando correctamente.',
        'default' => 'Por defecto',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => '¿Está habilitado Wasabi CDN?',
        'wasabi_cdn_enabled_helper' => 'Cuando esté habilitado, los archivos multimedia se entregarán a través de una CDN para una entrega de contenido global más rápida. Debe configurar un dominio CDN personalizado a continuación.',
        'media_wasabi_cdn_custom_domain' => 'Dominio personalizado de Wasabi CDN',
        'media_wasabi_cdn_custom_domain_placeholder' => 'https://tu-dominio-personalizado.com',
        ...
        'image_quality_helper' => 'Establece la calidad de codificación de imagen (70-100). Valores más bajos producen archivos más pequeños. El valor predeterminado es 75. Se aplica a imágenes subidas, miniaturas e imágenes con marca de agua.',
    ...
    'generate_thumbnails_override' => 'Sobrescribir miniaturas existentes',
    'generate_thumbnails_override_helper' => 'Si está marcado, las miniaturas existentes se regenerarán. De lo contrario, solo se crearán las miniaturas faltantes.',
    'generate_thumbnails_batch_size' => 'Tamaño del lote',
    'generate_thumbnails_batch_size_helper' => 'Número de imágenes a procesar por lote. Aumente para un procesamiento más rápido si su servidor puede manejarlo.',
    'generate_thumbnails_start_offset' => 'Desplazamiento inicial',
    'generate_thumbnails_start_offset_helper' => 'Omitir esta cantidad de imágenes desde el principio. Útil para reanudar después de un tiempo de espera agotado.',
