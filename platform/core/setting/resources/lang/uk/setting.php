...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Показати майстер початку роботи',
            'show_get_started_helper' => 'Відображати майстер налаштування початку роботи на панелі керування для нових встановлень',
    ...
    'email' => [
        ...
        'sendgrid_key_placeholder' => 'Приклад: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Ваш API ключ SendGrid',
        'default_locale' => 'Мова електронної пошти за замовчуванням',
        'default_locale_helper' => 'Виберіть мову за замовчуванням для листів клієнтам. При встановленні "Авто" система використовуватиме мову сайту за замовчуванням. Це запобігає надсиланню листів клієнтам мовою панелі керування співробітника.',
        'default_locale_auto' => 'Авто (використовувати мову сайту за замовчуванням)',
        ...
        'template_test' => 'Тестовий лист',
        'template_test_description' => 'Шаблон для тестових листів, надісланих з налаштувань електронної пошти',
        'template_test_subject' => 'Тестовий лист від {{ site_title }}',
        'test_email_title' => 'Тест конфігурації електронної пошти',
        'test_email_message' => 'Це тестовий лист, надісланий з :site_title для перевірки правильності налаштувань електронної пошти.',
        'test_email_success_message' => 'Якщо ви отримали цей лист, це означає, що ваша конфігурація SMTP працює правильно.',
        'default' => 'За замовчуванням',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Чи ввімкнено Wasabi CDN?',
        'wasabi_cdn_enabled_helper' => 'Якщо ввімкнено, медіафайли обслуговуватимуться через CDN для швидшої глобальної доставки вмісту. Ви повинні налаштувати спеціальний домен CDN нижче.',
        'media_wasabi_cdn_custom_domain' => 'Спеціальний домен Wasabi CDN',
        ...
        'image_quality_helper' => 'Встановіть якість кодування зображень (70-100). Нижчі значення створюють менші файли. За замовчуванням 75. Застосовується до завантажених зображень, мініатюр та зображень з водяним знаком.',
    ...
    'generate_thumbnails_override' => 'Перезаписати існуючі мініатюри',
    'generate_thumbnails_override_helper' => 'Якщо позначено, існуючі мініатюри будуть перегенеровані. Інакше будуть створені лише відсутні мініатюри.',
    'generate_thumbnails_batch_size' => 'Розмір пакета',
    'generate_thumbnails_batch_size_helper' => 'Кількість зображень для обробки за один пакет. Збільшіть для швидшої обробки, якщо ваш сервер може це витримати.',
    'generate_thumbnails_start_offset' => 'Початковий зсув',
    'generate_thumbnails_start_offset_helper' => 'Пропустити цю кількість зображень з початку. Корисно для відновлення після тайм-ауту.',
