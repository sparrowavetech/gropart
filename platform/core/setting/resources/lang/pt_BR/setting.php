...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started_helper' => 'Exibir o assistente de configuração de início no painel para novas instalações',
    ...
    'email' => [
        ...
        'sendgrid_key_helper' => 'Sua chave de API do SendGrid',
        ...
        'test_email_message' => 'Este é um e-mail de teste enviado de :site_title para verificar se as suas configurações de e-mail estão configuradas corretamente.',
        'test_email_success_message' => 'Se você recebeu este e-mail, isso significa que sua configuração SMTP está funcionando corretamente.',
        'default' => 'Padrão',
    ...
    'media' => [
        ...
        'image_quality_helper' => 'Defina a qualidade de codificação de imagem (70-100). Valores mais baixos produzem arquivos menores. O padrão é 75. Aplica-se a imagens enviadas, miniaturas e imagens com marca d\'água.',
    ...
    'generate_thumbnails_override_helper' => 'Se marcado, as miniaturas existentes serão regeneradas. Caso contrário, apenas as miniaturas ausentes serão criadas.',
    'generate_thumbnails_batch_size' => 'Tamanho do lote',
    'generate_thumbnails_batch_size_helper' => 'Número de imagens a processar por lote. Aumente para processamento mais rápido se o seu servidor puder lidar com isso.',
    'generate_thumbnails_start_offset' => 'Deslocamento inicial',
    'generate_thumbnails_start_offset_helper' => 'Pular esta quantidade de imagens do início. Útil para retomar após um tempo limite.',
