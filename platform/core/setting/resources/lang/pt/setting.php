...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Mostrar assistente de início',
            'show_get_started_helper' => 'Mostrar o assistente de configuração de início no painel para novas instalações',
    ...
    'email' => [
        ...
        'sendgrid_key' => 'Chave da API',
        'sendgrid_key_placeholder' => 'Ex.: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'A sua chave API do SendGrid',
        'default_locale' => 'Idioma padrão do e-mail',
        'default_locale_helper' => 'Selecione o idioma padrão para e-mails de clientes. Quando definido como "Auto", o sistema usará o idioma padrão do site. Isso impede que e-mails de clientes sejam enviados no idioma do painel do funcionário.',
        'default_locale_auto' => 'Auto (usar idioma padrão do site)',
        ...
        'template_test' => 'E-mail de teste',
        'template_test_description' => 'Modelo para e-mails de teste enviados a partir das configurações de e-mail',
        'template_test_subject' => 'E-mail de teste de {{ site_title }}',
        'test_email_title' => 'Teste de configuração de e-mail',
        'test_email_message' => 'Este é um e-mail de teste enviado de :site_title para verificar que as suas configurações de e-mail estão corretamente configuradas.',
        'test_email_success_message' => 'Se recebeu este e-mail, significa que a sua configuração SMTP está a funcionar corretamente.',
        'default' => 'Padrão',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Ativar CDN do Wasabi?',
        'wasabi_cdn_enabled_helper' => 'Quando ativado, os ficheiros de mídia serão entregues através de um CDN para melhorar a distribuição global. Configure abaixo um domínio CDN personalizado.',
        'media_wasabi_cdn_custom_domain' => 'Domínio personalizado do Wasabi CDN',
        'media_wasabi_cdn_custom_domain_placeholder' => 'https://o-seu-dominio-personalizado.com',
        ...
        'image_quality_helper' => 'Defina a qualidade de codificação de imagem (70-100). Valores mais baixos produzem ficheiros mais pequenos. O padrão é 75. Aplica-se a imagens carregadas, miniaturas e imagens com marca de água.',
    ...
    'generate_thumbnails_override' => 'Substituir miniaturas existentes',
    'generate_thumbnails_override_helper' => 'Se marcado, as miniaturas existentes serão regeneradas. Caso contrário, apenas as miniaturas em falta serão criadas.',
    'generate_thumbnails_batch_size' => 'Tamanho do lote',
    'generate_thumbnails_batch_size_helper' => 'Número de imagens a processar por lote. Aumente para processamento mais rápido se o seu servidor conseguir suportar.',
    'generate_thumbnails_start_offset' => 'Deslocamento inicial',
    'generate_thumbnails_start_offset_helper' => 'Ignorar este número de imagens desde o início. Útil para retomar após um tempo limite.',
