...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Afficher l\'assistant de démarrage',
            'show_get_started_helper' => 'Afficher l\'assistant de configuration de démarrage sur le tableau de bord pour les nouvelles installations',
    ...
    'email' => [
        ...
        'sendgrid_key' => 'Clé API',
        'sendgrid_key_placeholder' => 'Ex: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Votre clé API SendGrid',
        'default_locale' => 'Langue par défaut des e-mails',
        'default_locale_helper' => 'Sélectionnez la langue par défaut pour les e-mails clients. Lorsque défini sur "Auto", le système utilisera la langue par défaut du site. Cela empêche l\'envoi des e-mails clients dans la langue du tableau de bord de l\'employé.',
        'default_locale_auto' => 'Auto (utiliser la langue par défaut du site)',
        ...
        'template_test' => 'E-mail de test',
        'template_test_description' => 'Modèle pour les e-mails de test envoyés depuis les paramètres de messagerie',
        'template_test_subject' => 'E-mail de test de {{ site_title }}',
        'test_email_title' => 'Test de configuration de l\'e-mail',
        'test_email_message' => 'Ceci est un e-mail de test envoyé depuis :site_title pour vérifier que vos paramètres de messagerie sont correctement configurés.',
        'test_email_success_message' => 'Si vous avez reçu cet e-mail, cela signifie que votre configuration SMTP fonctionne correctement.',
        'default' => 'Défaut',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Le CDN Wasabi est-il activé ?',
        'wasabi_cdn_enabled_helper' => 'Lorsqu\'il est activé, les fichiers multimédias seront diffusés via un CDN pour une diffusion plus rapide du contenu mondial. Vous devez configurer un domaine CDN personnalisé ci-dessous.',
        'media_wasabi_cdn_custom_domain' => 'Domaine personnalisé Wasabi CDN',
        'media_wasabi_cdn_custom_domain_placeholder' => 'https://votre-domaine-personnalisé.com',
        ...
        'image_quality_helper' => 'Définissez la qualité d\'encodage des images (70-100). Des valeurs plus basses produisent des fichiers plus petits. La valeur par défaut est 75. S\'applique aux images téléchargées, miniatures et images avec filigrane.',
    ...
    'generate_thumbnails_override' => 'Écraser les miniatures existantes',
    'generate_thumbnails_override_helper' => 'Si coché, les miniatures existantes seront régénérées. Sinon, seules les miniatures manquantes seront créées.',
    'generate_thumbnails_batch_size' => 'Taille du lot',
    'generate_thumbnails_batch_size_helper' => 'Nombre d\'images à traiter par lot. Augmentez pour un traitement plus rapide si votre serveur peut le gérer.',
    'generate_thumbnails_start_offset' => 'Décalage de départ',
    'generate_thumbnails_start_offset_helper' => 'Ignorer ce nombre d\'images depuis le début. Utile pour reprendre après un délai d\'expiration.',
