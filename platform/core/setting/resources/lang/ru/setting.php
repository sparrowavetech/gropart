...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Показать мастер начала работы',
            'show_get_started_helper' => 'Отображать мастер настройки начала работы на панели управления для новых установок',
    ...
    'email' => [
        ...
        'sendgrid_key_placeholder' => 'Пример: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Ваш API ключ SendGrid',
        'default_locale' => 'Язык электронной почты по умолчанию',
        'default_locale_helper' => 'Выберите язык по умолчанию для электронных писем клиентам. При установке "Авто" система будет использовать язык сайта по умолчанию. Это предотвращает отправку электронных писем клиентам на языке панели управления сотрудника.',
        'default_locale_auto' => 'Авто (использовать язык сайта по умолчанию)',
        ...
        'template_test' => 'Тестовое письмо',
        'template_test_description' => 'Шаблон для тестовых писем, отправляемых из настроек электронной почты',
        'template_test_subject' => 'Тестовое письмо от {{ site_title }}',
        'test_email_title' => 'Тест конфигурации электронной почты',
        'test_email_message' => 'Это тестовое письмо, отправленное с :site_title для проверки правильности настроек электронной почты.',
        'test_email_success_message' => 'Если вы получили это письмо, значит ваша конфигурация SMTP работает правильно.',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Включен ли Wasabi CDN?',
        'wasabi_cdn_enabled_helper' => 'Если этот параметр включен, медиафайлы будут передаваться через CDN для более быстрой глобальной доставки контента. Ниже вам необходимо настроить собственный домен CDN.',
        'media_wasabi_cdn_custom_domain' => 'Персональный домен Wasabi CDN',
        'media_wasabi_cdn_custom_domain_placeholder' => 'https://ваш-пользовательский-домен.com',
        ...
        'image_quality_helper' => 'Установите качество кодирования изображений (70-100). Более низкие значения создают файлы меньшего размера. По умолчанию 75. Применяется к загруженным изображениям, миниатюрам и изображениям с водяным знаком.',
    ...
    'generate_thumbnails_override' => 'Перезаписать существующие миниатюры',
    'generate_thumbnails_override_helper' => 'Если отмечено, существующие миниатюры будут перегенерированы. В противном случае будут созданы только отсутствующие миниатюры.',
    'generate_thumbnails_batch_size' => 'Размер пакета',
    'generate_thumbnails_batch_size_helper' => 'Количество изображений для обработки за один пакет. Увеличьте для более быстрой обработки, если ваш сервер справится.',
    'generate_thumbnails_start_offset' => 'Начальное смещение',
    'generate_thumbnails_start_offset_helper' => 'Пропустить это количество изображений с начала. Полезно для возобновления после тайм-аута.',
