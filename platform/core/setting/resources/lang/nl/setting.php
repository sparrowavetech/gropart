...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Aan de slag-wizard tonen',
            'show_get_started_helper' => 'Toon de Aan de slag-installatiewizard op het dashboard voor nieuwe installaties',
    ...
    'email' => [
        ...
        'sendgrid_key_placeholder' => 'Bijv: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Uw SendGrid API-sleutel',
        'default_locale' => 'Standaard e-mailtaal',
        'default_locale_helper' => 'Selecteer de standaardtaal voor klant-e-mails. Wanneer ingesteld op "Auto", zal het systeem de standaardtaal van de site gebruiken. Dit voorkomt dat klant-e-mails worden verzonden in de dashboardtaal van de medewerker.',
        'default_locale_auto' => 'Auto (standaardtaal van de site gebruiken)',
        ...
        'template_test_description' => 'Template voor test e-mails verzonden vanuit de e-mailinstellingen',
        'template_test_subject' => 'Test e-mail van {{ site_title }}',
        'test_email_title' => 'E-mailconfiguratie test',
        'test_email_message' => 'Dit is een test e-mail verzonden vanaf :site_title om te verifiëren dat uw e-mailinstellingen correct zijn geconfigureerd.',
        'test_email_success_message' => 'Als u deze e-mail heeft ontvangen, betekent dit dat uw SMTP-configuratie correct werkt.',
        'default' => 'Default',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Is Wasabi CDN ingeschakeld?',
        'wasabi_cdn_enabled_helper' => 'Indien ingeschakeld, worden mediabestanden via een CDN aangeboden voor een snellere wereldwijde levering van inhoud. U moet hieronder een aangepast CDN-domein configureren.',
        'media_wasabi_cdn_custom_domain' => 'Wasabi CDN-aangepast domein',
        'media_wasabi_cdn_custom_domain_placeholder' => 'https://uw-aangepaste-domein.com',
        ...
        'image_quality_helper' => 'Stel de kwaliteit in voor beeldcodering (70-100). Lagere waarden produceren kleinere bestanden. Standaard is 75. Geldt voor geüploade afbeeldingen, miniaturen en afbeeldingen met watermerk.',
    ...
    'generate_thumbnails_override' => 'Bestaande miniaturen overschrijven',
    'generate_thumbnails_override_helper' => 'Indien aangevinkt, worden bestaande miniaturen opnieuw gegenereerd. Anders worden alleen ontbrekende miniaturen aangemaakt.',
    'generate_thumbnails_batch_size' => 'Batchgrootte',
    'generate_thumbnails_batch_size_helper' => 'Aantal afbeeldingen per batch. Verhoog voor snellere verwerking als uw server het aankan.',
    'generate_thumbnails_start_offset' => 'Startpositie',
    'generate_thumbnails_start_offset_helper' => 'Sla dit aantal afbeeldingen over vanaf het begin. Handig om te hervatten na een timeout.',
