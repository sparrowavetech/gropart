...
return [
    ...
    'email_reminder_template' => '<h3>:name 様</h3><p>お客様のアカウントのパスワードを再設定するリクエストを受け付けました。手続きを完了するには、以下のリンクをクリックしてください。</p><p><a href=":link">今すぐパスワードを再設定する</a></p><p>パスワードの再設定をリクエストしていない場合は、このメールを無視してください。</p><p>このメールは受信から60分間有効です。</p>',
    ...
    'first_name_placeholder' => 'ファーストネームを入力してください',
    'last_name_placeholder' => '苗字を入力してください',
    'password_placeholder' => 'パスワードを入力してください',
    'password_confirmation' => 'パスワードを再入力してください',
    'password_confirmation_placeholder' => 'パスワードを再入力してください',
    'select_role' => '役割の選択',
