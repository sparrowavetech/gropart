        ...
        'email' => [
            ...
            'templates' => [
                'password_reminder' => [
                    ...
                    'email_title' => 'パスワードリセットのご案内',
                    'email_message' => 'お客様のアカウントについてパスワードのリセットリクエストを受け付けたため、このメールをお送りしています。',
                    'button_text' => 'パスワードをリセットする',
                    'trouble_text' => '「パスワードをリセットする」ボタンがクリックできない場合は、以下の URL をコピーしてブラウザのアドレスバーに貼り付けてください: <a href=":reset_link">:reset_link</a>。パスワードのリセットをリクエストしていない場合は、このメールを無視してください。ご不明な点がありましたらお問い合わせください。',
                ],
            ],
        ],
    ],
