...
return [
    'settings' => [
        ...
        'content_types_heading' => 'Sitemap Content Types',
        'content_types_description' => 'Choose which content types to include in the sitemap. Disabled content types will be excluded from the sitemap and return a 404 if accessed directly.',
        'enable_pages_sitemap' => 'Include pages?',
        'enable_pages_sitemap_help' => 'Include static pages in the sitemap.',
        'enable_blog_posts_sitemap' => 'Include blog posts?',
        'enable_blog_posts_sitemap_help' => 'Include blog posts in the sitemap.',
        'enable_blog_categories_sitemap' => 'Include blog categories?',
        'enable_blog_categories_sitemap_help' => 'Include blog category pages in the sitemap.',
        'enable_blog_tags_sitemap' => 'Include blog tags?',
        'enable_blog_tags_sitemap_help' => 'Include blog tag pages in the sitemap.',
        'enable_galleries_sitemap' => 'Include galleries?',
        'enable_galleries_sitemap_help' => 'Include gallery pages in the sitemap.',
        'enable_stores_sitemap' => 'Include stores?',
        'enable_stores_sitemap_help' => 'Include store pages in the sitemap.',
        ...
        'llms_txt_page_limit' => 'Pages listed in llms.txt',
        'llms_txt_post_limit' => 'Blog posts listed in llms.txt',
        'llms_txt_limit_help' => 'Maximum number of items listed for this content type. When there are more, llms.txt points to the XML sitemap for full coverage.',
        'enable_llms_full_txt' => 'Enable llms-full.txt?',
        'enable_llms_full_txt_help' => 'When enabled, :url publishes the full text of your pages and posts in one file, not just links. Only published content is included, but it does republish complete article bodies - leave this off if you do not want that. Returns 404 while disabled.',
        'ai_crawler_heading' => 'AI Crawlers',
        'ai_crawler_description' => 'Declare which AI crawlers may access your site. Saving writes the matching rules into robots.txt, between managed markers - your own rules in that file are left untouched.',
        'ai_crawler_policy' => 'AI crawler policy',
        'ai_crawler_policy_allow_all' => 'Allow all crawlers',
        'ai_crawler_policy_block_training' => 'Block training crawlers (keep AI search & citations)',
        'ai_crawler_policy_block_all' => 'Block all AI crawlers',
        'ai_crawler_robots_not_writable' => 'The AI crawler policy could not be applied: :path is not writable. Make the file writable and save again, otherwise the policy has no effect.',
        'ai_crawler_policy_help' => 'Training crawlers (GPTBot, ClaudeBot, CCBot, Bytespider, ...) collect content to train models. Retrieval crawlers (OAI-SearchBot, ChatGPT-User, Claude-User, PerplexityBot, ...) fetch a page to answer a question and usually link back - blocking those also gives up AI citations and referral traffic. Note: robots.txt is advisory, crawlers choose whether to honour it; real enforcement needs a rule at your web server, CDN or firewall.',
    ],
];
