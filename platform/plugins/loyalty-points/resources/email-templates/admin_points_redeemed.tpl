        ...
        <tbody>
            <tr>
                <td class="bb-content bb-pb-0" align="center">
                    ...
                    <h1 class="bb-text-center bb-m-0 bb-mt-md">{{ 'plugins/loyalty-points::email-templates.admin_points_redeemed_heading' | trans }}</h1>
                </td>
            </tr>
            <tr>
                <td class="bb-content bb-text-center">
                    <p>{{ 'plugins/loyalty-points::email-templates.admin_points_redeemed_message' | trans({'customer': customer_name, 'points': points_redeemed, 'discount': discount_amount, 'order_code': order_code}) }}</p>
                </td>
            </tr>
            <tr>
