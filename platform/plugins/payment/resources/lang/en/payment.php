...
return [
    ...
    'could_not_get_stripe_payment_details' => 'Could not get Stripe payment details.',
    ...
    'refund_amount_is_invalid' => 'Refund amount is invalid.',
    'paid_at' => 'Paid At',
    ...
    'payment_created' => 'You have created a payment #:charge_id via :channel :time : :amount',
    'processing_please_wait' => 'Processing. Please wait...',
    'error' => 'Error',
    'checkout' => 'Checkout',
    'show_full_json' => 'Show Full JSON',
    'full_log_data' => 'Full Log Data',
    'currency_not_supported' => ":name doesn't support :currency. List of currencies supported by :name: :currencies.",
    'please_switch_currency' => 'Please switch currency to any supported currency',
    'payment_with' => 'Payment with :paymentType',
];
