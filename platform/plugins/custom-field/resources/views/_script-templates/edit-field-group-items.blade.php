<script id="_options-repeater_template" type="text/x-custom-template">
    <div class="line" data-option="repeater">
        <div class="col-3">
            <h5>{!! clean(trans('plugins/custom-field::base.form.repeater_fields')) !!}</h5>
        </div>
        <div class="col-9">
            <h5>{!! clean(trans('plugins/custom-field::base.form.repeater_fields')) !!}</h5>
...
<script id="_options-defaultvalue_template" type="text/x-custom-template">
    <div class="line" data-option="defaultvalue">
        <div class="col-3">
            <h5>{!! clean(trans('plugins/custom-field::base.form.default_value')) !!}</h5>
            <p>{!! clean(trans('plugins/custom-field::base.form.default_value_helper')) !!}</p>
        </div>
        <div class="col-9">
            <h5>{!! clean(trans('plugins/custom-field::base.form.default_value')) !!}</h5>
...
<script id="_options-placeholdertext_template" type="text/x-custom-template">
    <div class="line" data-option="placeholdertext">
        <div class="col-3">
            <h5>{!! clean(trans('plugins/custom-field::base.form.placeholder')) !!}</h5>
            <p>{!! clean(trans('plugins/custom-field::base.form.placeholder_helper')) !!}</p>
        </div>
        <div class="col-9">
            <h5>{!! clean(trans('plugins/custom-field::base.form.placeholder')) !!}</h5>
            <input type="text" class="form-control" placeholder="" value="">
...
<script id="_options-rows_template" type="text/x-custom-template">
    <div class="line" data-option="rows">
        <div class="col-3">
            <h5>{!! clean(trans('plugins/custom-field::base.form.rows')) !!}</h5>
            <p>{!! clean(trans('plugins/custom-field::base.form.rows_helper')) !!}</p>
        </div>
        <div class="col-9">
            <h5>{!! clean(trans('plugins/custom-field::base.form.rows')) !!}</h5>
...
<script id="_options-selectchoices_template" type="text/x-custom-template">
    <div class="line" data-option="selectchoices">
        <div class="col-3">
            <h5>{!! clean(trans('plugins/custom-field::base.form.choices')) !!}</h5>
            <p>{!! clean(trans('plugins/custom-field::base.form.choices_helper')) !!}</p>
        </div>
        <div class="col-9">
            <h5>{!! clean(trans('plugins/custom-field::base.form.choices')) !!}</h5>
            <textarea class="form-control" rows="5"></textarea>
...
<script id="_options-buttonlabel_template" type="text/x-custom-template">
    <div class="line" data-option="buttonlabel">
        <div class="col-3">
            <h5>{!! clean(trans('plugins/custom-field::base.form.button_label')) !!}</h5>
        </div>
        <div class="col-9">
            <h5>{!! clean(trans('plugins/custom-field::base.form.button_label')) !!}</h5>
    ...
    <li class="ui-sortable-handle active">
        <div class="field-column">
            <div class="row">
                ...
                <div class="text col-4 field-type">{!! clean(trans('plugins/custom-field::base.form.types.text')) !!}</div>
            </div>
        ...
        <div class="item-details">
            <div class="line" data-option="title">
                <div class="col-3">
                    <h5>{!! clean(trans('plugins/custom-field::base.form.field_label')) !!}</h5>
                    <p>{!! clean(trans('plugins/custom-field::base.form.field_label_helper')) !!}</p>
                </div>
                <div class="col-9">
                    <h5>{!! clean(trans('plugins/custom-field::base.form.field_label')) !!}</h5>
            ...
            <div class="line" data-option="slug">
                <div class="col-3">
                    <h5>{!! clean(trans('plugins/custom-field::base.form.field_name')) !!}</h5>
                    <p>{!! clean(trans('plugins/custom-field::base.form.field_name_helper')) !!}</p>
                </div>
                <div class="col-9">
                    <h5>{!! clean(trans('plugins/custom-field::base.form.field_name')) !!}</h5>
                    <input type="text" class="form-control" placeholder="" value="">
            ...
            <div class="line" data-option="type">
                <div class="col-3">
                    <h5>{!! clean(trans('plugins/custom-field::base.form.field_type')) !!}</h5>
                    <p>{!! clean(trans('plugins/custom-field::base.form.field_type_helper')) !!}</p>
                </div>
                <div class="col-9">
                    <h5>{!! clean(trans('plugins/custom-field::base.form.field_type')) !!}</h5>
            ...
            <div class="line" data-option="instructions">
                <div class="col-3">
                    <h5>{!! clean(trans('plugins/custom-field::base.form.field_instructions')) !!}</h5>
                    <p>{!! clean(trans('plugins/custom-field::base.form.field_instructions_helper')) !!}</p>
                </div>
                <div class="col-9">
                    <h5>{!! clean(trans('plugins/custom-field::base.form.field_instructions')) !!}</h5>
                    <textarea class="form-control" rows="5"></textarea>
