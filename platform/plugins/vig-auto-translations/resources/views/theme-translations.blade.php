                                ...
                                <tr>
                                    ...
                                    <td style="width: 20%">
                                        <div class="d-flex flex-row">
                                            @if ($group['locale'] !== 'en')
                                                @if ($key === $translation)
                                                    <button class="btn btn-primary btn-begin-translate-auto" data-name="{{ $key }}" data-reset="0" type="button" title="{{ trans('plugins/vig-auto-translations::vig-auto-translations.translate') }}">
                                                        <i class="fa-sharp fa-solid fa-language"></i> {{ trans('plugins/vig-auto-translations::vig-auto-translations.translate') }}
                                                    </button>
                                                @else
                                                    <button class="btn btn-warning btn-begin-translate-auto" data-name="{{ $key }}" data-reset="1" type="button" title="{{ trans('plugins/vig-auto-translations::vig-auto-translations.reset') }}">
