...
class PincodeRepository extends RepositoriesAbstract implements PincodeInterface
{
    /**
     * {@inheritDoc}
     */
    public function filters($keyword, $limit = 10, array $with = [], array $select = ['pincode.*'])
    {
        $data = $this->model
