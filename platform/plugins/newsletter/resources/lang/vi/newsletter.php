...
return [
    ...
    'settings' => [
        'email' => [
            'templates' => [
                ...
                'to_user' => [
                    ...
                    'subject' => '{{ site_title }}: Xác nhận đăng ký!',
        ...
        'sendgrid_list_id' => 'ID Danh sách SendGrid',
    ...
    'email_templates' => [
        ...
        'admin_new_subscriber_title' => 'Người đăng ký mới',
        'admin_new_subscriber_message' => 'Người dùng mới đã đăng ký nhận bản tin của bạn:',
        ...
        'subscriber_unsubscribe_instruction' => 'Để hủy đăng ký nhận bản tin, hãy nhấp vào :newsletter_unsubscribe_link',
    ],

    'enter_your_email' => 'Nhập email của bạn',
    'subscribe' => 'Đăng ký',
    'newsletter_popup' => 'Cửa sổ bật lên bản tin',
    'enable_newsletter_popup' => 'Bật cửa sổ bật lên bản tin',
    'popup_image' => 'Hình ảnh máy tính',
    'popup_image_helper' => 'Dành cho thiết bị có chiều rộng từ 1200px trở lên.',
    'popup_tablet_image' => 'Hình ảnh máy tính bảng',
    'popup_tablet_image_helper' => 'Dành cho thiết bị có chiều rộng từ 768px đến 1199px. Nếu trống, sẽ sử dụng hình ảnh máy tính.',
    'popup_mobile_image' => 'Hình ảnh di động',
    'popup_mobile_image_helper' => 'Dành cho thiết bị có chiều rộng dưới 768px. Nếu trống, sẽ sử dụng hình ảnh máy tính bảng.',
    'popup_title' => 'Tiêu đề cửa sổ bật lên',
    'popup_subtitle' => 'Phụ đề cửa sổ bật lên',
    'popup_description' => 'Mô tả cửa sổ bật lên',
    'popup_delay_seconds' => 'Độ trễ cửa sổ bật lên (giây)',
    'popup_delay_helper' => 'Thời gian trễ trước khi hiển thị cửa sổ bật lên bản tin sau khi tải trang. Đặt là 0 để hiển thị ngay lập tức. Mặc định là 5 giây.',
