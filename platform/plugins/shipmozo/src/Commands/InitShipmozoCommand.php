...
#[AsCommand('cms:shipmozo:init', 'Shipmozo initialization')]
class InitShipmozoCommand extends Command implements PromptsForMissingInput
{
    ...
    public function handle(): int
    {
        ...
        $settings = [
            ...
            'shipping_shipmozo_test_key' => $key,
            'shipping_shipmozo_status' => $key ? '1' : '0',
        ];
        ...
        $this->components->info('Shipmozo configuration initialized successfully!');
