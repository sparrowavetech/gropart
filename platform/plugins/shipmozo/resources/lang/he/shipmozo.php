...
return [
    ...
    'service_registration' => 'הרשם עם :name',
    'after_service_registration_msg' => 'לאחר הרישום ב-:name, יהיה לך מפתח API',
    ...
    'parcel' => 'Parcel',
    'estimated_days' => 'משלוח משוער תוך :day יום/ימים',
    'from_address' => 'From address',
    'to_address' => 'To address',
    'check_validate_token' => 'Check validate token?',
    'saved_shipping_settings_success' => 'Saved settings successfully!',
    'token_name_is_required' => ':name נדרש כדי שהאינטגרציה תעבוד',
    'token_name_is_invalid' => ':name אינו חוקי',
    ...
    'view_other_exchange_rates' => 'הצג :count שערי חליפין אחרים',
