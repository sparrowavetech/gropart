...
return [
    ...
    'configuration_requirement' => 'หากต้องการใช้ :name คุณต้องมี',
    'service_registration' => 'ลงทะเบียนกับ :name',
    'after_service_registration_msg' => 'หลังจากลงทะเบียนที่ :name คุณจะได้รับ API Key',
    ...
    'parcel' => 'Parcel',
    'estimated_days' => 'การจัดส่งโดยประมาณใน :day วัน',
    'from_address' => 'From address',
    'to_address' => 'To address',
    'check_validate_token' => 'Check validate token?',
    'saved_shipping_settings_success' => 'Saved settings successfully!',
    'token_name_is_required' => ':name จำเป็นสำหรับการทำงานของการรวม',
    'token_name_is_invalid' => ':name ไม่ถูกต้อง',
    ...
    'view_other_exchange_rates' => 'ดูอัตราแลกเปลี่ยนอื่น :count รายการ',
