...
return [
    ...
    'compare' => [
        ...
        'list_full' => 'შეგიძლიათ შეადაროთ :max-მდე პროდუქტი ერთდროულად. წაშალეთ ერთი მეორეს დასამატებლად.',
        'url_not_recognized' => 'ჩვენ ვერ ვიპოვეთ პროდუქტი ამ URL-ზე. გთხოვთ ჩასვათ პროდუქტის ბმული ამ საიტიდან.',
        'slot_count' => ':count :max პროდუქტიდან',
        'highlight_differences' => 'მონიშნეთ განსხვავებები',
        'copy_share_link' => 'დააკოპირეთ გაზიარების ბმული',
        'link_copied' => 'ბმული კოპირებულია ბუფერში',
        'additional_attributes' => 'დამატებითი ატრიბუტები',
        'add_another' => 'დაამატეთ სხვა პროდუქტი შესადარებლად',
        'paste_url_placeholder' => 'ჩასვით პროდუქტის URL',
        'add_button' => 'დამატება',
        'heading' => 'შეადარე',
        'savings_off' => 'დაზოგეთ :percent%',
        'savings_aria' => ':percent% დანაზოგი ამ პროდუქტზე',
        'picker_title' => 'იპოვნეთ პროდუქტი შესადარებლად',
        'picker_search_placeholder' => 'მოძებნეთ პროდუქტები სახელით…',
        'picker_empty' => 'პროდუქტები არ მოიძებნა.',
        'picker_loading' => 'იტვირთება პროდუქტები…',
        'choose_to_compare' => 'აირჩიეთ შედარება',
        'load_more' => 'მეტი ჩატვირთვა',
        'paste_url_alt' => 'ან ჩასვით პროდუქტის URL',
        'vs_separator' => 'vs',
    ],
];
