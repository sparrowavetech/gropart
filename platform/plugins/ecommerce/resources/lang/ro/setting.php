...
return [
  ...
  [
    ...
    [
      ...
      'store_name_placeholder' => 'Magazinul meu',
      'store_name_helper' => 'Numele magazinului va apărea în e-mailuri, facturi și pe tot site-ul.',
      'store_company' => 'Numele companiei',
      'store_company_placeholder' => 'Compania Mea S.R.L.',
      'store_company_helper' => 'Denumirea juridică a afacerii pentru facturi și documente oficiale.',
      'store_phone' => 'Număr de telefon',
      'store_phone_placeholder' => '+40 212 345 678',
      'store_phone_helper' => 'Numărul de contact afișat clienților și pe facturi.',
      'store_email' => 'E-mail magazin',
      'store_email_placeholder' => 'contact@magazinulmeu.com',
      'store_email_helper' => 'E-mail principal de contact pentru întrebările clienților și afișat pe facturi.',
      'store_address' => 'Adresă',
      'store_address_placeholder' => 'Strada Principală 123, Etaj 1',
      'store_address_helper' => 'Adresa fizică afișată pe facturi și pentru calculul expedierii.',
      'store_vat_number' => 'Tax ID / VAT',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'Codul de identificare fiscală al afacerii pentru facturi.',
      'admin_notification_email' => 'E-mailuri de notificare admin',
      'admin_notification_email_helper' => 'E-mailuri pentru primirea notificărilor de e-commerce (comenzi noi, retururi etc.). Dacă este gol, notificările vor fi trimise la e-mailurile implicite ale adminului.',
      'admin_notification_email_placeholder' => 'admin@exemplu.com',
    ],
  ],
  'currency' =>
  [
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'Activare produse up-sale',
      'is_enabled_up_sale_products_helper' => 'Afișați sugestii de produse up-sale pentru a încuraja upgrade-urile premium.',
      ...
      'delete_product_images_when_deleting' => 'Șterge imaginile produsului la ștergerea produsului',
      'delete_product_images_when_deleting_helper' => 'Când este activat, toate imaginile asociate produsului (inclusiv imaginea principală, imaginile din galerie și imaginile variațiilor) vor fi șterse permanent din biblioteca media la ștergerea produsului.',
      'enable_product_currency_selection' => 'Activare selecție monedă produs',
      'enable_product_currency_selection_helper' => 'Permite selectarea unei monede pentru fiecare produs. Prețurile vor fi convertite în moneda implicită pentru afișare.',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'Dimensiunea maximă a fișierului în megabytes pentru fiecare imagine de recenzie încărcată',
        'max_file_number' => 'Număr maxim fișiere recenzie',
        'max_file_number_help' => 'Numărul maxim de imagini pe care un client le poate încărca per recenzie',
      ],
      'review_comment_required' => 'Comentariu recenzie obligatoriu',
      'review_comment_required_help' => 'Când este dezactivat, clienții pot trimite o evaluare cu stele fără a scrie un comentariu',
      'only_allow_customers_purchased_to_review' => 'Doar clienții care au achiziționat produsul pot recenza produsul',
      'only_allow_customers_purchased_to_review_help' => 'Când este activat, doar clienții cu o comandă finalizată care conține produsul pot lăsa o recenzie',
      'review_need_to_be_approved' => 'Recenzia trebuie aprobată înainte de a fi afișată pe pagina produsului',
      'review_need_to_be_approved_help' => 'Când este activat, recenziile noi vor fi ascunse până când un admin le aprobă',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'Activare ștergere comenzi',
      'enable_order_deletion_helper' => 'Dacă este activat, adminii pot șterge comenzi. Dacă este dezactivat, comenzile pot doar schimba statusul și nu pot fi șterse. Dezactivați această opțiune pentru a păstra toate comenzile în scopuri de audit, raportare și legale.',
  ...
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'Permite clientului să încarce imagini',
      'allow_customer_upload_image_help' => 'Permite clienților să încarce fotografii la trimiterea cererilor de retur.',
      'max_file_size' => 'Dimensiune maximă fișier (MB)',
      'max_file_size_help' => 'Dimensiunea maximă per fișier imagine în megabytes.',
      'max_file_number' => 'Număr maxim de imagini',
    ],
  ],
  'invoice' =>
  [
    ...
    [
      ...
      'company_name_helper' => 'Numele afacerii sau companiei dumneavoastră care va apărea pe toate facturile trimise clienților.',
      'company_address' => 'Adresă companie',
      'company_address_placeholder' => '123 Business Street, Suite 100, New York, NY 10001, USA',
      'company_address_helper' => 'Adresa completă a companiei dumneavoastră, inclusiv strada, orașul, statul și țara. Aceasta va apărea pe facturi.',
      'company_zipcode' => 'Cod poștal companie',
      'company_zipcode_placeholder' => '10001',
      'company_zipcode_helper' => 'Codul poștal al adresei companiei dumneavoastră.',
      'company_email' => 'Email companie',
      'company_email_placeholder' => 'billing@company.com',
      'company_email_helper' => 'Adresa de email pentru întrebări de afaceri. Clienții o pot folosi pentru întrebări legate de facturi.',
      'company_phone' => 'Telefon companie',
      'company_phone_placeholder' => '+1 (555) 123-4567',
      'company_phone_helper' => 'Numărul de telefon de contact care va fi afișat pe facturi pentru asistență clienți.',
      'company_logo' => 'Logo companie',
      'company_logo_helper' => 'Logoul companiei dumneavoastră care va fi afișat în partea de sus a facturilor. Dimensiune recomandată: 200x60 pixeli.',
      'company_tax_id' => 'Cod fiscal companie',
      'company_tax_id_placeholder' => 'VAT123456789',
      'company_tax_id_helper' => 'Codul de identificare fiscală al afacerii dumneavoastră (TVA, GST, EIN etc.) pentru conformitate fiscală.',
      'invoice_code_prefix' => 'Prefix cod factură',
      'invoice_code_prefix_placeholder' => 'INV-',
      'invoice_code_prefix_helper' => 'Prefixul adăugat înaintea numerelor de factură (de ex., INV- va crea coduri de factură precum INV-001, INV-002).',
      'using_custom_font_for_invoice' => 'Folosind font personalizat pentru factură',
      'using_custom_font_for_invoice_helper' => 'Activați pentru a utiliza un Google Font personalizat pentru PDF-urile facturilor în locul fontului implicit.',
      'invoice_font_family' => 'Familie fonturi factură (Funcționează doar pentru limba latină)',
      'invoice_font_family_helper' => 'Selectați un Google Font pentru utilizare în PDF-urile facturilor. Funcționează doar cu seturi de caractere latine.',
      'enable_invoice_stamp' => 'Activați ștampila facturii',
      'enable_invoice_stamp_helper' => 'Adăugați o ștampilă PAID pe facturi când plata comenzii este finalizată.',
      'add_language_support' => 'Adăugați suport lingvistic',
      'add_language_support_helper' => 'Alegeți suport suplimentar pentru seturi de caractere pentru limbile non-latine în facturile PDF.',
      'invoice_processing_library' => 'Bibliotecă procesare factură',
      'invoice_processing_library_helper' => 'Alegeți biblioteca de generare PDF. DomPDF este mai rapid, dar are funcții limitate. mPDF suportă mai multe limbi și funcții, dar poate fi mai lent.',
      ...
      'disable_order_invoice_until_order_confirmed_helper' => 'Când este activat, facturile vor fi disponibile doar după confirmarea comenzilor, nu imediat după plasare.',
      'date_format' => 'Format dată',
      'date_format_helper' => 'Alegeți cum vor fi afișate datele pe facturi (de ex., F d, Y afișează January 01, 2024).',
      'languages' =>
      [
        'arabic' => 'Arabă',
  ...
  [
    ...
    'manage_taxes_info' => 'Pentru a gestiona taxele și a seta rata de taxă implicită, vă rugăm să mergeți la',
    'go_to_taxes' => 'E-commerce → Taxe',
    'form' =>
    [
      ...
      'display_item_tax_at_checkout' => 'Afișare taxă produs la checkout',
      'display_item_tax_at_checkout_helper' => 'Afișați suma taxei (ex. "Taxă: 10,00 lei") pentru fiecare articol pe pagina de checkout.',
      'tax_on_shipping_fee' => 'Aplică taxa pe costul de livrare',
      'tax_on_shipping_fee_helper' => 'Când este activat, rata de taxare implicită va fi aplicată costurilor de livrare. Asigurați-vă că o rată de taxare implicită este configurată în E-commerce → Taxe.',
    ],
  ],
  'customer' =>
  [
  ...
  [
    ...
    [
      ...
      'start_number' => 'Număr de început',
      'start_number_description' => 'Numărul comenzii va începe de la această valoare',
      'order_number_length' => 'Lungimea numărului de comandă',
      'order_number_length_description' => 'Numărul minim de cifre pentru numărul comenzii (ex. 3 va formata 1 ca 001)',
  ...
  'display_bank_info_at_the_checkout_success_page' => 'Afișați informațiile bancare pe pagina de succes finalizare?',
  'display_bank_info_at_the_checkout_success_page_helper' => 'Când este activat, clienții vor vedea detaliile contului dumneavoastră bancar pe pagina de confirmare a comenzii după plasarea unei comenzi. Acest lucru îi ajută să știe unde să transfere plata.',
