...
return [
  ...
  [
    ...
    [
      ...
      'store_name_placeholder' => 'Il Mio Negozio',
      'store_name_helper' => 'Il nome del negozio apparirà nelle e-mail, nelle fatture e in tutto il sito.',
      'store_company' => 'Nome dell\\\'azienda',
      'store_company_placeholder' => 'La Mia Azienda S.r.l.',
      'store_company_helper' => 'Ragione sociale per fatture e documenti ufficiali.',
      'store_phone' => 'Numero di telefono',
      'store_phone_placeholder' => '+39 012 345 6789',
      'store_phone_helper' => 'Numero di contatto mostrato ai clienti e sulle fatture.',
      'store_email' => 'E-mail del negozio',
      'store_email_placeholder' => 'contatto@mionegozio.it',
      'store_email_helper' => 'E-mail di contatto principale per le richieste dei clienti e mostrata sulle fatture.',
      'store_address' => 'Indirizzo',
      'store_address_placeholder' => 'Via Principale 123, Ufficio 100',
      'store_address_helper' => 'Indirizzo fisico mostrato sulle fatture e per il calcolo delle spedizioni.',
      'store_vat_number' => 'Codice fiscale / Partita IVA',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'Il numero di identificazione fiscale della vostra azienda per le fatture.',
      'admin_notification_email' => 'E-mail di notifica admin',
      'admin_notification_email_helper' => 'E-mail per ricevere notifiche e-commerce (nuovi ordini, resi, ecc.). Se vuoto, le notifiche verranno inviate alle e-mail admin predefinite.',
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'Abilita prodotti up-sell',
      'is_enabled_up_sale_products_helper' => 'Mostra suggerimenti di prodotti di fascia superiore per incoraggiare upgrade premium.',
      ...
      'delete_product_images_when_deleting' => 'Elimina le immagini del prodotto durante l\\\'eliminazione',
      'delete_product_images_when_deleting_helper' => 'Quando abilitato, tutte le immagini associate al prodotto (inclusa l\\\'immagine principale, le immagini della galleria e le immagini delle varianti) verranno eliminate permanentemente dalla libreria media quando il prodotto viene eliminato.',
      'enable_product_currency_selection' => 'Abilita selezione valuta per prodotto',
      'enable_product_currency_selection_helper' => 'Consente di selezionare una valuta per ogni prodotto. I prezzi verranno convertiti nella valuta predefinita per la visualizzazione.',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'Dimensione massima del file in megabyte per ogni immagine di recensione caricata',
        'max_file_number' => 'Numero massimo file recensione',
        'max_file_number_help' => 'Numero massimo di immagini che un cliente può caricare per recensione',
      ],
      'review_comment_required' => 'Richiedi commento nella recensione',
      'review_comment_required_help' => 'Quando disabilitato, i clienti possono inviare una valutazione a stelle senza scrivere un commento',
      'only_allow_customers_purchased_to_review' => 'Solo i clienti che hanno acquistato il prodotto possono recensire il prodotto',
      'only_allow_customers_purchased_to_review_help' => 'Quando abilitato, solo i clienti con un ordine completato contenente il prodotto possono lasciare una recensione',
      'review_need_to_be_approved' => 'Le recensioni devono essere approvate prima di essere mostrate nella pagina prodotto',
      'review_need_to_be_approved_help' => 'Quando abilitato, le nuove recensioni saranno nascoste fino all\\\'approvazione da parte di un amministratore',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'Abilita eliminazione ordini',
      'enable_order_deletion_helper' => 'Se abilitato, gli admin possono eliminare gli ordini. Se disabilitato, gli ordini possono solo cambiare stato e non possono essere eliminati. Disabilita questa opzione per conservare tutti gli ordini per scopi di audit, reportistica e legali.',
  ...
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'Consenti al cliente di caricare immagini',
      'allow_customer_upload_image_help' => 'Consente ai clienti di caricare foto quando inviano richieste di reso.',
      'max_file_size' => 'Dimensione massima del file (MB)',
      'max_file_size_help' => 'Dimensione massima per file immagine in megabyte.',
      'max_file_number' => 'Numero massimo di immagini',
    ],
  ],
  'invoice' =>
  [
    ...
    'company_settings' => 'Configurazione fatture',
    'company_settings_description' => 'Info azienda, numerazione fatture, font PDF e timbro pagamento',
    'form' =>
    [
  ...
  [
    'name' => 'Tassa',
    'description' => 'Calcolo tasse, opzioni di visualizzazione e campi fattura checkout',
    ...
    'tax_setting' => 'Visualizzazione tasse e checkout',
    'tax_setting_description' => 'Configura come vengono visualizzate le tasse sui prodotti e nelle pagine di checkout',
    'tax_management' => 'Gestione tasse',
    'tax_management_description' => 'Visualizza e gestisci le tue tasse',
    'manage_taxes_info' => 'Per gestire le tasse e impostare l\'aliquota fiscale predefinita, vai su',
    'go_to_taxes' => 'E-commerce → Tasse',
    'form' =>
    [
      ...
      'display_item_tax_at_checkout' => 'Mostra imposta per articolo al checkout',
      'display_item_tax_at_checkout_helper' => 'Mostra l\\\'importo dell\\\'imposta (es.: "Imposta: $10,00") per ogni articolo nella pagina di checkout.',
      'tax_on_shipping_fee' => 'Applica tassa sulle spese di spedizione',
      'tax_on_shipping_fee_helper' => 'Quando abilitato, l\'aliquota fiscale predefinita verrà applicata alle spese di spedizione. Assicurati che un\'aliquota fiscale predefinita sia configurata in E-commerce → Tasse.',
    ],
  ],
  'customer' =>
  [
  ...
  [
    'name' => 'Webhooks',
    'description' => 'Invia eventi ordine a servizi esterni tramite HTTP',
    'webhook_setting' => 'Webhook eventi ordine',
    'webhook_setting_description' => 'Configura URL per ricevere notifiche quando gli ordini vengono effettuati, aggiornati o spediti',
    'form' =>
    [
  ...
  [
    ...
    [
      ...
      'google_ads_conversion_id_helper' => 'Inserisci il tuo ID conversione Google Ads (formato: AW-123456789/AbC-D_efG-h1_ijk-lmN) per monitorare le conversioni di acquisto nella pagina di ringraziamento.',
    ],
    'validation' =>
    [
  ...
  [
    ...
    [
      ...
      'start_number_description' => 'Il numero d\\\'ordine partirà da questo valore',
      'order_number_length' => 'Lunghezza numero d\\\'ordine',
      'order_number_length_description' => 'Numero minimo di cifre per il numero d\\\'ordine (es.: 3 formatterà 1 come 001)',
  ...
  'display_bank_info_at_the_checkout_success_page' => 'Visualizza info banca nella pagina successo checkout?',
  'display_bank_info_at_the_checkout_success_page_helper' => 'Se abilitato, i clienti vedranno i dettagli del tuo conto bancario nella pagina di conferma dell\'ordine dopo aver effettuato un acquisto. Questo li aiuta a sapere dove trasferire il pagamento.',
