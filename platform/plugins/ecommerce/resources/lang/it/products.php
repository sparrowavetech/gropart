...
return [
    ...
    'compare' => [
        ...
        'list_full' => 'Puoi confrontare fino a :max prodotti contemporaneamente. Rimuovine uno per aggiungerne un altro.',
        'url_not_recognized' => 'Non siamo riusciti a trovare un prodotto a quell\'URL. Incolla un collegamento al prodotto da questo sito.',
        'slot_count' => ':count di :max prodotti',
        'highlight_differences' => 'Evidenziare le differenze',
        'copy_share_link' => 'Copia il collegamento di condivisione',
        'link_copied' => 'Link copiato negli appunti',
        'additional_attributes' => 'Attributi aggiuntivi',
        'add_another' => 'Aggiungi un altro prodotto per confrontare',
        'paste_url_placeholder' => 'Incolla l\'URL del prodotto',
        'add_button' => 'Aggiungere',
        'heading' => 'Confrontare',
        'savings_off' => 'Risparmia il :percent%',
        'savings_aria' => ':percent% di risparmio su questo prodotto',
        'picker_title' => 'Trova un prodotto da confrontare',
        'picker_search_placeholder' => 'Cerca prodotti per nome...',
        'picker_empty' => 'Nessun prodotto trovato.',
        'picker_loading' => 'Caricamento prodotti...',
        'choose_to_compare' => 'Scegli di confrontare',
        'load_more' => 'Carica di più',
        'paste_url_alt' => 'Oppure incolla l\'URL di un prodotto',
        'vs_separator' => 'vs',
    ],
];
