...
return [
  ...
  [
    ...
    [
      ...
      'store_name_helper' => 'O nome da sua loja aparecerá em e-mails, faturas e em todo o site.',
      'store_company' => 'Nome da empresa',
      'store_company_placeholder' => 'Minha Empresa Ltda.',
      'store_company_helper' => 'Razão social para notas fiscais e documentos oficiais.',
      'store_phone' => 'Número de telefone',
      'store_phone_placeholder' => '+55 11 91234 5678',
      'store_phone_helper' => 'Número de contato exibido para os clientes e nas notas fiscais.',
      'store_email' => 'E-mail da loja',
      'store_email_placeholder' => 'contato@minhaloja.com.br',
      'store_email_helper' => 'E-mail de contato principal para consultas de clientes e exibido nas notas fiscais.',
      'store_address' => 'Endereço',
      'store_address_placeholder' => 'Rua Principal 123, Sala 100',
      'store_address_helper' => 'Endereço físico exibido nas notas fiscais e para cálculos de frete.',
      'store_vat_number' => 'CNPJ / Inscrição Estadual',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'Seu número de identificação fiscal para notas fiscais.',
      'admin_notification_email' => 'E-mails de notificação do administrador',
      'admin_notification_email_helper' => 'E-mails para receber notificações de e-commerce (novos pedidos, devoluções, etc.). Se vazio, as notificações serão enviadas para os e-mails de administrador padrão.',
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'Ativar produtos de venda adicional',
      'is_enabled_up_sale_products_helper' => 'Exibir sugestões de produtos de categoria superior para incentivar upgrades premium.',
      ...
      'delete_product_images_when_deleting' => 'Excluir imagens do produto ao excluí-lo',
      'delete_product_images_when_deleting_helper' => 'Quando ativado, todas as imagens associadas ao produto (incluindo imagem principal, galeria e imagens de variações) serão permanentemente excluídas da biblioteca de mídia ao excluir o produto.',
      'enable_product_currency_selection' => 'Ativar seleção de moeda por produto',
      'enable_product_currency_selection_helper' => 'Permite selecionar uma moeda para cada produto. Os preços serão convertidos para a moeda padrão para exibição.',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'Tamanho máximo do arquivo em megabytes para cada imagem de avaliação enviada',
        'max_file_number' => 'Número máximo de arquivos de avaliação',
        'max_file_number_help' => 'Número máximo de imagens que um cliente pode enviar por avaliação',
      ],
      'review_comment_required' => 'Exigir comentário na avaliação',
      'review_comment_required_help' => 'Quando desativado, os clientes podem enviar uma avaliação por estrelas sem escrever um comentário',
      'only_allow_customers_purchased_to_review' => 'Apenas clientes que compraram o produto podem avaliar o produto',
      'only_allow_customers_purchased_to_review_help' => 'Quando ativado, apenas clientes com um pedido concluído contendo o produto podem deixar uma avaliação',
      'review_need_to_be_approved' => 'A avaliação precisa ser aprovada antes de ser exibida na página do produto',
      'review_need_to_be_approved_help' => 'Quando ativado, as novas avaliações ficarão ocultas até serem aprovadas por um administrador',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'Ativar exclusão de pedidos',
      'enable_order_deletion_helper' => 'Se ativado, os administradores podem excluir pedidos. Se desativado, os pedidos só podem mudar de status e não podem ser excluídos. Desative esta opção para manter todos os pedidos para fins de auditoria, relatórios e legais.',
  ...
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'Permitir ao cliente enviar imagens',
      'allow_customer_upload_image_help' => 'Permite aos clientes enviar fotos ao submeter solicitações de devolução.',
      'max_file_size' => 'Tamanho máximo do arquivo (MB)',
      'max_file_size_help' => 'Tamanho máximo por arquivo de imagem em megabytes.',
      'max_file_number' => 'Número máximo de imagens',
    ],
  ],
  'invoice' =>
  [
    ...
    [
      ...
      'company_name_helper' => 'O nome da sua empresa que aparecerá em todas as faturas enviadas aos clientes.',
      'company_address' => 'Endereço da empresa',
      'company_address_placeholder' => '123 Business Street, Suite 100, New York, NY 10001, USA',
      'company_address_helper' => 'O endereço completo da sua empresa incluindo rua, cidade, estado e país. Aparecerá nas faturas.',
      'company_zipcode' => 'CEP da empresa',
      'company_zipcode_placeholder' => '10001',
      'company_zipcode_helper' => 'CEP do endereço da sua empresa.',
      'company_email' => 'E-mail da empresa',
      'company_email_placeholder' => 'billing@company.com',
      'company_email_helper' => 'Endereço de e-mail para consultas comerciais. Os clientes podem usá-lo para perguntas relacionadas a faturas.',
      ...
      'company_tax_id_helper' => 'O número de identificação fiscal da sua empresa (CNPJ, CPF, VAT, etc.) para conformidade fiscal.',
      'invoice_code_prefix' => 'Prefixo do código da fatura',
      'invoice_code_prefix_placeholder' => 'INV-',
      'invoice_code_prefix_helper' => 'Prefixo adicionado antes dos números das faturas (ex.: INV- criará códigos como INV-001, INV-002).',
      'using_custom_font_for_invoice' => 'Usar fonte personalizada para fatura',
      'using_custom_font_for_invoice_helper' => 'Ative para usar uma Google Font personalizada nos PDFs das faturas em vez da fonte padrão.',
      'invoice_font_family' => 'Família de fontes da fatura (Funciona apenas para idioma latino)',
      'invoice_font_family_helper' => 'Selecione uma Google Font para usar nos PDFs das faturas. Funciona apenas com conjuntos de caracteres latinos.',
      'enable_invoice_stamp' => 'Habilitar carimbo de fatura',
      'enable_invoice_stamp_helper' => 'Adicione um carimbo PAID às faturas quando o pagamento do pedido for concluído.',
      'add_language_support' => 'Adicionar suporte de idioma',
      'add_language_support_helper' => 'Escolha suporte adicional a conjuntos de caracteres para idiomas não latinos nas faturas em PDF.',
      'invoice_processing_library' => 'Biblioteca de processamento de fatura',
      'invoice_processing_library_helper' => 'Escolha a biblioteca de geração de PDF. O DomPDF é mais rápido, mas tem recursos limitados. O mPDF suporta mais idiomas e recursos, mas pode ser mais lento.',
      ...
      'disable_order_invoice_until_order_confirmed_helper' => 'Quando ativado, as faturas só estarão disponíveis após a confirmação dos pedidos, não imediatamente após a realização.',
      'date_format' => 'Formato de data',
      'date_format_helper' => 'Escolha como as datas serão exibidas nas faturas (ex.: F d, Y exibe January 01, 2024).',
      'languages' =>
      [
        'arabic' => 'Árabe',
        'bangladesh' => 'Bengali',
  ...
  [
    ...
    'go_to_taxes' => 'E-commerce → Impostos',
    'form' =>
    [
      ...
      'display_item_tax_at_checkout' => 'Exibir imposto por item no checkout',
      'display_item_tax_at_checkout_helper' => 'Mostrar o valor do imposto (ex.: "Imposto: R$ 10,00") para cada item na página de checkout.',
      'tax_on_shipping_fee' => 'Aplicar imposto sobre o frete',
      'tax_on_shipping_fee_helper' => 'Quando ativado, a alíquota de imposto padrão será aplicada às taxas de frete. Certifique-se de que uma alíquota padrão está configurada em E-commerce → Impostos.',
    ],
  ],
  'customer' =>
  [
  ...
  [
    ...
    [
      ...
      'start_number_description' => 'O número do pedido começará a partir deste valor',
      'order_number_length' => 'Comprimento do número do pedido',
      'order_number_length_description' => 'Número mínimo de dígitos para o número do pedido (ex.: 3 formatará 1 como 001)',
  ...
  'display_bank_info_at_the_checkout_success_page' => 'Exibir informações bancárias na página de sucesso do checkout?',
  'display_bank_info_at_the_checkout_success_page_helper' => 'Quando ativado, os clientes verão os dados da sua conta bancária na página de confirmação do pedido após realizarem uma compra. Isso os ajuda a saber para onde transferir o pagamento.',
