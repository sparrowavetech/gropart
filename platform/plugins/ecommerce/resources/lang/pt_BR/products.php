...
return [
    'name' => 'Produtos',
    'description' => 'Gerenciar produtos físicos e digitais com estoque, preços e variações',
    'create' => 'Novo produto',
    'create_product_type' => [
    ...
    'form' => [
        ...
        'price_includes_tax_helper' => 'Marque esta opção se o preço inserido já inclui impostos. O sistema calculará o preço base removendo o valor do imposto.',
        'stock' => [
    ...
    'digital_attachments' => [
        ...
        'no_attachments' => 'Ainda sem anexos. Clique nos botões acima para adicionar arquivos.',
    ],
    'license_codes' => [
        ...
        'add_modal' => [
            ...
            'help' => 'Digite um código de licença único que será atribuído a um cliente após a compra.',
        ],
        'generate_modal' => [
        ...
        'bulk_delete' => [
            ...
            'confirm' => 'Tem certeza de que deseja excluir os códigos de licença selecionados?',
            'deleted_successfully' => ':count código(s) de licença excluído(s) com sucesso.',
            'skipped_used_codes' => ':count código(s) usado(s) foram ignorados.',
            'no_deletable_codes' => 'Nenhum código de licença disponível encontrado para excluir. Os códigos usados não podem ser excluídos.',
        ],
        'import' => [
            'name' => 'Importar Códigos de Licença de Produtos',
            'description' => 'Importar códigos de licença para produtos digitais de arquivo CSV/Excel.',
            'button' => 'Importar',
            'columns' => [
    ...
    'download' => 'Baixar',
    'external_link_downloads' => 'Links externos',
    'download_available_when_completed' => 'Os links de download estarão disponíveis quando o pedido estiver concluído.',
    ...
    'up_sale' => [
        ...
        'unlock_discount' => 'Adicione :product ao carrinho para desbloquear o desconto do combo',
        ...
        'bundle_discount_with' => 'Desconto de combo com :product',
        'bundle_with' => 'Combo com :product',
    ],
    'cross_sale' => [
        'title' => 'Frequentemente Comprados Juntos',
        'description' => 'Clientes que viram este item também compraram',
    ],
    ...
    'cart' => [
        ...
        'bundle_item_already_in_cart' => 'Este item do combo já está no seu carrinho. Apenas 1 item por desconto de combo é permitido.',
    ],
    'wishlist' => [
    ...
    'compare' => [
        ...
        'list_full' => 'Você pode comparar até :max produtos de uma só vez. Remova um para adicionar outro.',
        'url_not_recognized' => 'Não foi possível encontrar um produto nesse URL. Cole um link de produto deste site.',
        'slot_count' => ':count de :max produtos',
        'highlight_differences' => 'Destacar diferenças',
        'copy_share_link' => 'Copiar link de compartilhamento',
        'link_copied' => 'Link copiado para a área de transferência',
        'additional_attributes' => 'Atributos adicionais',
        'add_another' => 'Adicione outro produto para comparar',
        'paste_url_placeholder' => 'Colar URL do produto',
        'add_button' => 'Adicionar',
        'heading' => 'Comparar',
        'savings_off' => 'Economize :percent%',
        'savings_aria' => ':percent% de economia neste produto',
        'picker_title' => 'Encontre um produto para comparar',
        'picker_search_placeholder' => 'Pesquise produtos por nome…',
        'picker_empty' => 'Nenhum produto encontrado.',
        'picker_loading' => 'Carregando produtos…',
        'choose_to_compare' => 'Escolha comparar',
        'load_more' => 'Carregar mais',
        'paste_url_alt' => 'Ou cole o URL de um produto',
        'vs_separator' => 'vs',
    ],
];
