...
return [
  ...
  [
    ...
    'form' =>
    [
      'store_name' => 'Назив продавнице',
      'store_name_placeholder' => 'Моја продавница',
      'store_name_helper' => 'Назив ваше продавнице ће се приказивати у е-порукама, рачунима и на целом сајту.',
      'store_company' => 'Назив компаније',
      'store_company_placeholder' => 'Моја фирма д.о.о.',
      'store_company_helper' => 'Званични назив фирме за рачуне и службене документе.',
      'store_phone' => 'Телефонски број',
      'store_phone_placeholder' => '+381 11 234 5678',
      'store_phone_helper' => 'Контакт број приказан купцима и на рачунима.',
      'store_email' => 'Е-пошта продавнице',
      'store_email_placeholder' => 'contact@mystore.com',
      'store_email_helper' => 'Главна контакт е-адреса за упите купаца и приказ на рачунима.',
      'store_address' => 'Адреса',
      'store_address_placeholder' => 'Главна улица 123, 11000 Београд',
      'store_address_helper' => 'Физичка адреса приказана на рачунима и за израчунавање доставе.',
      'store_vat_number' => 'ПИБ / Tax ID / VAT',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'Порески идентификациони број ваше фирме за рачуне.',
      'admin_notification_email' => 'Е-адресе за обавештења администратора',
      'admin_notification_email_helper' => 'Е-адресе за примање обавештења о поруџбинама, повратима итд. Ако је празно, обавештења ће се слати на подразумеване е-адресе администратора.',
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'Омогући додатне производе',
      'is_enabled_up_sale_products_helper' => 'Приказуј предлоге додатних производа за подстицање куповине скупљих варијанти.',
      ...
      'delete_product_images_when_deleting' => 'Обриши слике производа при брисању',
      'delete_product_images_when_deleting_helper' => 'Када је омогућено, све слике повезане са производом (укључујући главну слику, галерију и слике варијација) биће трајно обрисане из медијске библиотеке при брисању производа.',
      'enable_product_currency_selection' => 'Омогући избор валуте производа',
      'enable_product_currency_selection_helper' => 'Омогућава избор валуте за сваки производ. Цене ће бити претворене у подразумевану валуту за приказ.',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'Максимална величина датотеке у мегабајтима за сваку учитану слику рецензије',
        'max_file_number' => 'Maksimalan broj fajlova recenzije',
        'max_file_number_help' => 'Максималан број слика које купац може учитати по рецензији',
      ],
      'review_comment_required' => 'Захтевај коментар уз рецензију',
      'review_comment_required_help' => 'Када је онемогућено, купци могу послати оцену звездицама без писања коментара',
      'only_allow_customers_purchased_to_review' => 'Samo kupci koji su kupili proizvod mogu recenzirati proizvod',
      'only_allow_customers_purchased_to_review_help' => 'Када је омогућено, само купци са завршеном поруџбином која садржи производ могу оставити рецензију',
      'review_need_to_be_approved' => 'Recenzija mora biti odobrena pre prikazivanja na stranici proizvoda',
      'review_need_to_be_approved_help' => 'Када је омогућено, нове рецензије биће скривене док их администратор не одобри',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'Омогући брисање поруџбина',
      'enable_order_deletion_helper' => 'Ако је омогућено, администратори могу брисати поруџбине. Ако је онемогућено, поруџбине могу само мењати статус и не могу се брисати. Онемогућите ову опцију за чување свих поруџбина за ревизију, извештавање и правне сврхе.',
  ...
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'Дозволи купцима учитавање слика',
      'allow_customer_upload_image_help' => 'Омогућава купцима учитавање фотографија при подношењу захтева за повраћај.',
      'max_file_size' => 'Максимална величина датотеке (MB)',
      'max_file_size_help' => 'Максимална величина сликовне датотеке у мегабајтима.',
      'max_file_number' => 'Максималан број слика',
    ],
  ],
  'invoice' =>
  [
    ...
    [
      ...
      'company_name_helper' => 'Назив вашег предузећа или компаније који ће се приказивати на свим рачунима послатим купцима.',
      'company_address' => 'Adresa kompanije',
      'company_address_placeholder' => '123 Business Street, Suite 100, New York, NY 10001, USA',
      'company_address_helper' => 'Пуна адреса вашег предузећа укључујући улицу, град, државу и земљу. Приказаће се на рачунима.',
      'company_zipcode' => 'Poštanski broj kompanije',
      'company_zipcode_placeholder' => '10001',
      'company_zipcode_helper' => 'Поштански број адресе вашег предузећа.',
      'company_email' => 'Email kompanije',
      'company_email_placeholder' => 'billing@company.com',
      'company_email_helper' => 'Адреса е-поште за пословне упите. Купци је могу користити за питања везана за рачуне.',
      'company_phone' => 'Telefon kompanije',
      'company_phone_placeholder' => '+1 (555) 123-4567',
      'company_phone_helper' => 'Контакт телефонски број који ће се приказивати на рачунима за корисничку подршку.',
      'company_logo' => 'Logo kompanije',
      'company_logo_helper' => 'Логотип вашег предузећа који ће се приказивати на врху рачуна. Препоручена величина: 200x60 пиксела.',
      'company_tax_id' => 'PIB kompanije',
      'company_tax_id_placeholder' => 'VAT123456789',
      'company_tax_id_helper' => 'Порески идентификациони број вашег предузећа (ПДВ, GST, EIN итд.) за пореску усклађеност.',
      'invoice_code_prefix' => 'Prefiks koda fakture',
      'invoice_code_prefix_placeholder' => 'INV-',
      'invoice_code_prefix_helper' => 'Префикс додат испред бројева рачуна (нпр. INV- ће створити кодове рачуна попут INV-001, INV-002).',
      'using_custom_font_for_invoice' => 'Korišćenje prilagođenog fonta za fakturu',
      'using_custom_font_for_invoice_helper' => 'Омогућите коришћење прилагођеног Google Font за PDF рачуне уместо подразумеваног фонта.',
      'invoice_font_family' => 'Familija fonta fakture (Samo za latinske jezike)',
      'invoice_font_family_helper' => 'Изаберите Google Font за коришћење у PDF рачунима. Ради само са латиничним скуповима знакова.',
      'enable_invoice_stamp' => 'Omogući pečat fakture',
      'enable_invoice_stamp_helper' => 'Додајте PAID печат на рачуне када је плаћање наруџбине завршено.',
      'add_language_support' => 'Dodaj podršku za jezik',
      'add_language_support_helper' => 'Изаберите додатну подршку за скупове знакова за нелатиничне језике у PDF рачунима.',
      'invoice_processing_library' => 'Biblioteka za obradu faktura',
      'invoice_processing_library_helper' => 'Изаберите библиотеку за генерисање PDF-а. DomPDF је бржи али има ограничене функције. mPDF подржава више језика и функција али може бити спорији.',
      ...
      'disable_order_invoice_until_order_confirmed_helper' => 'Када је омогућено, рачуни ће бити доступни тек након потврде наруџбина, а не одмах након подношења.',
      'date_format' => 'Format datuma',
      'date_format_helper' => 'Изаберите како ће се датуми приказивати на рачунима (нпр. F d, Y приказује January 01, 2024).',
      'languages' =>
      [
        'arabic' => 'Arapski',
  ...
  [
    ...
    'manage_taxes_info' => 'За управљање порезима и постављање подразумеване пореске стопе, идите на',
    'go_to_taxes' => 'Е-трговина → Порези',
    'form' =>
    [
      ...
      'display_item_tax_at_checkout' => 'Прикажи порез артикла на каси',
      'display_item_tax_at_checkout_helper' => 'Прикажи износ пореза (нпр. "Порез: $10.00") за сваки артикал на страници касе.',
      'tax_on_shipping_fee' => 'Примени порез на трошкове доставе',
      'tax_on_shipping_fee_helper' => 'Када је омогућено, подразумевана пореска стопа ће бити примењена на трошкове доставе. Уверите се да је подразумевана пореска стопа конфигурисана у Е-трговина → Порези.',
    ],
  ],
  'customer' =>
  [
  ...
  [
    ...
    [
      ...
      'start_number' => 'Почетни број',
      'start_number_description' => 'Нумерација поруџбина почеће од ове вредности',
      'order_number_length' => 'Дужина броја поруџбине',
      'order_number_length_description' => 'Минималан број цифара у броју поруџбине (нпр. 3 ће форматирати 1 као 001)',
  ...
  'display_bank_info_at_the_checkout_success_page' => 'Prikaži bankovne informacije na stranici uspešnog plaćanja?',
  'display_bank_info_at_the_checkout_success_page_helper' => 'Када је омогућено, купци ће видети податке о вашем банковном рачуну на страници потврде наруџбине након наручивања. Ово им помаже да знају куда да пренесу уплату.',
