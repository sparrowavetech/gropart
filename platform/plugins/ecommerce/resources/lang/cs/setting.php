...
return [
  ...
  [
    ...
    [
      ...
      'store_name_placeholder' => 'Můj obchod',
      'store_name_helper' => 'Název vašeho obchodu se bude zobrazovat v e-mailech, fakturách a na celém webu.',
      'store_company' => 'Název společnosti',
      'store_company_placeholder' => 'Moje firma s.r.o.',
      'store_company_helper' => 'Oficiální název firmy pro faktury a úřední dokumenty.',
      'store_phone' => 'Telefonní číslo',
      'store_phone_placeholder' => '+420 123 456 789',
      'store_phone_helper' => 'Kontaktní číslo zobrazované zákazníkům a na fakturách.',
      'store_email' => 'E-mail obchodu',
      'store_email_placeholder' => 'contact@mystore.com',
      'store_email_helper' => 'Hlavní kontaktní e-mail pro dotazy zákazníků a zobrazení na fakturách.',
      'store_address' => 'Adresa',
      'store_address_placeholder' => 'Hlavní 123, 100 00 Praha',
      'store_address_helper' => 'Fyzická adresa zobrazovaná na fakturách a pro výpočet dopravy.',
      'store_vat_number' => 'IČO / DIČ / VAT',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'Daňové identifikační číslo vaší firmy pro faktury.',
      'admin_notification_email' => 'E-maily pro upozornění administrátora',
      'admin_notification_email_helper' => 'E-maily pro příjem upozornění na objednávky, vrácení atd. Pokud je prázdné, upozornění budou zasílána na výchozí e-maily administrátora.',
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'Povolit doplňkové produkty',
      'is_enabled_up_sale_products_helper' => 'Zobrazovat návrhy doplňkových produktů pro podporu nákupu dražších variant.',
      ...
      'delete_product_images_when_deleting' => 'Smazat obrázky produktu při jeho odstranění',
      'delete_product_images_when_deleting_helper' => 'Při povolení budou všechny obrázky spojené s produktem (včetně hlavního obrázku, galerie a obrázků variant) trvale odstraněny z knihovny médií při smazání produktu.',
      'enable_product_currency_selection' => 'Povolit výběr měny produktu',
      'enable_product_currency_selection_helper' => 'Umožňuje vybrat měnu pro každý produkt. Ceny budou přepočítány na výchozí měnu pro zobrazení.',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'Maximální velikost souboru v megabajtech pro každý nahraný obrázek recenze',
        'max_file_number' => 'Maximální počet souborů recenze',
        'max_file_number_help' => 'Maximální počet obrázků, které může zákazník nahrát k recenzi',
      ],
      'review_comment_required' => 'Vyžadovat komentář k recenzi',
      'review_comment_required_help' => 'Při vypnutí mohou zákazníci odeslat hvězdičkové hodnocení bez psaní komentáře',
      'only_allow_customers_purchased_to_review' => 'Pouze zákazníci, kteří si produkt zakoupili, mohou produkt recenzovat',
      'only_allow_customers_purchased_to_review_help' => 'Při povolení mohou recenzi napsat pouze zákazníci s dokončenou objednávkou obsahující produkt',
      'review_need_to_be_approved' => 'Recenze musí být schválena před zobrazením na stránce produktu',
      'review_need_to_be_approved_help' => 'Při povolení budou nové recenze skryté, dokud je administrátor neschválí',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'Povolit mazání objednávek',
      'enable_order_deletion_helper' => 'Pokud je povoleno, administrátoři mohou mazat objednávky. Pokud je zakázáno, objednávky mohou pouze měnit stav a nelze je smazat. Zakažte tuto možnost pro zachování všech objednávek pro audit, reporting a právní účely.',
  ...
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'Povolit zákazníkům nahrávat obrázky',
      'allow_customer_upload_image_help' => 'Umožňuje zákazníkům nahrávat fotografie při podání žádosti o vrácení.',
      'max_file_size' => 'Maximální velikost souboru (MB)',
      'max_file_size_help' => 'Maximální velikost souboru obrázku v megabajtech.',
      'max_file_number' => 'Maximální počet obrázků',
    ],
  ],
  'invoice' =>
  [
    ...
    [
      ...
      'company_name_helper' => 'Název vaší firmy nebo společnosti, který se zobrazí na všech fakturách zasílaných zákazníkům.',
      'company_address' => 'Adresa společnosti',
      'company_address_placeholder' => '123 Business Street, Suite 100, New York, NY 10001, USA',
      'company_address_helper' => 'Úplná adresa vaší společnosti včetně ulice, města, státu a země. Zobrazí se na fakturách.',
      'company_zipcode' => 'PSČ společnosti',
      'company_zipcode_placeholder' => '10001',
      'company_zipcode_helper' => 'PSČ adresy vaší společnosti.',
      'company_email' => 'E-mail společnosti',
      'company_email_placeholder' => 'billing@company.com',
      'company_email_helper' => 'E-mailová adresa pro obchodní dotazy. Zákazníci ji mohou použít pro otázky týkající se faktur.',
      'company_phone' => 'Telefon společnosti',
      'company_phone_placeholder' => '+1 (555) 123-4567',
      'company_phone_helper' => 'Kontaktní telefonní číslo, které se zobrazí na fakturách pro zákaznickou podporu.',
      'company_logo' => 'Logo společnosti',
      'company_logo_helper' => 'Logo vaší společnosti, které se zobrazí v horní části faktur. Doporučená velikost: 200x60 pixelů.',
      'company_tax_id' => 'DIČ společnosti',
      'company_tax_id_placeholder' => 'VAT123456789',
      'company_tax_id_helper' => 'Daňové identifikační číslo vaší firmy (DIČ, IČ DPH apod.) pro daňové účely.',
      'invoice_code_prefix' => 'Prefix kódu faktury',
      'invoice_code_prefix_placeholder' => 'INV-',
      'invoice_code_prefix_helper' => 'Předpona před čísly faktur (např. INV- vytvoří kódy faktur jako INV-001, INV-002).',
      'using_custom_font_for_invoice' => 'Použití vlastního fontu pro fakturu',
      'using_custom_font_for_invoice_helper' => 'Povolte použití vlastního Google Font pro PDF faktury místo výchozího písma.',
      'invoice_font_family' => 'Rodina fontů faktury (Funguje pouze pro latinské jazyky)',
      'invoice_font_family_helper' => 'Vyberte Google Font pro použití v PDF fakturách. Funguje pouze se znaky latinky.',
      'enable_invoice_stamp' => 'Povolit razítko faktury',
      'enable_invoice_stamp_helper' => 'Přidá razítko PAID na faktury po dokončení platby objednávky.',
      'add_language_support' => 'Přidat jazykovou podporu',
      'add_language_support_helper' => 'Vyberte další podporu znakových sad pro nelatinské jazyky v PDF fakturách.',
      'invoice_processing_library' => 'Knihovna zpracování faktur',
      'invoice_processing_library_helper' => 'Vyberte knihovnu pro generování PDF. DomPDF je rychlejší, ale má omezené funkce. mPDF podporuje více jazyků a funkcí, ale může být pomalejší.',
      ...
      'disable_order_invoice_until_order_confirmed_helper' => 'Pokud je povoleno, faktury budou dostupné až po potvrzení objednávky, nikoli ihned po jejím vytvoření.',
      'date_format' => 'Formát data',
      'date_format_helper' => 'Vyberte, jak se budou zobrazovat data na fakturách (např. F d, Y zobrazí January 01, 2024).',
      'languages' =>
      [
        'arabic' => 'Arabština',
  ...
  [
    ...
    [
      ...
      'display_item_tax_at_checkout' => 'Zobrazit daň položky při pokladně',
      'display_item_tax_at_checkout_helper' => 'Zobrazit částku daně (např. "Daň: $10.00") pro každou položku na stránce pokladny.',
      'tax_on_shipping_fee' => 'Uplatnit daň na přepravu',
      'tax_on_shipping_fee_helper' => 'Pokud je povoleno, výchozí sazba daně bude uplatněna na poštovné. Ujistěte se, že je v E-commerce → Daně nakonfigurována výchozí sazba.',
    ],
  ],
  'customer' =>
  [
  ...
  [
    ...
    [
      ...
      'google_ads_conversion_id_helper' => 'Zadejte své ID konverze Google Ads (formát: AW-123456789/AbC-D_efG-h1_ijk-lmN) pro sledování konverzí nákupů na děkovné stránce.',
    ],
    'validation' =>
    [
  ...
  [
    ...
    [
      ...
      'start_number_description' => 'Číslování objednávek začne od této hodnoty',
      'order_number_length' => 'Délka čísla objednávky',
      'order_number_length_description' => 'Minimální počet číslic v čísle objednávky (např. 3 naformátuje 1 jako 001)',
  ...
  'display_bank_info_at_the_checkout_success_page' => 'Zobrazit bankovní informace na stránce úspěšné pokladny?',
  'display_bank_info_at_the_checkout_success_page_helper' => 'Pokud je povoleno, zákazníci uvidí údaje o vašem bankovním účtu na stránce potvrzení objednávky po jejím odeslání. To jim pomůže zjistit, kam převést platbu.',
