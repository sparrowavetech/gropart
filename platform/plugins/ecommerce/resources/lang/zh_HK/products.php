...
return [
    'name' => '產品',
    'description' => '管理實體及數碼產品的庫存、價格及款式',
    'create' => '新增產品',
    'create_product_type' => [
        'physical' => '新增實體產品',
        'digital' => '新增數碼產品',
    ...
    'form' => [
        ...
        'price' => '價格',
        'currency' => '貨幣',
        'currency_for_variations_hint' => '此貨幣將套用於此產品的所有款式。',
        'quantity' => '數量',
        'brand' => '品牌',
        'width' => '寬度',
        'height' => '高度',
        ...
        'barcode' => '條碼（ISBN、UPC、GTIN等） ',
        'barcode_placeholder' => '輸入條碼',
        'cost_per_item' => '每件成本',
        'cost_per_item_placeholder' => '輸入每件成本',
        'cost_per_item_helper' => '顧客不會看到此價格。',
        'price_includes_tax' => '價格含稅',
        'price_includes_tax_helper' => '如果輸入的價格已包含稅金，請勾選此項。系統將通過扣除稅金金額來計算基礎價格。',
        'stock' => [
        ...
        'create_product_variations' => ':link 以建立產品款式！',
        'tags' => '標籤',
        'write_some_tags' => '撰寫一些標籤',
        'variation_existed' => '此款式已存在。',
        'no_attributes_selected' => '未選擇屬性！',
        'added_variation_success' => '成功新增款式！',
        'updated_variation_success' => '成功更新款式！',
        'created_all_variation_success' => '成功建立所有款式！',
    ...
    'products' => '產品',
    'total_products_found' => '找到 :total 個產品',
    'total_product_found' => '找到 :total 個產品',
    'menu' => '產品',
    'control' => [
    ...
    'variations_box_description' => '點擊「編輯屬性」以新增/移除款式屬性，或點擊「新增款式」以新增款式。',
    'save_changes' => '儲存變更',
    'continue' => '繼續',
    'edit_attribute' => '編輯屬性',
    'select_attribute' => '選擇屬性',
    'add_new_variation' => '新增款式',
    'edit_variation' => '編輯款式',
    'generate_variations' => '生成款式',
    'generate_variations_confirmation' => '您確定要為此產品生成款式嗎？',
    'delete_variation' => '刪除款式？',
    'delete_variation_confirmation' => '您確定要刪除此款式嗎？此操作無法撤銷。',
    'delete_variations_confirmation' => '您確定要刪除這些款式嗎？此操作無法撤銷。',
    ...
    'stock_status' => '庫存狀態',
    'processing' => '處理中...',
    'delete_selected_variations' => '刪除選擇的款式',
    'delete_variations' => '刪除款式',
    'category' => '類別',
    'categories' => '分類',
    'tags' => '標籤',
    'product_price_flash_sale_warning' => '此產品正在限時特賣 <strong>:name</strong> 中，因此其價格為 <strong>:price</strong>。',
    'product_price_discount_warning' => '此產品正在折扣 <strong>:name</strong> 中，因此其價格為 <strong>:price</strong>。',
    'product_image' => '產品圖片',
    'product_name' => '產品名稱',
    'product_link' => '產品連結',
    'types' => [
    ...
    'license_codes' => [
        ...
        'manage_codes' => '管理授權碼',
        'management' => '授權碼管理',
        'variation_breadcrumb' => '款式: :name',
        'variation_label' => '產品款式',
        'variation_specific_note' => '這些授權碼專用於此產品款式。購買此款式的顧客將從此池中獲得授權碼。',
        'main_product_note' => '此產品有款式。每個款式可以有自己的授權碼，或者如果款式沒有授權碼，顧客可以從此主產品池中獲得授權碼。',
        'code' => '授權碼',
        'codes' => '授權碼',
        'status' => '狀態',
        'assigned_at' => '分配時間',
        ...
        'add_modal' => [
            ...
            'help' => '輸入一個唯一的授權碼，該授權碼將在購買後分配給顧客。',
        ],
        'generate_modal' => [
            'title' => '生成授權碼',
            'quantity' => '數量',
        ...
        'bulk_delete' => [
            'button' => '刪除選中',
            'selected' => '已選擇',
            'confirm' => '您確定要刪除選中的授權碼嗎？',
            'deleted_successfully' => '成功刪除 :count 個授權碼。',
            'skipped_used_codes' => '已跳過 :count 個已使用的授權碼。',
            'no_deletable_codes' => '找不到可刪除的授權碼。已使用的授權碼無法刪除。',
        ],
        'import' => [
            'name' => '匯入產品授權碼',
            'description' => '從 CSV/Excel 檔案匯入數碼產品的授權碼。',
            'button' => '匯入',
            'columns' => [
                'product_id' => '產品編號或 SKU',
                'license_code' => '授權碼',
            ],
        ],
        'copied' => '授權碼已複製到剪貼簿！',
    ...
    'select' => '選擇',
    'clear_filters' => '清除篩選',
    'set_this_variant_as_default' => '將此款式設為預設',
    'download' => '下載',
    'external_link_downloads' => '外部連結',
    'download_available_when_completed' => '下載連結將在訂單完成後可用。',
    ...
    'up_sale' => [
        'title' => '一起購買更優惠',
        'description' => '同時購買這些商品可享特別折扣',
        'unlock_discount' => '將 :product 加入購物車以解鎖組合折扣',
        'multiple_options' => '多個選項',
        'multiple_options_available' => '有多個選項可供選擇',
        'select' => '選擇',
        'selected_items_total' => '已選商品總計：',
        'add_selected_to_cart' => '將已選加入購物車',
        'bundle_discount_with' => '與 :product 的組合折扣',
        'bundle_with' => '與 :product 組合',
    ],
    'cross_sale' => [
        'title' => '經常一起購買',
        'description' => '瀏覽此商品的顧客也購買了',
    ],
    'apply_for_all_variations' => '套用於所有款式',
    'export' => [
        'description' => '將您的產品資料匯出到 CSV 或 Excel 檔案。',
        'total_items' => '項目總數',
        'total_products' => '產品總數',
        'total_variations' => '款式總數',
        'advanced_options' => '進階選項',
        'use_chunked_export' => '使用分塊匯出',
        'use_chunked_export_helper' => '分塊處理資料以有效處理大型資料集',
        'include_variations' => '包括產品款式',
        'include_variations_helper' => '匯出產品款式以及主產品',
        ...
        'large_dataset_warning_title' => '偵測到大型產品目錄',
        ...
        'use_multi_file' => '使用多檔案匯出',
        'use_multi_file_helper' => '將匯出拆分為多個檔案並打包在 ZIP 中，以處理非常大的資料集',
        'multi_file_enabled_title' => '已啟用多檔案匯出',
        'multi_file_enabled_message' => '您的匯出將拆分為 :count 個檔案並打包在 ZIP 中，以獲得最佳效能。',
        'records_per_file' => '每個檔案的記錄數',
        'records_per_file_helper' => '使用多檔案匯出時每個檔案中的記錄數',
        'estimated_files' => '預計檔案數',
        ...
        'medium_dataset_detected' => '偵測到中型資料集',
    ...
    'import' => [
        'description' => '從 CSV 或 Excel 檔案匯入您的產品資料。',
        'rules' => [
    ...
    'cart' => [
        ...
        'bundle_item_already_in_cart' => '此組合商品已在您的購物車中。每個組合折扣只允許 1 件商品。',
    ],
    'wishlist' => [
    ...
    'compare' => [
        ...
        'list_full' => '您一次最多可以比較 :max 個產品。刪除一個以新增另一個。',
        'url_not_recognized' => '我們在該 URL 上找不到產品。請貼上此網站的產品連結。',
        'slot_count' => ':max 產品中的 :count',
        'highlight_differences' => '突顯差異',
        'copy_share_link' => '複製分享連結',
        'link_copied' => '連結已複製到剪貼簿',
        'additional_attributes' => '附加屬性',
        'add_another' => '再增加一個產品進行比較',
        'paste_url_placeholder' => '貼上產品網址',
        'add_button' => '添加',
        'heading' => '比較',
        'savings_off' => '節省 :percent%',
        'savings_aria' => '此產品可節省 :percent%',
        'picker_title' => '尋找要比較的產品',
        'picker_search_placeholder' => '按名稱搜尋產品...',
        'picker_empty' => '沒有找到產品。',
        'picker_loading' => '正在加載產品...',
        'choose_to_compare' => '選擇比較',
        'load_more' => '加載更多',
        'paste_url_alt' => '或貼上產品網址',
        'vs_separator' => 'vs',
    ],
];
