...
return [
    ...
    'compare' => [
        ...
        'list_full' => 'Naraz môžete porovnávať až :max produktov. Ak chcete pridať ďalšie, odstráňte jeden.',
        'url_not_recognized' => 'Na tejto adrese URL sme nenašli produkt. Vložte odkaz na produkt z tejto stránky.',
        'slot_count' => ':count z :max produktov',
        'highlight_differences' => 'Zvýraznite rozdiely',
        'copy_share_link' => 'Kopírovať odkaz na zdieľanie',
        'link_copied' => 'Odkaz bol skopírovaný do schránky',
        'additional_attributes' => 'Ďalšie atribúty',
        'add_another' => 'Pridajte ďalší produkt na porovnanie',
        'paste_url_placeholder' => 'Prilepte adresu URL produktu',
        'add_button' => 'Pridať',
        'heading' => 'Porovnaj',
        'savings_off' => 'Ušetrite :percent%',
        'savings_aria' => 'Úspora :percent% na tento produkt',
        'picker_title' => 'Nájdite produkt na porovnanie',
        'picker_search_placeholder' => 'Hľadať produkty podľa názvu…',
        'picker_empty' => 'Nenašli sa žiadne produkty.',
        'picker_loading' => 'Načítavajú sa produkty…',
        'choose_to_compare' => 'Vyberte na porovnanie',
        'load_more' => 'Načítať viac',
        'paste_url_alt' => 'Alebo prilepte adresu URL produktu',
        'vs_separator' => 'vs',
    ],
];
