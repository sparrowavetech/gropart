...
return [
    ...
    'compare' => [
        ...
        'list_full' => '最大 :max 製品を一度に比較できます。 1 つを削除して別のを追加します。',
        'url_not_recognized' => 'その URL では製品が見つかりませんでした。このサイトから製品リンクを貼り付けてください。',
        'slot_count' => ':count/:max 製品',
        'highlight_differences' => '相違点を強調表示する',
        'copy_share_link' => '共有リンクをコピーする',
        'link_copied' => 'リンクがクリップボードにコピーされました',
        'additional_attributes' => '追加の属性',
        'add_another' => '比較する別の製品を追加する',
        'paste_url_placeholder' => '商品URLを貼り付けてください',
        'add_button' => '追加',
        'heading' => '比較する',
        'savings_off' => ':percent% 節約',
        'savings_aria' => 'この商品は:percent%割引',
        'picker_title' => '比較する製品を探す',
        'picker_search_placeholder' => '製品を名前で検索…',
        'picker_empty' => '製品が見つかりませんでした。',
        'picker_loading' => '製品を読み込み中…',
        'choose_to_compare' => '比較するものを選択してください',
        'load_more' => 'さらにロードする',
