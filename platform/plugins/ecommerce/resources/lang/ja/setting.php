...
return [
  ...
  [
    ...
    [
      'store_name' => 'ストア名',
      'store_name_placeholder' => 'マイストア',
      'store_name_helper' => 'ストア名はメール、請求書、サイト全体に表示されます。',
      'store_company' => '会社名',
      'store_company_placeholder' => '株式会社マイカンパニー',
      'store_company_helper' => '請求書や公式文書に使用する法人名。',
      'store_phone' => '電話番号',
      'store_phone_placeholder' => '+81 3 1234 5678',
      'store_phone_helper' => '顧客に表示され、請求書に記載される連絡先電話番号。',
      'store_email' => 'ストアメールアドレス',
      'store_email_placeholder' => 'contact@mystore.com',
      'store_email_helper' => '顧客からの問い合わせ用の主要連絡先メールアドレス。請求書にも表示されます。',
      'store_address' => '住所',
      'store_address_placeholder' => '東京都渋谷区1-2-3',
      'store_address_helper' => '請求書に表示され、配送計算に使用される住所。',
      'store_vat_number' => 'Tax ID / VAT番号',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => '請求書に記載する事業者の税務識別番号。',
      'admin_notification_email' => '管理者通知メールアドレス',
      'admin_notification_email_helper' => 'ECサイトの通知（新規注文、返品など）を受信するメールアドレス。空の場合、デフォルトの管理者メールアドレスに送信されます。',
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'アップセル商品を有効にする',
      'is_enabled_up_sale_products_helper' => 'プレミアムアップグレードを促すアップセル商品の提案を表示します。',
      ...
      'delete_product_images_when_deleting' => '商品削除時に商品画像を削除する',
      'delete_product_images_when_deleting_helper' => '有効にすると、商品を削除する際に関連するすべての画像（メイン画像、ギャラリー画像、バリエーション画像を含む）がメディアライブラリから完全に削除されます。',
      'enable_product_currency_selection' => '商品の通貨選択を有効にする',
      'enable_product_currency_selection_helper' => '各商品の通貨を選択できるようにします。価格は表示時にデフォルト通貨に変換されます。',
    ],
  ],
  'product_search' =>
  [
    ...
    [
      ...
      'enable_filter_products_by_rating' => '評価による商品の絞り込みを有効にする',
      ...
      'enable_filter_products_by_labels' => 'ラベルによる商品の絞り込みを有効にする',
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'レビュー画像1枚あたりの最大ファイルサイズ（メガバイト）',
        'max_file_number' => 'レビュー最大ファイル数',
        'max_file_number_help' => '1回のレビューで顧客がアップロードできる画像の最大数',
      ],
      'review_comment_required' => 'レビューコメントを必須にする',
      'review_comment_required_help' => '無効にすると、顧客はコメントを書かずに星評価のみを送信できます',
      'only_allow_customers_purchased_to_review' => '商品を購入した顧客のみが商品をレビューできる',
      'only_allow_customers_purchased_to_review_help' => '有効にすると、その商品を含む完了済み注文がある顧客のみがレビューを投稿できます',
      'review_need_to_be_approved' => '商品ページに表示する前にレビューの承認が必要',
      'review_need_to_be_approved_help' => '有効にすると、新しいレビューは管理者が承認するまで非表示になります',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => '注文の削除を有効にする',
      'enable_order_deletion_helper' => '有効にすると、管理者は注文を削除できます。無効にすると、注文はステータス変更のみ可能で削除できません。監査、レポート、法的目的のためにすべての注文を保持するには、このオプションを無効にしてください。',
  ...
  [
    ...
    [
      ...
      'enable_order_notes_at_checkout' => 'チェックアウト時の注文メモを有効にする',
      'enable_order_notes_at_checkout_helper' => '有効にすると、顧客はチェックアウトページで注文に任意のメモを追加できます（例：特別な配送指示）。',
    ],
  ],
  'return' =>
  [
    ...
    [
      ...
      'allow_customer_upload_image' => '顧客による画像アップロードを許可する',
      'allow_customer_upload_image_help' => '返品リクエスト送信時に顧客が写真をアップロードできるようにします。',
      'max_file_size' => '最大ファイルサイズ（MB）',
      'max_file_size_help' => '画像ファイル1枚あたりの最大サイズ（メガバイト）。',
      'max_file_number' => '最大画像数',
    ],
  ],
  'invoice' =>
  [
    ...
    'company_settings' => '請求書設定',
    'company_settings_description' => '会社情報、請求書番号、PDFフォント、支払い済みスタンプ',
    'form' =>
    [
      'company_name' => '会社名',
  ...
  [
    'name' => '税金',
    'description' => '税計算、表示オプション、チェックアウト請求書フィールド',
    'enable' => '税金を有効にしますか？',
    ...
    'tax_setting' => '税表示とチェックアウト',
    'tax_setting_description' => '商品とチェックアウトページでの税金の表示方法を設定',
    'tax_management' => '税金管理',
    'tax_management_description' => '税金を表示・管理します',
    'manage_taxes_info' => '税金を管理しデフォルトの税率を設定するには、次のページに移動してください',
    'go_to_taxes' => 'Eコマース → 税金',
    'form' =>
    [
      'enable_tax' => '税金を有効にする',
      ...
      'display_checkout_tax_information' => 'チェックアウトで各商品の下に税情報を表示する',
      'display_checkout_tax_information_helper' => 'チェックアウトページの各商品の横に、税の内訳（例：「消費税10%」）を表示します。',
      'display_item_tax_at_checkout' => 'チェックアウト時に商品の税額を表示する',
      'display_item_tax_at_checkout_helper' => 'チェックアウトページで各商品の税額（例：「税: $10.00」）を表示します。',
      'tax_on_shipping_fee' => '送料に税金を適用',
      'tax_on_shipping_fee_helper' => '有効にすると、デフォルトの税率が送料に適用されます。Eコマース → 税金でデフォルトの税率が設定されていることを確認してください。',
    ],
  ],
  'customer' =>
  [
  ...
  [
    ...
    [
      ...
      'volumetric_weight_divisor' => '容積重量の除数',
      'volumetric_weight_divisor_helper' => '0を入力すると無効になります。設定すると、請求対象の配送重量は実重量と、各商品の長さ・幅・高さから計算した容積重量のうち、大きい方が使用されます。除数の単位はストアの表示単位に関わらず、常に1キログラムあたりの立方センチメートル（cm³/kg）です。一般的な値は5000（標準）、6000（航空便）、4000（速達）です。有効にする前に、重量ベースの配送ルールのうち最も重い区分の「上限」を空欄にするか、十分に大きい値にしてください。かさばる注文の重量が増えるため、すべてのルールの範囲を超える注文はどのルールにも一致せず、チェックアウトで配送方法が表示されなくなります。',
    ],
  ],
  'webhook' =>
  [
    'name' => 'Webhook',
    'description' => 'HTTP経由で注文イベントを外部サービスに送信',
    'webhook_setting' => '注文イベントWebhook',
    'webhook_setting_description' => '注文が作成、更新、発送された時に通知を受け取るURLを設定',
    'form' =>
    [
  ...
  [
    ...
    [
      ...
      'google_ads_conversion_id_helper' => 'Google Ads コンバージョンID（形式: AW-123456789/AbC-D_efG-h1_ijk-lmN）を入力して、サンクスページで購入コンバージョンを追跡します。',
    ],
    'validation' =>
    [
  ...
  [
    ...
    [
      ...
      'end_with' => '終了文字',
      'start_number' => '開始番号',
      'start_number_description' => '注文番号はこの値から始まります',
      'order_number_length' => '注文番号の桁数',
      'order_number_length_description' => '注文番号の最小桁数（例：3を設定すると1は001と表示されます）',
  ...
  [
    'name' => '未払いの注文',
    'description' => '支払いが行われなかった保留中の注文を自動的にキャンセルし、在庫を戻します。',
    'panel_description' => '放置されたオンライン決済の注文を自動キャンセルし、在庫を復元します。',
    'form' =>
    [
      'enable' => '保留中の注文の自動キャンセルを有効にする',
      'enable_helper' => '有効にすると、下記の時間を超えた保留中のオンライン決済の注文が自動的にキャンセルされます。代金引換と銀行振込の注文は自動キャンセルされません。',
      'threshold_minutes' => 'キャンセルまでの時間（分）',
      'threshold_minutes_helper' => '保留中の注文をキャンセルするまでの待機時間です。推奨は15〜60分です。',
      'cronjob_not_setup' => '<strong>Cronジョブが設定されていません。</strong>自動キャンセルを利用するには、Cronジョブを正しく設定する必要があります。<a href=":url">今すぐCronジョブを設定する</a>。',
      'cronjob_not_running' => '<strong>Cronジョブが動作していません。</strong>Cronジョブが停止しているようです。サーバーの設定をご確認ください。<a href=":url">Cronジョブの状態を確認する</a>。',
      'cronjob_working' => '<strong>Cronジョブは正常に動作しています。</strong>最終実行：:time。保留中の注文は自動的にキャンセルされます。',
    ],
  ],
  'payment_method_cod_minimum_amount' => '最小注文金額 - :currency（任意）',
  'payment_method_cod_minimum_amount_helper' => '代金引換を利用できる最低注文金額を設定します。下限を設けない場合は0のままにするか、空欄にしてください。',
  'payment_method_cod_maximum_amount' => '上限注文金額 - :currency（任意）',
  'payment_method_cod_maximum_amount_helper' => '代金引換で許可する上限注文金額を設定します。上限を設けない場合は0のままにするか、空欄にしてください。',
  'payment_method_minimum_amount' => '最小注文金額 - :currency（任意）',
  'payment_method_minimum_amount_helper' => 'この支払い方法を利用できる最低注文金額を設定します。下限を設けない場合は0のままにするか、空欄にしてください。',
  'payment_method_maximum_amount' => '上限注文金額 - :currency（任意）',
  'payment_method_maximum_amount_helper' => 'この支払い方法で許可する上限注文金額を設定します。上限を設けない場合は0のままにするか、空欄にしてください。',
  'payment_method_maximum_amount_error' => ':payment_methodでお支払いいただける上限金額は:amountです。ご注文いただくには:more分を減らしてください。',
  'display_bank_info_at_the_checkout_success_page' => 'チェックアウト成功ページで銀行情報を表示しますか？',
  'display_bank_info_at_the_checkout_success_page_helper' => '有効にすると、注文後の注文確認ページにお客様が銀行口座の詳細を確認できるようになります。これにより、お客様は送金先を知ることができます。',
