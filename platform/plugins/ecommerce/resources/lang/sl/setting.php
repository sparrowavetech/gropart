...
return [
  ...
  [
    ...
    [
      ...
      'store_name_helper' => 'Ime vaše trgovine bo prikazano v e-poštnih sporočilih, računih in na celotnem spletnem mestu.',
      'store_company' => 'Ime podjetja',
      'store_company_placeholder' => 'Moje podjetje d.o.o.',
      'store_company_helper' => 'Uradno ime podjetja za račune in uradne dokumente.',
      'store_phone' => 'Telefonska številka',
      'store_phone_placeholder' => '+386 1 234 5678',
      'store_phone_helper' => 'Kontaktna številka, prikazana strankam in na računih.',
      'store_email' => 'E-pošta trgovine',
      'store_email_placeholder' => 'contact@mystore.com',
      'store_email_helper' => 'Glavni kontaktni e-naslov za povpraševanja strank in prikaz na računih.',
      'store_address' => 'Naslov',
      'store_address_placeholder' => 'Glavna ulica 123, 1000 Ljubljana',
      'store_address_helper' => 'Fizični naslov, prikazan na računih in za izračun poštnine.',
      'store_vat_number' => 'Davčna številka / Tax ID / VAT',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'Davčna identifikacijska številka vašega podjetja za račune.',
      'admin_notification_email' => 'E-naslovi za obvestila administratorja',
      'admin_notification_email_helper' => 'E-naslovi za prejemanje obvestil o naročilih, vračilih itd. Če je prazno, bodo obvestila poslana na privzete e-naslove administratorja.',
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'Omogoči dodatne izdelke',
      'is_enabled_up_sale_products_helper' => 'Prikaži predloge dodatnih izdelkov za spodbujanje nakupa dražjih različic.',
      ...
      'delete_product_images_when_deleting' => 'Izbriši slike izdelka ob brisanju',
      'delete_product_images_when_deleting_helper' => 'Ko je omogočeno, bodo vse slike, povezane z izdelkom (vključno z glavno sliko, galerijo in slikami različic), trajno izbrisane iz medijske knjižnice ob brisanju izdelka.',
      'enable_product_currency_selection' => 'Omogoči izbiro valute izdelka',
      'enable_product_currency_selection_helper' => 'Omogoča izbiro valute za vsak izdelek. Cene bodo pretvorjene v privzeto valuto za prikaz.',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'Največja velikost datoteke v megabajtih za vsako naloženo sliko ocene',
        'max_file_number' => 'Maksimalno število datotek ocene',
        'max_file_number_help' => 'Največje število slik, ki jih stranka lahko naloži na oceno',
      ],
      'review_comment_required' => 'Zahtevaj komentar k oceni',
      'review_comment_required_help' => 'Ko je onemogočeno, lahko stranke oddajo zvezdično oceno brez pisanja komentarja',
      'only_allow_customers_purchased_to_review' => 'Samo stranke, ki so kupile izdelek, lahko ocenijo izdelek',
      'only_allow_customers_purchased_to_review_help' => 'Ko je omogočeno, lahko oceno napišejo samo stranke z zaključenim naročilom, ki vsebuje izdelek',
      'review_need_to_be_approved' => 'Ocena mora biti odobrena pred prikazom na strani izdelka',
      'review_need_to_be_approved_help' => 'Ko je omogočeno, bodo nove ocene skrite, dokler jih administrator ne odobri',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'Omogoči brisanje naročil',
      'enable_order_deletion_helper' => 'Če je omogočeno, lahko administratorji brišejo naročila. Če je onemogočeno, lahko naročila le spreminjajo status in jih ni mogoče izbrisati. Onemogočite to možnost za ohranjanje vseh naročil za revizijo, poročanje in pravne namene.',
  ...
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'Dovoli strankam nalaganje slik',
      'allow_customer_upload_image_help' => 'Omogoča strankam nalaganje fotografij pri oddaji zahtevka za vračilo.',
      'max_file_size' => 'Največja velikost datoteke (MB)',
      'max_file_size_help' => 'Največja velikost slikovne datoteke v megabajtih.',
      'max_file_number' => 'Največje število slik',
    ],
  ],
  'invoice' =>
  [
    ...
    [
      ...
      'company_name_helper' => 'Ime vašega podjetja, ki bo prikazano na vseh računih, poslanih strankam.',
      'company_address' => 'Naslov podjetja',
      'company_address_placeholder' => '123 Business Street, Suite 100, New York, NY 10001, USA',
      'company_address_helper' => 'Polni naslov vašega podjetja, vključno z ulico, mestom, državo in državo. Prikazan bo na računih.',
      'company_zipcode' => 'Poštna številka podjetja',
      'company_zipcode_placeholder' => '10001',
      'company_zipcode_helper' => 'Poštna številka naslova vašega podjetja.',
      'company_email' => 'E-pošta podjetja',
      'company_email_placeholder' => 'billing@company.com',
      'company_email_helper' => 'E-poštni naslov za poslovna vprašanja. Stranke ga lahko uporabijo za vprašanja v zvezi z računi.',
      'company_phone' => 'Telefon podjetja',
      'company_phone_placeholder' => '+1 (555) 123-4567',
      'company_phone_helper' => 'Kontaktna telefonska številka, ki bo prikazana na računih za podporo strankam.',
      'company_logo' => 'Logotip podjetja',
      'company_logo_helper' => 'Logotip vašega podjetja, ki bo prikazan na vrhu računov. Priporočena velikost: 200x60 pikslov.',
      'company_tax_id' => 'Davčna številka podjetja',
      'company_tax_id_placeholder' => 'VAT123456789',
      'company_tax_id_helper' => 'Davčna identifikacijska številka vašega podjetja (DDV, GST, EIN itd.) za davčno skladnost.',
      'invoice_code_prefix' => 'Predpona kode računa',
      'invoice_code_prefix_placeholder' => 'INV-',
      'invoice_code_prefix_helper' => 'Predpona, dodana pred številke računov (npr. INV- bo ustvarila kode računov kot INV-001, INV-002).',
      'using_custom_font_for_invoice' => 'Uporaba pisave po meri za račun',
      'using_custom_font_for_invoice_helper' => 'Omogočite uporabo pisave Google Font po meri za PDF račune namesto privzete pisave.',
      'invoice_font_family' => 'Družina pisav računa (Deluje samo za latinske jezike)',
      'invoice_font_family_helper' => 'Izberite Google Font za uporabo v PDF računih. Deluje samo z latiničnimi nabori znakov.',
      'enable_invoice_stamp' => 'Omogoči žig računa',
      'enable_invoice_stamp_helper' => 'Dodajte žig PAID na račune, ko je plačilo naročila zaključeno.',
      'add_language_support' => 'Dodaj podporo za jezik',
      'add_language_support_helper' => 'Izberite dodatno podporo naborov znakov za nelatinične jezike v PDF računih.',
      'invoice_processing_library' => 'Knjižnica za obdelavo računov',
      'invoice_processing_library_helper' => 'Izberite knjižnico za generiranje PDF. DomPDF je hitrejši, a ima omejene funkcije. mPDF podpira več jezikov in funkcij, a je lahko počasnejši.',
      ...
      'disable_order_invoice_until_order_confirmed_helper' => 'Ko je omogočeno, bodo računi na voljo šele po potrditvi naročil, ne takoj po oddaji.',
      'date_format' => 'Format datuma',
      'date_format_helper' => 'Izberite, kako bodo datumi prikazani na računih (npr. F d, Y prikaže January 01, 2024).',
      'languages' =>
      [
        'arabic' => 'Arabščina',
  ...
  [
    ...
    'manage_taxes_info' => 'Za upravljanje davkov in nastavitev privzete davčne stopnje pojdite na',
    'go_to_taxes' => 'E-trgovina → Davki',
    'form' =>
    [
      ...
      'display_item_tax_at_checkout' => 'Prikaži davek artikla na blagajni',
      'display_item_tax_at_checkout_helper' => 'Prikaži znesek davka (npr. "Davek: $10.00") za vsak artikel na strani blagajne.',
      'tax_on_shipping_fee' => 'Uporabi davek na poštnino',
      'tax_on_shipping_fee_helper' => 'Ko je omogočeno, se privzeta davčna stopnja uporabi za poštnino. Prepričajte se, da je privzeta davčna stopnja nastavljena v E-trgovina → Davki.',
    ],
  ],
  'customer' =>
  [
  ...
  [
    ...
    [
      ...
      'start_with' => 'Začni z',
      'end_with' => 'Končaj z',
      'start_number' => 'Začetna številka',
      'start_number_description' => 'Številčenje naročil se bo začelo s to vrednostjo',
      'order_number_length' => 'Dolžina številke naročila',
      'order_number_length_description' => 'Najmanjše število cifer v številki naročila (npr. 3 bo oblikovalo 1 kot 001)',
  ...
  'display_bank_info_at_the_checkout_success_page' => 'Prikaži bančne informacije na strani uspešnega plačila?',
  'display_bank_info_at_the_checkout_success_page_helper' => 'Ko je omogočeno, bodo stranke na strani potrditve naročila videle podatke o vašem bančnem računu po oddaji naročila. To jim pomaga vedeti, kam nakazati plačilo.',
