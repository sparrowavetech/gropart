...
return [
    ...
    'compare' => [
        ...
        'list_full' => 'Puede comparar hasta :max productos a la vez. Elimina uno para agregar otro.',
        'url_not_recognized' => 'No pudimos encontrar un producto en esa URL. Pegue el enlace de un producto de este sitio.',
        'slot_count' => ':count de :max productos',
        'highlight_differences' => 'Resaltar diferencias',
        'copy_share_link' => 'Copiar enlace para compartir',
        'link_copied' => 'Enlace copiado al portapapeles',
        'additional_attributes' => 'Atributos adicionales',
        'add_another' => 'Añade otro producto para comparar',
        'paste_url_placeholder' => 'Pegar URL del producto',
        'add_button' => 'Agregar',
        'heading' => 'Comparar',
        'savings_off' => 'Ahorre :percent%',
        'savings_aria' => ':percent% de ahorro en este producto',
        'picker_title' => 'Encuentra un producto para comparar',
        'picker_search_placeholder' => 'Buscar productos por nombre...',
        'picker_empty' => 'No se encontraron productos.',
        'picker_loading' => 'Cargando productos…',
        'choose_to_compare' => 'Elige comparar',
        'load_more' => 'Cargar más',
        'paste_url_alt' => 'O pegue la URL de un producto',
        'vs_separator' => 'vs',
    ],
];
