...
return [
  ...
  [
    ...
    [
      ...
      'store_name_placeholder' => 'Mi Tienda',
      'store_name_helper' => 'El nombre de su tienda aparecerá en correos electrónicos, facturas y en todo el sitio.',
      'store_company' => 'Nombre de la empresa',
      'store_company_placeholder' => 'Mi Empresa S.L.',
      'store_company_helper' => 'Razón social para facturas y documentos oficiales.',
      'store_phone' => 'Número de teléfono',
      'store_phone_placeholder' => '+34 123 456 789',
      'store_phone_helper' => 'Número de contacto mostrado a los clientes y en las facturas.',
      'store_email' => 'Correo electrónico de la tienda',
      'store_email_placeholder' => 'contacto@mitienda.com',
      'store_email_helper' => 'Correo electrónico de contacto principal para consultas de clientes y mostrado en facturas.',
      'store_address' => 'Dirección',
      'store_address_placeholder' => 'Calle Principal 123, Oficina 100',
      'store_address_helper' => 'Dirección física mostrada en facturas y para cálculos de envío.',
      'store_vat_number' => 'NIF / Número de IVA',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'Su número de identificación fiscal para facturas.',
      'admin_notification_email' => 'Correos de notificación del administrador',
      'admin_notification_email_helper' => 'Correos para recibir notificaciones de comercio electrónico (nuevos pedidos, devoluciones, etc.). Si está vacío, las notificaciones se enviarán a los correos de administrador predeterminados.',
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'Habilitar productos de venta adicional',
      'is_enabled_up_sale_products_helper' => 'Mostrar sugerencias de productos de gama superior para fomentar actualizaciones premium.',
      ...
      'delete_product_images_when_deleting' => 'Eliminar imágenes del producto al eliminarlo',
      'delete_product_images_when_deleting_helper' => 'Cuando está habilitado, todas las imágenes asociadas al producto (incluyendo imagen destacada, galería e imágenes de variaciones) se eliminarán permanentemente de la biblioteca de medios al eliminar el producto.',
      'enable_product_currency_selection' => 'Habilitar selección de moneda por producto',
      'enable_product_currency_selection_helper' => 'Permite seleccionar una moneda para cada producto. Los precios se convertirán a la moneda predeterminada para su visualización.',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'Tamaño máximo de archivo en megabytes para cada imagen de reseña subida',
        'max_file_number' => 'Número máximo de archivos de reseña',
        'max_file_number_help' => 'Número máximo de imágenes que un cliente puede subir por reseña',
      ],
      'review_comment_required' => 'Requerir comentario en la reseña',
      'review_comment_required_help' => 'Cuando está deshabilitado, los clientes pueden enviar una calificación por estrellas sin escribir un comentario',
      'only_allow_customers_purchased_to_review' => 'Solo clientes que han comprado el producto pueden reseñar el producto',
      'only_allow_customers_purchased_to_review_help' => 'Cuando está habilitado, solo los clientes con un pedido completado que contenga el producto pueden dejar una reseña',
      'review_need_to_be_approved' => 'La reseña necesita ser aprobada antes de mostrarse en la página del producto',
      'review_need_to_be_approved_help' => 'Cuando está habilitado, las nuevas reseñas se ocultarán hasta que un administrador las apruebe',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'Habilitar eliminación de pedidos',
      'enable_order_deletion_helper' => 'Si está habilitado, los administradores pueden eliminar pedidos. Si está deshabilitado, los pedidos solo pueden cambiar de estado y no pueden eliminarse. Deshabilite esta opción para conservar todos los pedidos con fines de auditoría, informes y legales.',
  ...
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'Permitir al cliente subir imágenes',
      'allow_customer_upload_image_help' => 'Permite a los clientes subir fotos al enviar solicitudes de devolución.',
      'max_file_size' => 'Tamaño máximo de archivo (MB)',
      'max_file_size_help' => 'Tamaño máximo por archivo de imagen en megabytes.',
      'max_file_number' => 'Número máximo de imágenes',
    ],
  ],
  'invoice' =>
  [
  ...
  [
    ...
    'go_to_taxes' => 'Comercio electrónico → Impuestos',
    'form' =>
    [
      ...
      'display_item_tax_at_checkout' => 'Mostrar impuesto por artículo en el pago',
      'display_item_tax_at_checkout_helper' => 'Mostrar el monto del impuesto (ej.: "Impuesto: $10.00") para cada artículo en la página de pago.',
      'tax_on_shipping_fee' => 'Aplicar impuesto sobre el envío',
      'tax_on_shipping_fee_helper' => 'Cuando está habilitado, la tasa de impuesto predeterminada se aplicará a los gastos de envío. Asegúrese de que una tasa de impuesto predeterminada esté configurada en Comercio electrónico → Impuestos.',
    ],
  ],
  'customer' =>
  [
  ...
  [
    ...
    [
      ...
      'google_ads_conversion_id_helper' => 'Ingrese su ID de conversión de Google Ads (formato: AW-123456789/AbC-D_efG-h1_ijk-lmN) para rastrear conversiones de compra en la página de agradecimiento.',
    ],
    'validation' =>
    [
  ...
  [
    ...
    [
      ...
      'start_number_description' => 'El número de pedido comenzará a partir de este valor',
      'order_number_length' => 'Longitud del número de pedido',
      'order_number_length_description' => 'Número mínimo de dígitos para el número de pedido (ej.: 3 formateará 1 como 001)',
