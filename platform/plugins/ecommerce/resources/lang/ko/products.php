...
return [
    ...
    'compare' => [
        ...
        'list_full' => '한 번에 최대 :max개의 제품을 비교할 수 있습니다. 다른 하나를 추가하려면 하나를 제거하세요.',
        'url_not_recognized' => '해당 URL에서 제품을 찾을 수 없습니다. 이 사이트의 제품 링크를 붙여넣으세요.',
        'slot_count' => ':max 제품 중 :count',
        'highlight_differences' => '차이점 강조',
        'copy_share_link' => '공유 링크 복사',
        'link_copied' => '링크가 클립보드에 복사되었습니다.',
        'additional_attributes' => '추가 속성',
        'add_another' => '비교할 다른 제품을 추가하세요.',
        'paste_url_placeholder' => '제품 URL 붙여넣기',
        'add_button' => '추가하다',
        'heading' => '비교하다',
        'savings_off' => ':percent% 절약',
        'savings_aria' => '이 제품에 대해 :percent% 할인',
        'picker_title' => '비교할 제품을 찾아보세요',
        'picker_search_placeholder' => '이름으로 제품 검색…',
        'picker_empty' => '검색된 상품이 없습니다.',
        'picker_loading' => '제품 로드 중…',
        'choose_to_compare' => '비교를 선택하세요',
        'load_more' => '더 로드하기',
        'paste_url_alt' => '또는 제품 URL을 붙여넣으세요.',
        'vs_separator' => 'vs',
    ],
];
