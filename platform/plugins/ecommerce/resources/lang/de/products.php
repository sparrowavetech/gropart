...
return [
    ...
    'compare' => [
        ...
        'list_full' => 'Sie können bis zu :max Produkte gleichzeitig vergleichen. Entfernen Sie eines, um ein weiteres hinzuzufügen.',
        'url_not_recognized' => 'Wir konnten unter dieser URL kein Produkt finden. Bitte fügen Sie einen Produktlink von dieser Website ein.',
        'slot_count' => ':count von :max Produkten',
        'highlight_differences' => 'Heben Sie Unterschiede hervor',
        'copy_share_link' => 'Teilen-Link kopieren',
        'link_copied' => 'Link in die Zwischenablage kopiert',
        'additional_attributes' => 'Zusätzliche Attribute',
        'add_another' => 'Fügen Sie ein weiteres Produkt zum Vergleich hinzu',
        'paste_url_placeholder' => 'Produkt-URL einfügen',
        'add_button' => 'Hinzufügen',
        'heading' => 'Vergleichen',
        'savings_off' => 'Sparen Sie :percent %',
        'savings_aria' => ':percent % Ersparnis bei diesem Produkt',
        'picker_title' => 'Finden Sie ein Produkt zum Vergleichen',
        'picker_search_placeholder' => 'Produkte nach Namen suchen…',
        'picker_empty' => 'Keine Produkte gefunden.',
        'picker_loading' => 'Produkte werden geladen…',
        'choose_to_compare' => 'Wählen Sie zum Vergleichen',
        'load_more' => 'Mehr laden',
        'paste_url_alt' => 'Oder fügen Sie eine Produkt-URL ein',
        'vs_separator' => 'vs',
    ],
];
