...
return [
  ...
  [
    ...
    [
      ...
      'store_name_placeholder' => 'Mein Shop',
      'store_name_helper' => 'Ihr Shop-Name wird in E-Mails, Rechnungen und auf der gesamten Website angezeigt.',
      'store_company' => 'Firmenname',
      'store_company_placeholder' => 'Meine Firma GmbH',
      'store_company_helper' => 'Offizieller Firmenname für Rechnungen und amtliche Dokumente.',
      'store_phone' => 'Telefonnummer',
      'store_phone_placeholder' => '+49 123 456 7890',
      'store_phone_helper' => 'Kontaktnummer, die Kunden und auf Rechnungen angezeigt wird.',
      'store_email' => 'Shop-E-Mail',
      'store_email_placeholder' => 'kontakt@meinshop.de',
      'store_email_helper' => 'Primäre Kontakt-E-Mail für Kundenanfragen und auf Rechnungen.',
      'store_address' => 'Adresse',
      'store_address_placeholder' => 'Hauptstraße 123, Büro 100',
      'store_address_helper' => 'Physische Adresse, die auf Rechnungen und für Versandberechnungen angezeigt wird.',
      'store_vat_number' => 'Steuernummer / USt-IdNr.',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'Ihre Umsatzsteuer-Identifikationsnummer für Rechnungen.',
      'admin_notification_email' => 'Admin-Benachrichtigungs-E-Mails',
      'admin_notification_email_helper' => 'E-Mails für E-Commerce-Benachrichtigungen (neue Bestellungen, Retouren usw.). Falls leer, werden Benachrichtigungen an die Standard-Admin-E-Mails gesendet.',
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'Up-Selling-Produkte aktivieren',
      'is_enabled_up_sale_products_helper' => 'Up-Selling-Produktvorschläge anzeigen, um Premium-Upgrades zu fördern.',
      ...
      'delete_product_images_when_deleting' => 'Produktbilder beim Löschen des Produkts entfernen',
      'delete_product_images_when_deleting_helper' => 'Wenn aktiviert, werden alle mit dem Produkt verknüpften Bilder (einschließlich Hauptbild, Galeriebilder und Variantenbilder) beim Löschen des Produkts dauerhaft aus der Medienbibliothek entfernt.',
      'enable_product_currency_selection' => 'Produktwährungsauswahl aktivieren',
      'enable_product_currency_selection_helper' => 'Ermöglicht die Auswahl einer Währung pro Produkt. Preise werden zur Anzeige in die Standardwährung umgerechnet.',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'Maximale Dateigröße in Megabyte pro hochgeladenem Bewertungsbild',
        'max_file_number' => 'Maximale Dateianzahl für Bewertungen',
        'max_file_number_help' => 'Maximale Anzahl an Bildern, die ein Kunde pro Bewertung hochladen kann',
      ],
      'review_comment_required' => 'Bewertungskommentar erforderlich',
      'review_comment_required_help' => 'Wenn deaktiviert, können Kunden eine Sternebewertung ohne Kommentar abgeben',
      'only_allow_customers_purchased_to_review' => 'Nur Kunden, die das Produkt gekauft haben, können es bewerten',
      'only_allow_customers_purchased_to_review_help' => 'Wenn aktiviert, können nur Kunden mit einer abgeschlossenen Bestellung des Produkts eine Bewertung abgeben',
      'review_need_to_be_approved' => 'Bewertung muss vor Anzeige auf der Produktseite genehmigt werden',
      'review_need_to_be_approved_help' => 'Wenn aktiviert, werden neue Bewertungen ausgeblendet, bis ein Administrator sie genehmigt',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'Bestellungen löschen aktivieren',
      'enable_order_deletion_helper' => 'Wenn aktiviert, können Admins Bestellungen löschen. Wenn deaktiviert, können Bestellungen nur ihren Status ändern und nicht gelöscht werden. Deaktivieren Sie diese Option, um alle Bestellungen für Prüfungs-, Berichts- und rechtliche Zwecke aufzubewahren.',
  ...
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'Kunden das Hochladen von Bildern erlauben',
      'allow_customer_upload_image_help' => 'Kunden das Hochladen von Fotos bei Rücksendeanfragen ermöglichen.',
      'max_file_size' => 'Maximale Dateigröße (MB)',
      'max_file_size_help' => 'Maximale Größe pro Bilddatei in Megabyte.',
      'max_file_number' => 'Maximale Anzahl an Bildern',
    ],
  ],
  'invoice' =>
  [
  ...
  [
    ...
    'go_to_taxes' => 'E-Commerce → Steuern',
    'form' =>
    [
      ...
      'display_item_tax_at_checkout' => 'Artikelsteuer an der Kasse anzeigen',
      'display_item_tax_at_checkout_helper' => 'Den Steuerbetrag (z. B. "Steuer: 10,00 €") für jeden Artikel auf der Kassenseite anzeigen.',
      'tax_on_shipping_fee' => 'Steuer auf Versandkosten anwenden',
      'tax_on_shipping_fee_helper' => 'Wenn aktiviert, wird der Standard-Steuersatz auf die Versandkosten angewendet. Stellen Sie sicher, dass ein Standard-Steuersatz unter E-Commerce → Steuern konfiguriert ist.',
    ],
  ],
  'customer' =>
  [
  ...
  [
    ...
    [
      ...
      'google_ads_conversion_id_helper' => 'Geben Sie Ihre Google Ads Conversion-ID ein (Format: AW-123456789/AbC-D_efG-h1_ijk-lmN), um Kaufkonversionen auf der Dankesseite zu verfolgen.',
    ],
    'validation' =>
    [
  ...
  [
    ...
    [
      ...
      'start_number_description' => 'Die Bestellnummer beginnt ab diesem Wert',
      'order_number_length' => 'Bestellnummernlänge',
      'order_number_length_description' => 'Mindestanzahl der Ziffern für die Bestellnummer (z. B. 3 formatiert 1 als 001)',
