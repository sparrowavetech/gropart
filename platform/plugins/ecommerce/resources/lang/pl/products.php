...
return [
    ...
    'compare' => [
        ...
        'list_full' => 'Możesz porównać maksymalnie :max produktów na raz. Usuń jedno, aby dodać kolejne.',
        'url_not_recognized' => 'Nie znaleźliśmy produktu pod tym adresem URL. Wklej link do produktu z tej witryny.',
        'slot_count' => ':count z :max produktów',
        'highlight_differences' => 'Zaznacz różnice',
        'copy_share_link' => 'Skopiuj link do udostępniania',
        'link_copied' => 'Link skopiowany do schowka',
        'additional_attributes' => 'Dodatkowe atrybuty',
        'add_another' => 'Dodaj kolejny produkt do porównania',
        'paste_url_placeholder' => 'Wklej adres URL produktu',
        'add_button' => 'Dodać',
        'heading' => 'Porównywać',
        'savings_off' => 'Zaoszczędź :percent%',
        'savings_aria' => ':percent% oszczędności na tym produkcie',
        'picker_title' => 'Znajdź produkt do porównania',
        'picker_search_placeholder' => 'Wyszukaj produkty według nazwy…',
        'picker_empty' => 'Nie znaleziono żadnych produktów.',
        'picker_loading' => 'Ładowanie produktów…',
        'choose_to_compare' => 'Wybierz, aby porównać',
        'load_more' => 'Załaduj więcej',
        'paste_url_alt' => 'Lub wklej adres URL produktu',
        'vs_separator' => 'vs',
    ],
];
