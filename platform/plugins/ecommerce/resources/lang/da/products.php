...
return [
    ...
    'compare' => [
        ...
        'list_full' => 'Du kan sammenligne op til :max produkter på én gang. Fjern en for at tilføje en anden.',
        'url_not_recognized' => 'Vi kunne ikke finde et produkt på den URL. Indsæt venligst et produktlink fra denne side.',
        'slot_count' => ':count af :max produkter',
        'highlight_differences' => 'Fremhæv forskelle',
        'copy_share_link' => 'Kopiér delelink',
        'link_copied' => 'Linket er kopieret til udklipsholderen',
        'additional_attributes' => 'Yderligere attributter',
        'add_another' => 'Tilføj et andet produkt for at sammenligne',
        'paste_url_placeholder' => 'Indsæt produkt-URL',
        'add_button' => 'Tilføje',
        'heading' => 'Sammenligne',
        'savings_off' => 'Spar :percent%',
        'savings_aria' => ':percent% besparelse på dette produkt',
        'picker_title' => 'Find et produkt at sammenligne',
        'picker_search_placeholder' => 'Søg efter produkter efter navn...',
        'picker_empty' => 'Ingen produkter fundet.',
        'picker_loading' => 'Indlæser produkter...',
        'choose_to_compare' => 'Vælg at sammenligne',
        'load_more' => 'Indlæs mere',
        'paste_url_alt' => 'Eller indsæt en produkt-URL',
        'vs_separator' => 'vs',
    ],
];
