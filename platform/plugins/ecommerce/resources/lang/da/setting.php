...
return [
  ...
  [
    ...
    [
      ...
      'store_name_helper' => 'Dit butiksnavn vises i e-mails, fakturaer og på hele hjemmesiden.',
      'store_company' => 'Firmanavn',
      'store_company_placeholder' => 'Mit Firma ApS',
      'store_company_helper' => 'Juridisk firmanavn til fakturaer og officielle dokumenter.',
      'store_phone' => 'Telefonnummer',
      'store_phone_placeholder' => '+45 12 34 56 78',
      'store_phone_helper' => 'Kontaktnummer vist til kunder og på fakturaer.',
      'store_email' => 'Butikkens e-mail',
      'store_email_placeholder' => 'info@minbutik.dk',
      'store_email_helper' => 'Primær kontakt-e-mail til kundehenvendelser og vises på fakturaer.',
      'store_address' => 'Adresse',
      'store_address_placeholder' => 'Hovedgaden 123, sal 1',
      'store_address_helper' => 'Fysisk adresse vist på fakturaer og til forsendelsesberegninger.',
      'store_vat_number' => 'Tax ID / VAT-nummer',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'Dit virksomheds skatteidentifikationsnummer til fakturaer.',
      'admin_notification_email' => 'Administrator notifikations-e-mails',
      'admin_notification_email_helper' => 'E-mails til at modtage e-handelsnotifikationer (nye ordrer, returneringer osv.). Hvis tom, sendes notifikationer til standard admin-e-mails.',
      'admin_notification_email_placeholder' => 'admin@eksempel.dk',
    ],
  ],
  'currency' =>
  [
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'Aktivér mersalgsprodukter',
      'is_enabled_up_sale_products_helper' => 'Vis mersalgsproduktforslag for at opmuntre til premium-opgraderinger.',
      ...
      'delete_product_images_when_deleting' => 'Slet produktbilleder ved sletning af produkt',
      'delete_product_images_when_deleting_helper' => 'Når aktiveret vil alle billeder tilknyttet produktet (inklusive fremhævet billede, galleribilleder og variantbilleder) blive permanent slettet fra mediebiblioteket, når produktet slettes.',
      'enable_product_currency_selection' => 'Aktivér produktvalutavalg',
      'enable_product_currency_selection_helper' => 'Tillad valg af valuta for hvert produkt. Priser konverteres til standardvalutaen til visning.',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'Maksimal filstørrelse i megabytes for hvert uploadet anmeldelsesbillede',
        'max_file_number' => 'Anmeldelse maks antal filer',
        'max_file_number_help' => 'Maksimalt antal billeder en kunde kan uploade pr. anmeldelse',
      ],
      'review_comment_required' => 'Kræv anmeldelseskommentar',
      'review_comment_required_help' => 'Når deaktiveret kan kunder indsende en stjernebedømmelse uden at skrive en kommentar',
      'only_allow_customers_purchased_to_review' => 'Kun kunder der har købt produktet kan anmelde produktet',
      'only_allow_customers_purchased_to_review_help' => 'Når aktiveret kan kun kunder med en gennemført ordre, der indeholder produktet, efterlade en anmeldelse',
      'review_need_to_be_approved' => 'Anmeldelse skal godkendes før visning på produktsiden',
      'review_need_to_be_approved_help' => 'Når aktiveret vil nye anmeldelser være skjulte, indtil en administrator godkender dem',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'Aktivér sletning af ordrer',
      'enable_order_deletion_helper' => 'Hvis aktiveret kan administratorer slette ordrer. Hvis deaktiveret kan ordrer kun ændre status og kan ikke slettes. Deaktivér denne mulighed for at beholde alle ordrer til revision, rapportering og juridiske formål.',
  ...
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'Tillad kunden at uploade billeder',
      'allow_customer_upload_image_help' => 'Gør det muligt for kunder at uploade fotos, når de indsender returanmodninger.',
      'max_file_size' => 'Maksimal filstørrelse (MB)',
      'max_file_size_help' => 'Maksimal størrelse pr. billedfil i megabytes.',
      'max_file_number' => 'Maksimalt antal billeder',
    ],
  ],
  'invoice' =>
  [
    ...
    [
      ...
      'company_name_helper' => 'Dit firma- eller virksomhedsnavn, der vil fremgå på alle fakturaer sendt til kunder.',
      'company_address' => 'Virksomhedsadresse',
      'company_address_placeholder' => '123 Business Street, Suite 100, New York, NY 10001, USA',
      'company_address_helper' => 'Din virksomheds fulde adresse inklusive gade, by, stat og land. Denne vil fremgå på fakturaer.',
      'company_zipcode' => 'Virksomhedspostnummer',
      'company_zipcode_placeholder' => '10001',
      'company_zipcode_helper' => 'Postnummer for din virksomhedsadresse.',
      'company_email' => 'Virksomheds e-mail',
      'company_email_placeholder' => 'billing@company.com',
      'company_email_helper' => 'E-mailadresse til forretningshenvendelser. Kunder kan bruge denne til fakturarelaterede spørgsmål.',
      'company_phone' => 'Virksomhedstelefon',
      'company_phone_placeholder' => '+1 (555) 123-4567',
      'company_phone_helper' => 'Kontakttelefonnummer, der vises på fakturaer til kundesupport.',
      'company_logo' => 'Virksomhedslogo',
      'company_logo_helper' => 'Dit firmalogo, der vises øverst på fakturaer. Anbefalet størrelse: 200x60 pixels.',
      'company_tax_id' => 'Virksomheds CVR-nummer',
      'company_tax_id_placeholder' => 'VAT123456789',
      'company_tax_id_helper' => 'Dit virksomheds skatteidentifikationsnummer (moms, GST, EIN osv.) til skatteoverholdelse.',
      'invoice_code_prefix' => 'Fakturakode præfiks',
      'invoice_code_prefix_placeholder' => 'INV-',
      'invoice_code_prefix_helper' => 'Præfiks tilføjet før fakturanumre (f.eks. vil INV- oprette fakturakoder som INV-001, INV-002).',
      'using_custom_font_for_invoice' => 'Brug tilpasset skrifttype til faktura',
      'using_custom_font_for_invoice_helper' => 'Aktiver for at bruge en brugerdefineret Google Font til faktura-PDF\'er i stedet for standardskrifttypen.',
      'invoice_font_family' => 'Faktura skrifttypefamilie (Virker kun for latinsk sprog)',
      'invoice_font_family_helper' => 'Vælg en Google Font til brug i faktura-PDF\'er. Fungerer kun med latinske tegnsæt.',
      'enable_invoice_stamp' => 'Aktiver fakturastempel',
      'enable_invoice_stamp_helper' => 'Tilføj et PAID-stempel til fakturaer, når ordrebetalingen er gennemført.',
      'add_language_support' => 'Tilføj sprogsupport',
      'add_language_support_helper' => 'Vælg yderligere tegnsætunderstøttelse for ikke-latinske sprog i PDF-fakturaer.',
      'invoice_processing_library' => 'Fakturabehandlingsbibliotek',
      'invoice_processing_library_helper' => 'Vælg PDF-genereringsbiblioteket. DomPDF er hurtigere men har begrænsede funktioner. mPDF understøtter flere sprog og funktioner men kan være langsommere.',
      ...
      'disable_order_invoice_until_order_confirmed_helper' => 'Når aktiveret vil fakturaer kun være tilgængelige efter ordrer er bekræftet, ikke umiddelbart efter bestilling.',
      'date_format' => 'Datoformat',
      'date_format_helper' => 'Vælg hvordan datoer vises på fakturaer (f.eks. F d, Y viser January 01, 2024).',
      'languages' =>
      [
        'arabic' => 'Arabisk',
        'bangladesh' => 'Bengali',
  ...
  [
    ...
    [
      ...
      'display_item_tax_at_checkout' => 'Vis varemoms ved kassen',
      'display_item_tax_at_checkout_helper' => 'Vis momsbeløbet (f.eks. "Moms: 10,00 kr.") for hver vare på betalingssiden.',
      'tax_on_shipping_fee' => 'Anvend skat på forsendelsesgebyr',
      'tax_on_shipping_fee_helper' => 'Når aktiveret, vil standardskattesatsen blive anvendt på forsendelsesgebyrer. Sørg for, at en standardskattesats er konfigureret i E-handel → Skatter.',
    ],
  ],
  'customer' =>
  [
  ...
  [
    ...
    [
      ...
      'start_number_description' => 'Ordrenummeret starter fra denne værdi',
      'order_number_length' => 'Ordrenummerets længde',
      'order_number_length_description' => 'Minimum antal cifre for ordrenummeret (f.eks. 3 formaterer 1 som 001)',
  ...
  'display_bank_info_at_the_checkout_success_page' => 'Vis bankinfo på betalingssuccessiden?',
  'display_bank_info_at_the_checkout_success_page_helper' => 'Når aktiveret vil kunder se dine bankkontooplysninger på ordrebekræftelsessiden efter at have afgivet en ordre. Dette hjælper dem med at vide, hvor de skal overføre betalingen.',
