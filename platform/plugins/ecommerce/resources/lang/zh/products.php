...
return [
    ...
    'compare' => [
        ...
        'list_full' => '您一次最多可以比较 :max 个产品。删除一个以添加另一个。',
        'url_not_recognized' => '我们在该 URL 上找不到产品。请粘贴此网站的产品链接。',
        'slot_count' => ':max 产品中的 :count',
        'highlight_differences' => '突出差异',
        'copy_share_link' => '复制分享链接',
        'link_copied' => '链接已复制到剪贴板',
        'additional_attributes' => '附加属性',
        'add_another' => '添加另一个产品进行比较',
        'paste_url_placeholder' => '粘贴产品网址',
        'add_button' => '添加',
        'heading' => '比较',
        'savings_off' => '节省 :percent%',
        'savings_aria' => '该产品可节省 :percent%',
        'picker_title' => '查找要比较的产品',
        'picker_search_placeholder' => '按名称搜索产品...',
        'picker_empty' => '没有找到产品。',
        'picker_loading' => '正在加载产品...',
        'choose_to_compare' => '选择比较',
        'load_more' => '加载更多',
        'paste_url_alt' => '或者粘贴产品网址',
        'vs_separator' => 'vs',
    ],
];
