...
return [
  ...
  [
    ...
    [
      ...
      'store_name_placeholder' => 'Mon Magasin',
      'store_name_helper' => 'Le nom de votre magasin apparaîtra dans les e-mails, les factures et sur l\\\'ensemble du site.',
      'store_company' => 'Nom de l\\\'entreprise',
      'store_company_placeholder' => 'Ma Société SAS',
      'store_company_helper' => 'Raison sociale pour les factures et documents officiels.',
      'store_phone' => 'Numéro de téléphone',
      'store_phone_placeholder' => '+33 1 23 45 67 89',
      'store_phone_helper' => 'Numéro de contact affiché aux clients et sur les factures.',
      'store_email' => 'E-mail du magasin',
      'store_email_placeholder' => 'contact@monmagasin.com',
      'store_email_helper' => 'E-mail de contact principal pour les demandes clients et affiché sur les factures.',
      'store_address' => 'Adresse',
      'store_address_placeholder' => '123 Rue Principale, Bureau 100',
      'store_address_helper' => 'Adresse physique affichée sur les factures et pour le calcul des frais de livraison.',
      'store_vat_number' => 'Numéro d\\\'identification fiscale / TVA',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'Votre numéro d\\\'identification fiscale pour les factures.',
      'admin_notification_email' => 'E-mails de notification admin',
      'admin_notification_email_helper' => 'E-mails pour recevoir les notifications e-commerce (nouvelles commandes, retours, etc.). Si vide, les notifications seront envoyées aux e-mails admin par défaut.',
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'Activer les produits de vente incitative',
      'is_enabled_up_sale_products_helper' => 'Afficher des suggestions de produits de gamme supérieure pour encourager les mises à niveau.',
      ...
      'delete_product_images_when_deleting' => 'Supprimer les images du produit lors de la suppression',
      'delete_product_images_when_deleting_helper' => 'Lorsqu\\\'activé, toutes les images associées au produit (image principale, galerie et images des variantes) seront définitivement supprimées de la bibliothèque média lors de la suppression du produit.',
      'enable_product_currency_selection' => 'Activer la sélection de devise par produit',
      'enable_product_currency_selection_helper' => 'Permet de sélectionner une devise pour chaque produit. Les prix seront convertis dans la devise par défaut pour l\\\'affichage.',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'Taille maximale en mégaoctets pour chaque image d\\\'avis téléchargée',
        'max_file_number' => 'Nombre maximum de fichiers d\'avis',
        'max_file_number_help' => 'Nombre maximum d\\\'images qu\\\'un client peut télécharger par avis',
      ],
      'review_comment_required' => 'Exiger un commentaire d\\\'avis',
      'review_comment_required_help' => 'Lorsque désactivé, les clients peuvent soumettre une note en étoiles sans écrire de commentaire',
      ...
      'only_allow_customers_purchased_to_review_help' => 'Lorsqu\\\'activé, seuls les clients ayant une commande terminée contenant le produit peuvent laisser un avis',
      'review_need_to_be_approved' => 'L\'avis doit être approuvé avant d\'être affiché sur la page du produit',
      'review_need_to_be_approved_help' => 'Lorsqu\\\'activé, les nouveaux avis seront masqués jusqu\\\'à leur approbation par un administrateur',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'Activer la suppression des commandes',
      'enable_order_deletion_helper' => 'Si activé, les admins peuvent supprimer des commandes. Si désactivé, les commandes peuvent uniquement changer de statut et ne peuvent pas être supprimées. Désactivez cette option pour conserver toutes les commandes à des fins d\\\'audit, de reporting et juridiques.',
  ...
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'Permettre au client de télécharger des images',
      'allow_customer_upload_image_help' => 'Permet aux clients de télécharger des photos lors de la soumission de demandes de retour.',
      'max_file_size' => 'Taille maximale du fichier (Mo)',
      'max_file_size_help' => 'Taille maximale par fichier image en mégaoctets.',
      'max_file_number' => 'Nombre maximum d\\\'images',
    ],
  ],
  'invoice' =>
  [
  ...
  [
    'name' => 'Taxe',
    'description' => 'Calcul des taxes, options d\'affichage et champs de facturation',
    ...
    'tax_setting' => 'Affichage des taxes & paiement',
    'tax_setting_description' => 'Configurez l\'affichage des taxes sur les produits et les pages de paiement',
    'tax_management' => 'Gestion des taxes',
    'tax_management_description' => 'Afficher et gérer vos taxes',
    'manage_taxes_info' => 'Pour gérer les taxes et définir le taux de taxe par défaut, veuillez aller à',
    'go_to_taxes' => 'E-commerce → Taxes',
    'form' =>
    [
      ...
      'display_item_tax_at_checkout' => 'Afficher la taxe par article au paiement',
      'display_item_tax_at_checkout_helper' => 'Afficher le montant de la taxe (ex. : "Taxe : 10,00 $") pour chaque article sur la page de paiement.',
      'tax_on_shipping_fee' => 'Appliquer la taxe sur les frais de livraison',
      'tax_on_shipping_fee_helper' => 'Lorsqu\'activé, le taux de taxe par défaut sera appliqué aux frais de livraison. Assurez-vous qu\'un taux de taxe par défaut est configuré dans E-commerce → Taxes.',
    ],
  ],
  'customer' =>
  [
  ...
  [
    'name' => 'Webhooks',
    'description' => 'Envoyer les événements de commande aux services externes via HTTP',
    'webhook_setting' => 'Webhooks d\'événements de commande',
    'webhook_setting_description' => 'Configurer les URLs pour recevoir des notifications lors de la création, mise à jour ou expédition des commandes',
    'form' =>
    [
  ...
  [
    ...
    [
      ...
      'start_number_description' => 'Le numéro de commande commencera à partir de cette valeur',
      'order_number_length' => 'Longueur du numéro de commande',
      'order_number_length_description' => 'Nombre minimum de chiffres pour le numéro de commande (ex. : 3 formatera 1 en 001)',
