...
return [
    ...
    'compare' => [
        ...
        'list_full' => 'Vous pouvez comparer jusqu\'à :max produits à la fois. Supprimez-en un pour en ajouter un autre.',
        'url_not_recognized' => 'Nous n\'avons pas trouvé de produit à cette URL. Veuillez coller un lien produit depuis ce site.',
        'slot_count' => ':count de :max produits',
        ...
        'additional_attributes' => 'Attributs supplémentaires',
        'add_another' => 'Ajouter un autre produit à comparer',
        'paste_url_placeholder' => 'Coller l\'URL du produit',
        'add_button' => 'Ajouter',
        'heading' => 'Comparer',
        'savings_off' => 'Économisez :percent %',
        'savings_aria' => ':percent % d\'économie sur ce produit',
        'picker_title' => 'Trouver un produit à comparer',
        'picker_search_placeholder' => 'Rechercher des produits par nom…',
        'picker_empty' => 'Aucun produit trouvé.',
        'picker_loading' => 'Chargement des produits…',
        'choose_to_compare' => 'Choisissez de comparer',
        'load_more' => 'Charger plus',
        'paste_url_alt' => 'Ou collez une URL de produit',
        'vs_separator' => 'vs',
    ],
];
