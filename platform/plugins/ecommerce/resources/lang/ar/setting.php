...
return [
  ...
  [
    ...
    [
      ...
      'store_name_placeholder' => 'متجري',
      'store_name_helper' => 'سيظهر اسم متجرك في رسائل البريد الإلكتروني والفواتير وفي جميع أنحاء الموقع.',
      'store_company' => 'اسم الشركة',
      'store_company_placeholder' => 'شركتي المحدودة',
      'store_company_helper' => 'الاسم التجاري القانوني للفواتير والمستندات الرسمية.',
      'store_phone' => 'رقم الهاتف',
      'store_phone_placeholder' => '+1 234 567 890',
      'store_phone_helper' => 'رقم الاتصال المعروض للعملاء وعلى الفواتير.',
      'store_email' => 'البريد الإلكتروني للمتجر',
      'store_email_placeholder' => 'contact@mystore.com',
      'store_email_helper' => 'البريد الإلكتروني الرئيسي لاستفسارات العملاء والمعروض على الفواتير.',
      'store_address' => 'العنوان',
      'store_address_placeholder' => '123 الشارع الرئيسي، جناح 100',
      'store_address_helper' => 'العنوان الفعلي المعروض على الفواتير ولحسابات الشحن.',
      'store_vat_number' => 'الرقم الضريبي / رقم VAT',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'رقم التعريف الضريبي لنشاطك التجاري للفواتير.',
      'admin_notification_email' => 'بريد إشعارات المسؤول',
      'admin_notification_email_helper' => 'عناوين البريد الإلكتروني لاستقبال إشعارات التجارة الإلكترونية (طلبات جديدة، مرتجعات، إلخ). إذا كان فارغًا، سيتم الإرسال إلى بريد المسؤول الافتراضي.',
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'تفعيل منتجات البيع الإضافي',
      'is_enabled_up_sale_products_helper' => 'عرض اقتراحات منتجات البيع الإضافي لتشجيع الترقية إلى منتجات أفضل.',
      ...
      'delete_product_images_when_deleting' => 'حذف صور المنتج عند حذف المنتج',
      'delete_product_images_when_deleting_helper' => 'عند التفعيل، سيتم حذف جميع الصور المرتبطة بالمنتج (بما في ذلك الصورة الرئيسية وصور المعرض وصور المتغيرات) نهائيًا من مكتبة الوسائط عند حذف المنتج.',
      'enable_product_currency_selection' => 'تفعيل اختيار عملة المنتج',
      'enable_product_currency_selection_helper' => 'السماح باختيار عملة لكل منتج. سيتم تحويل الأسعار إلى العملة الافتراضية للعرض.',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'الحد الأقصى لحجم الملف بالميغابايت لكل صورة مراجعة مرفوعة',
        'max_file_number' => 'الحد الأقصى لعدد ملفات المراجعة',
        'max_file_number_help' => 'الحد الأقصى لعدد الصور التي يمكن للعميل رفعها لكل مراجعة',
      ],
      'review_comment_required' => 'تعليق المراجعة مطلوب',
      'review_comment_required_help' => 'عند التعطيل، يمكن للعملاء إرسال تقييم بالنجوم دون كتابة تعليق',
      'only_allow_customers_purchased_to_review' => 'فقط العملاء الذين اشتروا المنتج يمكنهم مراجعة المنتج',
      'only_allow_customers_purchased_to_review_help' => 'عند التفعيل، فقط العملاء الذين لديهم طلب مكتمل يحتوي على المنتج يمكنهم ترك مراجعة',
      'review_need_to_be_approved' => 'المراجعة تحتاج إلى موافقة قبل الظهور في صفحة المنتج',
      'review_need_to_be_approved_help' => 'عند التفعيل، ستكون المراجعات الجديدة مخفية حتى يوافق عليها المسؤول',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'تفعيل حذف الطلبات',
      'enable_order_deletion_helper' => 'إذا تم التفعيل، يمكن للمسؤولين حذف الطلبات. إذا تم التعطيل، يمكن فقط تغيير حالة الطلبات ولا يمكن حذفها. قم بتعطيل هذا الخيار للاحتفاظ بجميع الطلبات لأغراض التدقيق والتقارير والمتطلبات القانونية.',
  ...
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'السماح للعميل برفع صور',
      'allow_customer_upload_image_help' => 'تمكين العملاء من رفع صور عند تقديم طلبات الإرجاع.',
      'max_file_size' => 'الحد الأقصى لحجم الملف (ميغابايت)',
      'max_file_size_help' => 'الحد الأقصى لحجم كل ملف صورة بالميغابايت.',
      'max_file_number' => 'الحد الأقصى لعدد الصور',
    ],
  ],
  'invoice' =>
  [
    ...
    'company_settings' => 'إعدادات الفاتورة',
    'company_settings_description' => 'معلومات الشركة، ترقيم الفواتير، خطوط PDF، وختم الدفع',
    'form' =>
    [
  ...
  [
    'name' => 'الضريبة',
    'description' => 'حساب الضرائب وخيارات العرض وحقول الفاتورة عند الدفع',
    ...
    'tax_setting' => 'عرض الضرائب والدفع',
    'tax_setting_description' => 'تكوين كيفية عرض الضرائب على المنتجات وصفحات الدفع',
    'tax_management' => 'إدارة الضرائب',
    'tax_management_description' => 'عرض وإدارة ضرائبك',
    'manage_taxes_info' => 'لإدارة الضرائب وتعيين معدل الضريبة الافتراضي، يرجى الانتقال إلى',
    'go_to_taxes' => 'التجارة الإلكترونية ← الضرائب',
    'form' =>
    [
      ...
      'display_item_tax_at_checkout' => 'عرض ضريبة المنتج عند الدفع',
      'display_item_tax_at_checkout_helper' => 'عرض مبلغ الضريبة (مثل "الضريبة: $10.00") لكل منتج في صفحة الدفع.',
      'tax_on_shipping_fee' => 'تطبيق الضريبة على رسوم الشحن',
      'tax_on_shipping_fee_helper' => 'عند التفعيل، سيتم تطبيق معدل الضريبة الافتراضي على رسوم الشحن. تأكد من تكوين معدل ضريبة افتراضي في التجارة الإلكترونية ← الضرائب.',
    ],
  ],
  'customer' =>
  [
  ...
  [
    'name' => 'الويب هوك',
    'description' => 'إرسال أحداث الطلبات إلى الخدمات الخارجية عبر HTTP',
    'webhook_setting' => 'ويب هوك أحداث الطلبات',
    'webhook_setting_description' => 'تكوين عناوين URL لتلقي الإشعارات عند تقديم الطلبات أو تحديثها أو شحنها',
    'form' =>
    [
  ...
  [
    ...
    [
      ...
      'start_number_description' => 'سيبدأ رقم الطلب من هذه القيمة',
      'order_number_length' => 'طول رقم الطلب',
      'order_number_length_description' => 'الحد الأدنى لعدد أرقام رقم الطلب (مثلاً، 3 ستنسق 1 كـ 001)',
  ...
  'display_bank_info_at_the_checkout_success_page' => 'عرض معلومات البنك في صفحة نجاح الدفع؟',
  'display_bank_info_at_the_checkout_success_page_helper' => 'عند التفعيل، سيرى العملاء تفاصيل حسابك البنكي في صفحة تأكيد الطلب بعد تقديم الطلب. يساعدهم ذلك في معرفة أين يمكنهم تحويل المبلغ.',
