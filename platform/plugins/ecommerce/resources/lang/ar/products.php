...
return [
    ...
    'compare' => [
        ...
        'list_full' => 'يمكنك مقارنة ما يصل إلى :max من المنتجات في وقت واحد. قم بإزالة واحد لإضافة آخر.',
        'url_not_recognized' => 'لم نتمكن من العثور على منتج على عنوان URL هذا. الرجاء لصق رابط المنتج من هذا الموقع.',
        'slot_count' => ':count من :max المنتجات',
        'highlight_differences' => 'تسليط الضوء على الاختلافات',
        'copy_share_link' => 'انسخ رابط المشاركة',
        'link_copied' => 'تم نسخ الرابط إلى الحافظة',
        'additional_attributes' => 'سمات إضافية',
        'add_another' => 'أضف منتج آخر للمقارنة',
        'paste_url_placeholder' => 'الصق عنوان URL للمنتج',
        'add_button' => 'إضافة',
        'heading' => 'مقارنة',
        'savings_off' => 'حفظ :percent%',
        'savings_aria' => ':percent% توفير على هذا المنتج',
        'picker_title' => 'ابحث عن منتج للمقارنة',
        'picker_search_placeholder' => 'البحث عن المنتجات بالاسم...',
        'picker_empty' => 'لم يتم العثور على منتجات.',
        'picker_loading' => 'جارٍ تحميل المنتجات…',
        'choose_to_compare' => 'اختر للمقارنة',
        'load_more' => 'تحميل المزيد',
        'paste_url_alt' => 'أو قم بلصق عنوان URL للمنتج',
        'vs_separator' => 'ضد',
    ],
];
