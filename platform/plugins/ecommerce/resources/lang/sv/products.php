...
return [
    ...
    'compare' => [
        ...
        'list_full' => 'Du kan jämföra upp till :max produkter på en gång. Ta bort en för att lägga till en annan.',
        'url_not_recognized' => 'Vi kunde inte hitta en produkt på den webbadressen. Vänligen klistra in en produktlänk från den här webbplatsen.',
        'slot_count' => ':count av :max produkter',
        'highlight_differences' => 'Markera skillnader',
        'copy_share_link' => 'Kopiera delningslänk',
        'link_copied' => 'Länken har kopierats till urklipp',
        'additional_attributes' => 'Ytterligare attribut',
        'add_another' => 'Lägg till ytterligare en produkt för att jämföra',
        'paste_url_placeholder' => 'Klistra in produktens URL',
        'add_button' => 'Tillägga',
        'heading' => 'Jämföra',
        'savings_off' => 'Spara :percent%',
        'savings_aria' => ':percent% besparing på denna produkt',
        'picker_title' => 'Hitta en produkt att jämföra',
        'picker_search_placeholder' => 'Sök efter produkter efter namn...',
        'picker_empty' => 'Inga produkter hittades.',
        'picker_loading' => 'Laddar produkter...',
        'choose_to_compare' => 'Välj att jämföra',
        'load_more' => 'Ladda mer',
        'paste_url_alt' => 'Eller klistra in en produkt-URL',
        'vs_separator' => 'vs',
    ],
];
