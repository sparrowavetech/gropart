...
return [
    ...
    'compare' => [
        ...
        'list_full' => 'Du kan sammenligne opptil :max produkter samtidig. Fjern en for å legge til en annen.',
        'url_not_recognized' => 'Vi kunne ikke finne et produkt på den nettadressen. Vennligst lim inn en produktlink fra dette nettstedet.',
        'slot_count' => ':count av :max produkter',
        'highlight_differences' => 'Fremhev forskjeller',
        'copy_share_link' => 'Kopier delelink',
        'link_copied' => 'Linken er kopiert til utklippstavlen',
        'additional_attributes' => 'Ytterligere attributter',
        'add_another' => 'Legg til et annet produkt for å sammenligne',
        'paste_url_placeholder' => 'Lim inn produkt-URL',
        'add_button' => 'Legge til',
        'heading' => 'Sammenligne',
        'savings_off' => 'Spar :percent%',
        'savings_aria' => ':percent% besparelse på dette produktet',
        'picker_title' => 'Finn et produkt å sammenligne',
        'picker_search_placeholder' => 'Søk etter produkter etter navn...',
        'picker_empty' => 'Ingen produkter funnet.',
        'picker_loading' => 'Laster inn produkter …',
        'choose_to_compare' => 'Velg å sammenligne',
        'load_more' => 'Last inn mer',
        'paste_url_alt' => 'Eller lim inn en produkt-URL',
        'vs_separator' => 'vs',
    ],
];
