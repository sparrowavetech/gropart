...
return [
    ...
    'form' => [
        ...
        'price' => 'Price',
        'currency' => 'Currency',
        'currency_for_variations_hint' => 'This currency will be applied to all variations of this product.',
        'quantity' => 'Quantity',
        'brand' => 'Brand',
        'width' => 'Width',
        'height' => 'Height',
        ...
        'is_affiliate' => 'External product',
        'is_affiliate_helper' => 'Sell this product on another website. The "Buy on External Store" button replaces "Add to Cart" and "Buy It Now" on the product page.',
        'external_url' => 'External URL',
        'external_url_helper' => 'The link customers are sent to when they click the external store button.',
    ],
    'price' => 'Price',
    'quantity' => 'Quantity',
    'type' => 'Type',
    ...
    'digital_attachments' => [
        ...
        'no_attachments' => 'No attachments yet. Click the buttons above to add files.',
    ],
    'license_codes' => [
        'title' => 'License Codes',
        ...
        'add_modal' => [
            ...
            'help' => 'Enter a unique license code that will be assigned to a customer upon purchase.',
        ],
        'generate_modal' => [
        ...
        'bulk_delete' => [
            ...
            'selected' => 'selected',
            'confirm' => 'Are you sure you want to delete the selected license codes?',
            'deleted_successfully' => 'Successfully deleted :count license code(s).',
            'skipped_used_codes' => ':count used code(s) were skipped.',
            'no_deletable_codes' => 'No available license codes found to delete. Used codes cannot be deleted.',
        ],
        'import' => [
            'name' => 'Import Product License Codes',
            'description' => 'Import license codes for digital products from CSV/Excel file.',
            'button' => 'Import',
            'columns' => [
    ...
    'download' => 'Download',
    'external_link_downloads' => 'External links',
    'download_available_when_completed' => 'Download links will be available when the order is completed.',
    ...
    'up_sale' => [
        'title' => 'Buy Together & Save',
        'description' => 'Get special discounts when purchasing these items together',
        'unlock_discount' => 'Add :product to cart to unlock bundle discount',
        'multiple_options' => 'Multiple options',
        'multiple_options_available' => 'Multiple options available',
        'select' => 'Select',
        'select_options_hint' => 'Select options to add',
        'selected_items_total' => 'Selected items total:',
        'add_selected_to_cart' => 'Add Selected to Cart',
        'bundle_discount_with' => 'Bundle discount with :product',
        'bundle_with' => 'Bundle with :product',
    ],
    'cross_sale' => [
        'title' => 'Frequently Bought Together',
        'description' => 'Customers who viewed this item also bought',
    ],
    ...
    'cart' => [
        ...
        'external_product' => 'This product is sold on an external store and cannot be added to the cart.',
        'not_enough_quantity' => 'Some products do not have enough stock to update.',
        'empty_success' => 'Your cart has been emptied.',
        'bundle_item_already_in_cart' => 'This bundle item is already in your cart. Only 1 item per bundle discount is allowed.',
    ],
    'wishlist' => [
    ...
    'compare' => [
        ...
        'list_full' => 'You can compare up to :max products at once. Remove one to add another.',
        'url_not_recognized' => 'We could not find a product at that URL. Please paste a product link from this site.',
        'slot_count' => ':count of :max products',
        ...
        'add_another' => 'Add another product to compare',
        'paste_url_placeholder' => 'Paste product URL',
        'add_button' => 'Add',
        'heading' => 'Compare',
        'savings_off' => 'Save :percent%',
        'savings_aria' => ':percent% savings on this product',
        'picker_title' => 'Find a product to compare',
        'picker_search_placeholder' => 'Search products by name…',
        'picker_empty' => 'No products found.',
        'picker_loading' => 'Loading products…',
        'choose_to_compare' => 'Choose to compare',
        'load_more' => 'Load more',
        'paste_url_alt' => 'Or paste a product URL',
        'vs_separator' => 'vs',
        'empty_description' => 'Add up to 4 products side-by-side to spot the differences in spec, price and stock at a glance.',
