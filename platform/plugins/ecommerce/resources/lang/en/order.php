...
return [
    ...
    'upload_return_images' => 'Upload Images',
    'upload_return_images_limit' => 'You can upload up to :total photos (max :max MB each)',
    'return_image_max_size_error' => 'The file :attribute is too large. Maximum size is :max.',
    'return_image_max_files_error' => 'The Return Images must not have more than :max items.',
    'please_select_return_reason' => 'Please select a return reason.',
    ...
    'enter_new_billing_address' => 'Enter new billing address...',
    ...
    'cancellation_reasons' => [
        ...
        'out-of-service-area' => 'Delivery address is outside our service area',
    ...
    'digital_product_downloads' => [
        ...
        'no_files_found' => 'No files found for this product.',
        'no_external_links' => 'No external download links available for this product.',
        'no_downloadable_files' => 'No downloadable files available for this product.',
        'files_not_available' => 'The download files are not available. Please contact support.',
    ],
    'digital_product_checkout' => [
        'title' => 'Digital Product Download',
        'message' => 'Download links for your digital products will be sent to your email address after payment is completed.',
    ],
    ...
    'order_successfully_id' => 'Order successfully. Order number :id',
    'thank_you_name' => 'Thank you, :name!',
    'customer' => 'Customer',
    'your_order_is_confirmed' => 'Your order is confirmed',
    'order_confirmed_message' => "We've accepted your order, and we're getting it ready.",
