...
return [
    ...
    'rule' => [
        ...
        'enum_types' => [
            ...
            'based_on_zipcode_and_weight' => 'Based on zipcode and weight (:unit)',
        ...
        'item' => [
            ...
            'forms' => [
                ...
                'zip_code_from' => 'Zip code from',
                'zip_code_from_placeholder' => 'Start zip code',
                'zip_code_to' => 'Zip code to',
                'zip_code_to_placeholder' => 'End zip code',
                'zip_code_to_helper' => 'Leave empty for exact zip code match',
                'adjustment_price' => 'Adjustment price',
        ...
        'cannot_create_rule_type_for_this_location' => 'The ":type" rule type requires a specific country. Please select a country instead of "All" to use this rule type.',
    ],
