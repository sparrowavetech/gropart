...
return [
    ...
    'compare' => [
        ...
        'list_full' => 'Вы можете сравнить до :max товаров одновременно. Удалите один, чтобы добавить другой.',
        'url_not_recognized' => 'Нам не удалось найти продукт по этому URL-адресу. Вставьте ссылку на товар с этого сайта.',
        'slot_count' => ':count из :max продуктов',
        'highlight_differences' => 'Выделите различия',
        'copy_share_link' => 'Скопировать ссылку «Поделиться»',
        'link_copied' => 'Ссылка скопирована в буфер обмена',
        'additional_attributes' => 'Дополнительные атрибуты',
        'add_another' => 'Добавьте еще один товар для сравнения',
        'paste_url_placeholder' => 'Вставьте URL-адрес продукта',
        'add_button' => 'Добавлять',
        'heading' => 'Сравнивать',
        'savings_off' => 'Сэкономьте :percent%',
        'savings_aria' => 'Экономия :percent% на этом продукте',
        'picker_title' => 'Найдите продукт для сравнения',
        'picker_search_placeholder' => 'Поиск товаров по названию…',
        'picker_empty' => 'Товары не найдены.',
        'picker_loading' => 'Загрузка товаров…',
        'choose_to_compare' => 'Выберите для сравнения',
        'load_more' => 'Загрузить больше',
        'paste_url_alt' => 'Или вставьте URL-адрес продукта',
        'vs_separator' => 'против',
    ],
];
