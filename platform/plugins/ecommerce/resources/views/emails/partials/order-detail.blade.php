    ...
    <table class="bb-table" cellspacing="0" cellpadding="0">
        ...
        <tbody>
            ...
            <tr>
                <td class="bb-pr-0">
                    <a href="">
                        <img src="{{ RvMedia::getImageUrl($orderProduct->product_image, 'thumb') }}" class=" bb-rounded" width="50" alt="" />
                    </a>
                </td>
                ...
                <td class="bb-text-right">{{ format_price($orderProduct->qty * $orderProduct->price) }}</td>
            </tr>
        @endforeach
