                            ...
                            <div class="form-group mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 checkout-button-group">
                                        <button type="submit" style="pointer-events: none;opacity: 0.5;" @if (EcommerceHelper::getMinimumOrderAmount() > Cart::instance('cart')->rawSubTotal()) disabled @endif class="btn payment-checkout-btn payment-checkout-btn-step float-end" data-processing-text="{{ __('Processing. Please wait...') }}" data-error-header="{{ __('Error') }}">
                                            {{ __('Checkout') }}
                                        </button>
                                    </div>
                                </div>
