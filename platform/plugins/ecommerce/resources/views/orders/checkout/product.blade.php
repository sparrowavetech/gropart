<div class="row cart-item">
    ...
    <div class="col-sm-7 col-6">
        <h6 class="mb-0"><a class="fw-bold text-black" href="{{ $product ? route('products.edit', $product->original_product->id) : '#' }}" target="_BLANK" title="{{ $product->original_product->name }}">{{ $product->original_product->name }}</a> @if ($product->isOutOfStock())
