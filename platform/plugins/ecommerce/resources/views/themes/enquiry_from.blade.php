...
<img class="card-img-top lazyload product-thumbnail__img"
    ...
    <div class="form-content">
        <div class="mb-3">
            ...
            <input id="name" type="text" class="form-control @if ($errors->has('name')) is-invalid @endif"
                name="name" value="{{ auth()->user()->name }}" placeholder="{{ __('Enter Full Name') }}" required minlength="3" maxlength="120">
            @if ($errors->has('name'))
        ...
        <div class="mb-3">
            ...
            <input id="email" type="email" class="form-control @if ($errors->has('email')) is-invalid @endif"
                name="email" value="{{ auth()->user()->email }}" placeholder="{{ __('Enter Email') }}" required>
            @if ($errors->has('email'))
                <div class="invalid-feedback">
                    {{ $errors->first('email') }}
                </div>
        ...
        <div class="mb-3">
            ...
            <input id="phone" type="text" class="form-control @if ($errors->has('phone')) is-invalid @endif"
                name="phone" value="{{ auth()->user()->phone }}" placeholder="{{ __('Enter Phone') }}" required>
            @if ($errors->has('phone'))
                <div class="invalid-feedback">
                    {{ $errors->first('phone') }}
                </div>
