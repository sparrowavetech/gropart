...
return [
    ...
    'templates' => [
        ...
        'customer_new_enquiry'      => [
            'title'       => 'plugins/ecommerce::email.enquiry_customer_title',
            'description' => 'plugins/ecommerce::email.enquiry_customer_description',
            'subject'     => 'New Enquiry(s) at {{ site_title }}',
            'can_off'     => true,
            'enabled'     => false,
            'variables'   => [
                'customer_name'    => 'plugins/ecommerce::ecommerce.customer_name',
                ...
                'payment_method'   => 'plugins/ecommerce::ecommerce.payment_method',
                'product_list'     => 'plugins/ecommerce::ecommerce.product_list',
                'enquiry_id'       => 'plugins/ecommerce::ecommerce.enquiry_id',
                'enquiry_description' => 'plugins/ecommerce::ecommerce.enquiry_description',
            ],
        ],
        'admin_new_enquiry'         => [
            'title'       => 'plugins/ecommerce::email.enquiry_title',
            'description' => 'plugins/ecommerce::email.enquiry_description',
            'subject'     => 'New Enquiry(s) at {{ site_title }}',
            'can_off'     => true,
            'enabled'     => false,
            'variables'   => [
