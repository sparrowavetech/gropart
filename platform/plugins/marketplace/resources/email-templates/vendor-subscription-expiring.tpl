        ...
        <tbody>
            <tr>
                <td class="bb-content bb-pb-0" align="center">
                    ...
                    <h1 class="bb-text-center bb-m-0 bb-mt-md">{{ 'plugins/marketplace::subscription.email_templates.vendor_subscription_expiring_title' | trans }}</h1>
                </td>
            </tr>
            <tr>
                <td class="bb-content bb-pb-0">
                    <p>{{ 'plugins/marketplace::subscription.email_templates.greeting' | trans({'vendor_name': vendor_name}) }}</p>
                    <div>{{ 'plugins/marketplace::subscription.email_templates.vendor_subscription_expiring_message' | trans({'plan_name': plan_name, 'days_left': days_left}) | raw }}</div>
                </td>
            </tr>
            <tr>
                <td class="bb-content bb-pb-0">
