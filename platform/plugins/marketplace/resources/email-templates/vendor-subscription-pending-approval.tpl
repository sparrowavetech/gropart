        ...
        <tbody>
            <tr>
                <td class="bb-content bb-pb-0" align="center">
                    ...
                    <h1 class="bb-text-center bb-m-0 bb-mt-md">{{ 'plugins/marketplace::subscription.email_templates.vendor_subscription_pending_approval_title' | trans }}</h1>
                </td>
            </tr>
            <tr>
                <td class="bb-content bb-pb-0">
                    <p>{{ 'plugins/marketplace::subscription.email_templates.greeting_admin' | trans }}</p>
                    <div>{{ 'plugins/marketplace::subscription.email_templates.vendor_subscription_pending_approval_message' | trans({'vendor_name': vendor_name, 'plan_name': plan_name}) | raw }}</div>
                </td>
            </tr>
            <tr>
                <td class="bb-content bb-pb-0">
            ...
            <tr>
                <td class="bb-content bb-text-center">
                    <a href="{{ subscription_url }}" class="bb-btn bb-bg-blue bb-border-blue">{{ 'plugins/marketplace::subscription.email_templates.review_subscription' | trans }}</a>
                </td>
            </tr>
        </tbody>
    </table>
