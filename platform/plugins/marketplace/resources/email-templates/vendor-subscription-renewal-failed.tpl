        ...
        <tbody>
            <tr>
                <td class="bb-content bb-pb-0" align="center">
                    ...
                    <h1 class="bb-text-center bb-m-0 bb-mt-md">{{ 'plugins/marketplace::subscription.email_templates.vendor_subscription_renewal_failed_title' | trans }}</h1>
                </td>
            </tr>
            <tr>
                <td class="bb-content bb-pb-0">
                    <p>{{ 'plugins/marketplace::subscription.email_templates.greeting' | trans({'vendor_name': vendor_name}) }}</p>
                    <div>{{ 'plugins/marketplace::subscription.email_templates.vendor_subscription_renewal_failed_message' | trans({'plan_name': plan_name, 'grace_ends_at': grace_ends_at}) | raw }}</div>
                </td>
            </tr>
            <tr>
                <td class="bb-content bb-pb-0">
                    <table class="bb-table" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <td>{{ 'plugins/marketplace::subscription.email.grace_ends_at' | trans }}</td>
                                <td align="right"><strong>{{ grace_ends_at }}</strong></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
