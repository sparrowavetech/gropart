        ...
        <tbody>
            <tr>
                <td class="bb-content bb-pb-0" align="center">
                    ...
                    <h1 class="bb-text-center bb-m-0 bb-mt-md">{{ 'plugins/marketplace::subscription.email_templates.vendor_subscription_expired_title' | trans }}</h1>
                </td>
            </tr>
            <tr>
                <td class="bb-content bb-pb-0">
                    <p>{{ 'plugins/marketplace::subscription.email_templates.greeting' | trans({'vendor_name': vendor_name}) }}</p>
                    <div>{{ 'plugins/marketplace::subscription.email_templates.vendor_subscription_expired_message' | trans({'plan_name': plan_name}) | raw }}</div>
                </td>
            </tr>
            <tr>
                <td class="bb-content bb-pb-0">
