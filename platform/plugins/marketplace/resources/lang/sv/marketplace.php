...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => 'Avisering om lågt lager',
        'store_low_stock_description' => 'Skicka e-post till säljaren när produktlagret sjunker under tröskelvärdet',
        'store_low_stock_subject' => 'Varning om lågt lager: {{ product_name }} håller på att ta slut',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => 'Varning om lågt lager',
        'store_low_stock_message' => 'Din produkt <strong>:product_name</strong> har lågt lager med bara <strong>:product_quantity</strong> kvar. Tröskelvärdet för lågt lager är satt till <strong>:low_stock_threshold</strong>.',
        'store_low_stock_restock' => 'Vänligen fyll på lagret av denna produkt för att undvika förlorade försäljningar.',
        'store_low_stock_view_product' => 'Visa produkt',
        'store_verified_title' => 'Butiksverifiering Godkänd',
    ...
    'settings' => [
        ...
        'enable_stores_page' => 'Aktivera butikslista?',
        'enable_stores_page_helper' => 'Om inaktiverad, kommer butikslistasidan (t.ex. /stores) returnera ett 404-fel.',
        ...
        'hide_store_info_in_invoice' => 'Dölj butiksinformation på fakturan?',
        'hide_store_info_in_invoice_helper' => 'Om aktiverat kommer fakturor att använda huvudwebbplatsens information i stället för leverantörens/butikens information.',
        ...
        'allow_vendor_manage_product_currency' => 'Tillåt leverantörer att hantera produktens valuta',
        'allow_vendor_manage_product_currency_description' => 'Om det är aktiverat kan leverantörer välja en valuta för sina produkter. Priserna kommer att konverteras till standardvalutan för visning.',
        ...
        'low_stock_threshold' => 'Tröskelvärde för lågt lager',
        'low_stock_threshold_helper' => 'När produktkvantiteten sjunker till detta nummer eller lägre, kommer säljaren att få en e-postavisering. Standard är 5.',
    ],
    'theme_options' => [
        'name' => 'Marknadsplats',
    ...
    'product_quantity' => 'Produktkvantitet',
    'low_stock_threshold' => 'Tröskelvärde för lågt lager',
    ...
    'forms' => [
        'back' => 'Tillbaka',
        'drop_files_here_or_click_to_upload' => 'Släpp filer här eller klicka för att ladda upp',
        'check' => 'Kontrollera',
        'error' => 'Fel',
        'confirm_delete_image' => 'Är du säker på att du vill ta bort den här bilden?',
    ...
    'drop_certificate_here' => 'Släpp registreringsbevis här eller klicka för att ladda upp',
    'government_id' => 'Officiell ID-handling',
    'drop_government_id_here' => 'Släpp ID-handling här eller klicka för att ladda upp',
    'documents' => 'Dokument',
    ...
    'already_vendor' => 'Du är redan säljare.',
    'updated_registration_successfully' => 'Registrering uppdaterad framgångsrikt',
    'updated_registration_info_successfully' => 'Registreringsinformation uppdaterades!',
    ...
    'fees' => 'Avgifter',
    'congratulations_vendor' => 'Grattis till att du är säljare på :site_title',
    'attract_customers_message' => 'Låt oss locka kunder genom att lägga till din första produkt.',
    'choose_product_type_to_create' => 'Välj vilken typ av produkt du vill skapa:',
    'create_new_product_here' => 'Skapa en ny produkt <a href=":url">här</a>',
    'no_orders_yet_message' => 'Du har :total produkt(er) men inga beställningar ännu',
    'view_your_store_here' => 'Se din butik <a href=":url">här</a>',
    ...
    'go_to_customer_dashboard' => 'Kundinstrumentpanel',
