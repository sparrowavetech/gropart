...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => '库存不足通知',
        'store_low_stock_description' => '当产品库存低于阈值时向卖家发送邮件',
        'store_low_stock_subject' => '库存不足警告：{{ product_name }} 即将售罄',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => '库存不足警告',
        'store_low_stock_message' => '您的产品 <strong>:product_name</strong> 库存不足，仅剩 <strong>:product_quantity</strong> 件。低库存阈值设置为 <strong>:low_stock_threshold</strong>。',
        'store_low_stock_restock' => '请及时补货以免错过销售机会。',
        'store_low_stock_view_product' => '查看产品',
        'store_verified_title' => '店铺验证已批准',
    ...
    'settings' => [
        ...
        'fee_withdrawal_amount_helper' => '当卖家请求提款时收取的金额或百分比。',
        'withdrawal_fee_type' => '提现费用类型',
        'withdrawal_fee_type_helper' => '选择提款费用是固定金额还是提款金额的百分比。',
        'withdrawal_fee_types' => [
            'fixed' => '固定金额',
            'percentage' => '百分比',
        ],
        'check_valid_signature' => '检查卖家收入中的有效签名',
        'check_valid_signature_helper' => '如果启用，系统将验证卖家收入记录的完整性以防止篡改。',
        ...
        'enable_stores_page' => '启用店铺列表页面？',
        'enable_stores_page_helper' => '如果禁用，店铺列表页面（如 /stores）将返回404错误。',
        'hide_store_phone_number' => '隐藏店铺电话号码？',
        'hide_store_phone_number_helper' => '如果启用，商店电话号码将从公共商店页面隐藏。',
        'hide_store_email' => '隐藏店铺邮箱？',
        'hide_store_email_helper' => '如果启用，商店邮箱将从公共商店页面隐藏。',
        'hide_store_address' => '隐藏店铺地址？',
        'hide_store_address_helper' => '如果启用，商店地址将从公共商店页面隐藏。',
        'hide_store_social_links' => '隐藏店铺社交链接？',
        'hide_store_social_links_helper' => '如果启用，商店社交链接将从公共商店页面隐藏。',
        'hide_store_info_in_invoice' => '发票中隐藏店铺信息？',
        'hide_store_info_in_invoice_helper' => '如果启用，发票将使用主站的信息而不是卖家/店铺信息。',
        ...
        'max_upload_filesize_helper' => '卖家可以上传的最大文件大小（兆字节）。',
        'max_product_images_upload_by_vendor' => '每个产品的最大图片数量',
        'max_product_images_upload_by_vendor_helper' => '限制卖家每个产品可以上传的图片数量。',
        ...
        'allow_vendor_manage_product_currency' => '允许供应商管理产品货币',
        'allow_vendor_manage_product_currency_description' => '如果启用，供应商可以为其产品选择货币。价格将转换为默认货币进行显示。',
        ...
        'allow_vendor_digital_products' => '允许卖家销售数字产品',
        'allow_vendor_digital_products_helper' => '启用此选项以允许卖家创建和销售数字/可下载产品。',
        'low_stock_threshold' => '低库存阈值',
        'low_stock_threshold_helper' => '当产品数量降至此数字或以下时，卖家将收到邮件通知。默认值为5。',
    ],
    'theme_options' => [
        'name' => '市场',
        'description' => '市场主题选项',
    ...
    'forms' => [
        'back' => '返回',
        'drop_files_here_or_click_to_upload' => '将文件拖到此处或点击上传',
        'check' => '检查',
        'error' => '错误',
        'confirm_delete_image' => '您确定要删除这张图片吗？',
        'character_remain' => '剩余字符',
    ],
    ...
    'drop_certificate_here' => '将公司注册证书拖到此处或点击上传',
    'government_id' => '政府签发的身份证件',
    'drop_government_id_here' => '将政府签发的身份证件拖到此处或点击上传',
    'documents' => '文档',
    'store_products' => '店铺商品',
    'store_orders' => '店铺订单',
    'total_revenue' => '总收入',
    ...
    'specification_groups' => '规格组',
    'specification_attributes' => '规格属性',
    'specification_tables' => '规格表',
    'register_as' => '注册为',
    'register' => '注册',
    'i_am_customer' => '我是客户',
    'i_am_vendor' => '我是卖家',
    ...
    'send_message_successfully' => '发送消息成功！',
    'cannot_send_message_to_own_store' => '您无法向自己的商店发送消息。',
    'vendor_account_not_verified' => '供应商帐户未经过验证。',
    'invalid_signature' => '供应商信息签名无效',
    'file_not_found' => '未找到文件！',
    'notices' => [
        'file_not_found' => '找不到该文件。',
    ],
    'update_successfully' => '更新成功！',
    'shop_url_exists' => '商店网址已存在。请选择另一项！',
    'insufficient_balance' => '余额不足或没有银行信息',
    'total_amount_exceeds_balance' => '总金额（含费用）超过您当前的余额',
    'registered_successfully' => '注册成功！',
    'already_vendor' => '您已经是卖家了。',
    'updated_registration_successfully' => '注册信息更新成功！',
    'updated_registration_info_successfully' => '注册信息更新成功！',
    'missing_documentations' => '缺少文档！请上传您的公司注册证书和政府身份证件以继续。',
    'only_add_products_from_same_store' => '您只能将同一商店的产品添加到购物车。',
    'checkout_only_one_store' => '一次只能对一家商店的产品进行结账。请先移除其他商店的商品，然后再继续。',
    'coupon_code_invalid' => '优惠券代码无效或不适用于产品',
    'recovered_from_previous_orders' => '您已从之前的订单中恢复过来！',
    'not_available' => '无法使用',
    'available' => '可用的',
    'stores_seo_title' => '商店列表页面 SEO 标题',
    'stores_seo_description' => '商店列表页面 SEO 描述',
    'leave_empty_for_default' => '将其留空以使用默认描述。',
    'stores' => '商店',
    'total_products_found' => ':total 找到产品',
    'language' => '语言',
    'save_settings' => '保存设置',
    'payout_info' => '付款信息',
    'payment_method' => '付款方式',
    'bank_name' => '银行名称',
    'bank_code_ifsc' => '银行代码/IFSC',
    'account_holder_name' => '账户持有人姓名',
    'account_number' => 'Account Number',
    'upi_id' => '统一识别​​码',
    'upi_id_helper' => '它是可选的。如果您有 UPI ID，可以在此处提供。了解更多：https://support.google.com/pay/india/answer/10331134?hl=en',
    'description' => '描述',
    'paypal_id' => '贝宝 ID',
    'pickup_location' => '接送地点',
    'pickup_location_helper' => '您想在哪里领取现金付款？',
    'contact_name' => '联系人姓名',
    'contact_phone' => '联系电话',
    'business_name' => '公司名称',
    'tax_id' => '税号',
    ...
    'conversion_rate' => '转化率',
    'avg_order_value' => '平均。订单价值',
    'fulfillment_rate' => '履行率',
    'store_visibility' => '商店可见度',
    'active' => '积极的',
    'sales_reports' => '销售报告',
    'revenues_in_label' => '收入:label',
    'earnings_in_label' => '收入:label',
    'fees' => '费用',
    'congratulations_vendor' => '恭喜您成为 :site_title 的供应商',
    'attract_customers_message' => '用最好的产品吸引您的客户。',
    'choose_product_type_to_create' => '选择您要创建的产品类型：',
    'create_new_product_here' => '创建新产品<a href=":url">此处</a>',
    'no_orders_yet_message' => '您有 :total 产品，但还没有订单',
    'view_your_store_here' => '查看您的商店<a href=":url">此处</a>',
    'includes_order_statuses' => '包括已完成、待处理和处理状态',
    'wait_for_approval' => '等待批准',
    'uploaded_certificate' => '已上传证书',
    'uploaded_government_id' => '上传的政府身份证件',
    'store' => '店铺',
    'tax_info' => '税务信息',
    'joined_on_date' => '已加入:date',
    'view_your_store' => '查看您的商店',
    'go_to_homepage' => '前往主页',
    'go_to_customer_dashboard' => '客户仪表板',
    'recent_orders' => '最近订单',
    'no_orders' => '没有订单！',
    'view_full_orders' => '查看完整订单',
    'customer_reviews' => '客户评论',
    'no_reviews_yet' => '还没有评论',
    'reviews_require_ecommerce' => '评论功能需要电子商务插件',
    'view_all_products' => '查看所有产品',
    'top_selling_products' => '畅销商品',
    'no_products' => '没有产品！',
    'view_full_products' => '查看完整产品',
