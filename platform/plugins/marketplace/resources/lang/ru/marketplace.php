...
return [
    ...
    'email' => [
        ...
        'description' => 'Настройка шаблонов электронной почты для Marketplace',
        ...
        'store_low_stock_title' => 'Уведомление о низком остатке',
        'store_low_stock_description' => 'Отправить письмо продавцу, когда остаток товара опустится ниже порога',
        'store_low_stock_subject' => 'Предупреждение о низком остатке: {{ product_name }} заканчивается',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => 'Предупреждение о низком остатке',
        'store_low_stock_message' => 'У вашего товара <strong>:product_name</strong> низкий остаток — осталось только <strong>:product_quantity</strong> шт. Порог низкого остатка установлен на <strong>:low_stock_threshold</strong>.',
        'store_low_stock_restock' => 'Пожалуйста, пополните запасы этого товара, чтобы не упустить продажи.',
        'store_low_stock_view_product' => 'Посмотреть товар',
        'store_verified_title' => 'Верификация магазина одобрена',
    ...
    'settings' => [
        ...
        'default_commission_fee_helper' => 'Установите процент от каждой продажи, который идет на маркетплейс в качестве комиссии.',
        'fixed_commission_fee' => 'Фиксированная комиссия (за заказ)',
        'fixed_commission_fee_helper' => 'Фиксированная сумма, добавляемая к комиссии и взимаемая один раз за заказ продавца сверх указанного выше процента. Полезно для покрытия фиксированной части комиссий платёжного шлюза (напр. Stripe/PayPal €0,25). Оставьте 0, чтобы отключить.',
        'enable_commission_fee_for_each_category' => 'Включить комиссию для каждой категории?',
        'enable_commission_fee_for_each_category_helper' => 'Если включено, вы можете установить разные ставки комиссии для каждой категории товаров.',
        ...
        'fee_withdrawal_amount_helper' => 'Сумма или процент, взимаемые при запросе продавцами вывода средств.',
        'withdrawal_fee_type' => 'Тип комиссии за снятие',
        'withdrawal_fee_type_helper' => 'Выберите, является ли комиссия за вывод фиксированной суммой или процентом от вывода.',
        'withdrawal_fee_types' => [
            'fixed' => 'Фиксированная сумма',
            'percentage' => 'Процент',
        ],
        'check_valid_signature' => 'Проверка действительной подписи в доходах продавца',
        'check_valid_signature_helper' => 'Если включено, система проверит целостность записей о доходах продавцов для предотвращения подделки.',
        ...
        'enable_stores_page' => 'Включить страницу списка магазинов?',
        'enable_stores_page_helper' => 'Если отключено, страница списка магазинов (напр. /stores) вернёт ошибку 404.',
        'hide_store_phone_number' => 'Скрыть номер телефона магазина?',
        'hide_store_phone_number_helper' => 'Если включено, номер телефона магазина будет скрыт на публичной странице магазина.',
        'hide_store_email' => 'Скрыть электронную почту магазина?',
        'hide_store_email_helper' => 'Если включено, email магазина будет скрыт на публичной странице магазина.',
        'hide_store_address' => 'Скрыть адрес магазина?',
        'hide_store_address_helper' => 'Если включено, адрес магазина будет скрыт на публичной странице магазина.',
        'hide_store_social_links' => 'Скрыть социальные ссылки магазина?',
        'hide_store_social_links_helper' => 'Если включено, социальные ссылки магазина будут скрыты на публичной странице магазина.',
        'hide_store_info_in_invoice' => 'Скрыть информацию о магазине в счете?',
        'hide_store_info_in_invoice_helper' => 'Если включено, в счетах будет использоваться информация основного сайта вместо информации продавца/магазина.',
        ...
        'max_upload_filesize_helper' => 'Максимальный размер файла в мегабайтах, который могут загружать продавцы.',
        'max_product_images_upload_by_vendor' => 'Максимальное количество изображений для каждого товара',
        'max_product_images_upload_by_vendor_helper' => 'Ограничьте количество изображений, которые продавцы могут загружать для каждого товара.',
        ...
        'allow_vendor_manage_product_currency' => 'Разрешить продавцам управлять валютой продукта',
        'allow_vendor_manage_product_currency_description' => 'Если этот параметр включен, продавцы могут выбирать валюту для своих продуктов. Цены будут конвертированы в валюту по умолчанию для отображения.',
        ...
        'allow_vendor_digital_products' => 'Разрешить продавцам продавать цифровые товары',
        'allow_vendor_digital_products_helper' => 'Включите это, чтобы позволить продавцам создавать и продавать цифровые/загружаемые товары.',
        'low_stock_threshold' => 'Порог низкого остатка',
        'low_stock_threshold_helper' => 'Когда количество товара упадёт до этого числа или ниже, продавец получит уведомление по электронной почте. По умолчанию — 5.',
    ],
    'theme_options' => [
        'name' => 'Торговая площадка',
    ...
    'forms' => [
        'back' => 'Назад',
        'drop_files_here_or_click_to_upload' => 'Перетащите файлы сюда или нажмите для загрузки',
        'check' => 'Проверить',
        'error' => 'Ошибка',
        'confirm_delete_image' => 'Вы уверены, что хотите удалить это изображение?',
        'character_remain' => 'символов осталось',
    ],
    ...
    'drop_certificate_here' => 'Перетащите свидетельство о регистрации сюда или нажмите для загрузки',
    'government_id' => 'Документ, удостоверяющий личность',
    'drop_government_id_here' => 'Перетащите документ, удостоверяющий личность, сюда или нажмите для загрузки',
    'documents' => 'Документы',
    ...
    'already_vendor' => 'Вы уже являетесь продавцом.',
    'updated_registration_successfully' => 'Информация регистрации успешно обновлена!',
    'updated_registration_info_successfully' => 'Регистрационная информация успешно обновлена!',
    ...
    'choose_product_type_to_create' => 'Выберите тип продукта, который вы хотите создать:',
    ...
    'go_to_customer_dashboard' => 'Панель управления клиента',
