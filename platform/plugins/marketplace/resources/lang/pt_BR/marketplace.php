...
return [
    ...
    'email_templates' => [
        ...
        'store_low_stock_message' => 'Seu produto <strong>:product_name</strong> está com estoque baixo, restando apenas <strong>:product_quantity</strong> unidade(s). O limite de estoque baixo está definido em <strong>:low_stock_threshold</strong>.',
    ...
    'forms' => [
        'back' => 'Voltar',
        'drop_files_here_or_click_to_upload' => 'Solte arquivos aqui ou clique para fazer upload',
        'check' => 'Verificar',
        'error' => 'Erro',
    ...
    'certificate_of_incorporation' => 'Certificado de Constituição',
    'drop_certificate_here' => 'Solte o Certificado de Constituição aqui ou clique para fazer upload',
    'government_id' => 'Documento de Identidade',
    'drop_government_id_here' => 'Solte o Documento de Identidade aqui ou clique para fazer upload',
