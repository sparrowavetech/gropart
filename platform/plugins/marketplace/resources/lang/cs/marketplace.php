...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => 'Upozornění na nízké zásoby',
        'store_low_stock_description' => 'Odeslat e-mail prodejci, když zásoby produktu klesnou pod hranici',
        'store_low_stock_subject' => 'Upozornění na nízké zásoby: {{ product_name }} dochází',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => 'Upozornění na nízké zásoby',
        'store_low_stock_message' => 'Váš produkt <strong>:product_name</strong> má nízké zásoby, zbývá pouze <strong>:product_quantity</strong> kusů. Hranice nízkých zásob je nastavena na <strong>:low_stock_threshold</strong>.',
        'store_low_stock_restock' => 'Prosím doplňte zásoby tohoto produktu, abyste nepřicházeli o prodeje.',
        'store_low_stock_view_product' => 'Zobrazit produkt',
        'store_verified_title' => 'Ověření obchodu schváleno',
    ...
    'settings' => [
        ...
        'enable_stores_page' => 'Povolit stránku se seznamem obchodů?',
        'enable_stores_page_helper' => 'Pokud je zakázáno, stránka se seznamem obchodů (např. /stores) vrátí chybu 404.',
        ...
        'hide_store_info_in_invoice' => 'Skrýt informace o obchodu na faktuře?',
        'hide_store_info_in_invoice_helper' => 'Je-li povoleno, faktury budou používat informace hlavní stránky místo informací prodejce/obchodu.',
        ...
        'allow_vendor_manage_product_currency' => 'Umožněte dodavatelům spravovat měnu produktu',
        'allow_vendor_manage_product_currency_description' => 'Pokud je tato možnost povolena, dodavatelé si mohou vybrat měnu pro své produkty. Ceny budou převedeny na výchozí měnu pro zobrazení.',
        ...
        'low_stock_threshold' => 'Hranice nízkých zásob',
        'low_stock_threshold_helper' => 'Když množství produktu klesne na toto číslo nebo pod něj, prodejce obdrží e-mailové upozornění. Výchozí hodnota je 5.',
    ],
    'theme_options' => [
        'name' => 'Tržiště',
    ...
    'product_quantity' => 'Množství produktu',
    'low_stock_threshold' => 'Hranice nízkých zásob',
    ...
    'forms' => [
        'back' => 'Zpět',
        'drop_files_here_or_click_to_upload' => 'Přetáhněte soubory sem nebo klikněte pro nahrání',
        'check' => 'Zkontrolovat',
        'error' => 'Chyba',
        'confirm_delete_image' => 'Opravdu chcete smazat tento obrázek?',
        'character_remain' => 'zbývajících znaků',
    ],
    ...
    'drop_certificate_here' => 'Přetáhněte osvědčení o založení sem nebo klikněte pro nahrání',
    'government_id' => 'Doklad totožnosti',
    'drop_government_id_here' => 'Přetáhněte doklad totožnosti sem nebo klikněte pro nahrání',
    'documents' => 'Dokumenty',
    ...
    'already_vendor' => 'Již jste prodejcem.',
    'updated_registration_successfully' => 'Registrační informace byly úspěšně aktualizovány!',
    'updated_registration_info_successfully' => 'Registrační údaje byly úspěšně aktualizovány!',
    ...
    'choose_product_type_to_create' => 'Vyberte typ produktu, který chcete vytvořit:',
    ...
    'go_to_customer_dashboard' => 'Zákaznický panel',
