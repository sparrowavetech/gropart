...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => 'Notificación de stock bajo',
        'store_low_stock_description' => 'Enviar correo al vendedor cuando el stock de un producto caiga por debajo del umbral',
        'store_low_stock_subject' => 'Alerta de stock bajo: {{ product_name }} se está agotando',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => 'Alerta de stock bajo',
        'store_low_stock_message' => 'Su producto <strong>:product_name</strong> tiene stock bajo con solo <strong>:product_quantity</strong> unidad(es) restantes. El umbral de stock bajo está establecido en <strong>:low_stock_threshold</strong>.',
        'store_low_stock_restock' => 'Por favor reabastezca este producto para evitar perder ventas.',
        'store_low_stock_view_product' => 'Ver producto',
        'store_verified_title' => 'Verificación de Tienda Aprobada',
    ...
    'settings' => [
        ...
        'fee_withdrawal_amount_helper' => 'Cantidad o porcentaje a cobrar cuando los vendedores solicitan un retiro.',
        'withdrawal_fee_type' => 'Tipo de tarifa de retiro',
        'withdrawal_fee_type_helper' => 'Elija si la tarifa de retiro es una cantidad fija o un porcentaje del retiro.',
        'withdrawal_fee_types' => [
            'fixed' => 'Monto fijo',
            'percentage' => 'Porcentaje',
        ],
        'check_valid_signature' => 'Verifique la firma válida en las ganancias del proveedor',
        'check_valid_signature_helper' => 'Si está habilitado, el sistema verificará la integridad de los registros de ganancias de los vendedores para evitar manipulaciones.',
        ...
        'enable_stores_page' => '¿Habilitar página de listado de tiendas?',
        'enable_stores_page_helper' => 'Si está deshabilitado, la página de listado de tiendas (ej. /stores) devolverá un error 404.',
        'hide_store_phone_number' => '¿Ocultar el número de teléfono de la tienda?',
        'hide_store_phone_number_helper' => 'Si está habilitado, el número de teléfono de la tienda se ocultará de la página pública de la tienda.',
        'hide_store_email' => '¿Ocultar el correo electrónico de la tienda?',
        'hide_store_email_helper' => 'Si está habilitado, el correo electrónico de la tienda se ocultará de la página pública de la tienda.',
        'hide_store_address' => '¿Ocultar la dirección de la tienda?',
        'hide_store_address_helper' => 'Si está habilitado, la dirección de la tienda se ocultará de la página pública de la tienda.',
        'hide_store_social_links' => '¿Ocultar enlaces sociales de la tienda?',
        'hide_store_social_links_helper' => 'Si está habilitado, los enlaces sociales de la tienda se ocultarán de la página pública de la tienda.',
        'hide_store_info_in_invoice' => '¿Ocultar la información de la tienda en la factura?',
        'hide_store_info_in_invoice_helper' => 'Si está habilitado, las facturas utilizarán la información del sitio principal en lugar de la información del vendedor/tienda.',
        ...
        'max_upload_filesize_helper' => 'Tamaño máximo de archivo en megabytes que los vendedores pueden cargar.',
        'max_product_images_upload_by_vendor' => 'Número máximo de imágenes para cada producto.',
        'max_product_images_upload_by_vendor_helper' => 'Limite el número de imágenes que los vendedores pueden cargar por producto.',
        ...
        'allow_vendor_manage_product_currency' => 'Permitir a los proveedores gestionar la moneda del producto',
        'allow_vendor_manage_product_currency_description' => 'Si está habilitado, los proveedores pueden seleccionar una moneda para sus productos. Los precios se convertirán a la moneda predeterminada para su visualización.',
        ...
        'allow_vendor_digital_products' => 'Permitir a los vendedores vender productos digitales',
        'allow_vendor_digital_products_helper' => 'Habilite esto para permitir que los vendedores creen y vendan productos digitales/descargables.',
        'low_stock_threshold' => 'Umbral de stock bajo',
        'low_stock_threshold_helper' => 'Cuando la cantidad de un producto caiga a este número o menos, el vendedor recibirá una notificación por correo electrónico. El valor predeterminado es 5.',
    ],
    'theme_options' => [
        'name' => 'Mercado',
    ...
    'helpers' => [
        'store_status' => 'Si cambia el estado que no sea ":status", la cuenta de esta tienda también cambiará a ":customer".',
    ],
    'tables' => [
        'earnings' => 'Ganancias',
    ...
    'forms' => [
        'back' => 'Volver',
        'drop_files_here_or_click_to_upload' => 'Suelta archivos aquí o haz clic para subir',
        'check' => 'Verificar',
        'error' => 'Error',
    ...
    'drop_certificate_here' => 'Suelta el certificado de constitución aquí o haz clic para subir',
    'government_id' => 'Documento de identidad',
    'drop_government_id_here' => 'Suelta el documento de identidad aquí o haz clic para subir',
    ...
    'already_vendor' => 'Ya eres vendedor.',
    'updated_registration_successfully' => '¡Información de registro actualizada correctamente!',
    'updated_registration_info_successfully' => '¡Información de registro actualizada exitosamente!',
    ...
    'choose_product_type_to_create' => 'Elige el tipo de producto que deseas crear:',
    ...
    'go_to_customer_dashboard' => 'Panel de control del cliente',
