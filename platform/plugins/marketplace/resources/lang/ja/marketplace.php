...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => '在庫不足通知',
        'store_low_stock_description' => '商品の在庫がしきい値を下回った場合に販売者にメールを送信',
        'store_low_stock_subject' => '在庫不足警告: {{ product_name }} の在庫が少なくなっています',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => '在庫不足警告',
        'store_low_stock_message' => '商品 <strong>:product_name</strong> の在庫が少なくなり、残り <strong>:product_quantity</strong> 個です。在庫不足のしきい値は <strong>:low_stock_threshold</strong> に設定されています。',
        'store_low_stock_restock' => '販売機会を逃さないよう、この商品を補充してください。',
        'store_low_stock_view_product' => '商品を表示',
        'store_verified_title' => 'ストア認証承認',
    ...
    'settings' => [
        ...
        'fee_withdrawal_amount_helper' => '販売者が出金を要求したときに請求する金額またはパーセンテージ。',
        'withdrawal_fee_type' => '出金手数料タイプ',
        'withdrawal_fee_type_helper' => '出金手数料が固定金額か出金額の割合かを選択してください。',
        'withdrawal_fee_types' => [
            'fixed' => '固定金額',
            'percentage' => 'パーセンテージ',
        ],
        'check_valid_signature' => 'ベンダーの収益で有効な署名を確認する',
        'check_valid_signature_helper' => '有効にすると、システムは改ざんを防ぐために販売者の収益記録の整合性を検証します。',
        ...
        'enable_stores_page' => 'ストア一覧ページを有効にしますか？',
        'enable_stores_page_helper' => '無効にすると、ストア一覧ページ（例：/stores）は404エラーを返します。',
        'hide_store_phone_number' => '店舗の電話番号を非表示にしますか?',
        'hide_store_phone_number_helper' => '有効にすると、ストアの電話番号が公開ストアページから非表示になります。',
        'hide_store_email' => 'ストアのメールを非表示にしますか?',
        'hide_store_email_helper' => '有効にすると、ストアのメールが公開ストアページから非表示になります。',
        'hide_store_address' => '店舗の住所を非表示にしますか?',
        'hide_store_address_helper' => '有効にすると、ストアの住所が公開ストアページから非表示になります。',
        'hide_store_social_links' => 'ストアのソーシャルリンクを非表示にしますか?',
        'hide_store_social_links_helper' => '有効にすると、ストアのソーシャルリンクが公開ストアページから非表示になります。',
        'hide_store_info_in_invoice' => '請求書に店舗情報を非表示にしますか？',
        'hide_store_info_in_invoice_helper' => '有効にすると、請求書にはベンダー/店舗情報ではなく、メインサイトの情報が使用されます。',
        ...
        'max_upload_filesize_helper' => '販売者がアップロードできる最大ファイルサイズ（メガバイト）。',
        'max_product_images_upload_by_vendor' => '各商品の画像の最大数',
        'max_product_images_upload_by_vendor_helper' => '販売者が製品ごとにアップロードできる画像の数を制限します。',
        ...
        'allow_vendor_manage_product_currency' => '出品者による商品通貨の管理を許可する',
        'allow_vendor_manage_product_currency_description' => '有効にすると、出品者が自分の商品の通貨を選択できます。表示時には既定の通貨に換算されます。',
        ...
        'allow_vendor_digital_products' => '販売者がデジタル製品を販売することを許可する',
        'allow_vendor_digital_products_helper' => 'これを有効にすると、販売者がデジタル/ダウンロード可能な製品を作成・販売できるようになります。',
        'low_stock_threshold' => '在庫不足しきい値',
        'low_stock_threshold_helper' => '商品の数量がこの数以下になると、販売者にメール通知が送信されます。デフォルトは5です。',
    ],
    'theme_options' => [
        'name' => '市場',
    ...
    'forms' => [
        'back' => '戻る',
        'drop_files_here_or_click_to_upload' => 'ここにファイルをドロップするかクリックしてアップロード',
        'check' => '確認',
        'error' => 'エラー',
        'confirm_delete_image' => 'この画像を削除してもよろしいですか？',
        'character_remain' => '文字残り',
    ],
    ...
    'drop_certificate_here' => '法人登記証明書をここにドロップするかクリックしてアップロード',
    'government_id' => '政府発行の身分証明書',
    'drop_government_id_here' => '身分証明書をここにドロップするかクリックしてアップロード',
    'documents' => '書類',
    ...
    'already_vendor' => 'あなたはすでに販売者です。',
    'updated_registration_successfully' => '登録情報が更新されました！',
    'updated_registration_info_successfully' => '登録情報が正常に更新されました！',
    ...
    'choose_product_type_to_create' => '作成する商品の種類を選択してください：',
    ...
    'go_to_customer_dashboard' => '顧客ダッシュボード',
    'recent_orders' => '最近の注文',
    'no_orders' => '注文がありません！',
