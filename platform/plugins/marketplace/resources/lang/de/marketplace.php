...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => 'Benachrichtigung bei niedrigem Lagerbestand',
        'store_low_stock_description' => 'E-Mail an den Verkäufer senden, wenn der Produktbestand unter den Schwellenwert fällt',
        'store_low_stock_subject' => 'Warnung: {{ product_name }} hat niedrigen Lagerbestand',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => 'Warnung bei niedrigem Lagerbestand',
        'store_low_stock_message' => 'Ihr Produkt <strong>:product_name</strong> hat einen niedrigen Lagerbestand mit nur noch <strong>:product_quantity</strong> Stück. Der Schwellenwert für niedrigen Lagerbestand ist auf <strong>:low_stock_threshold</strong> eingestellt.',
        'store_low_stock_restock' => 'Bitte füllen Sie den Bestand dieses Produkts auf, um keine Verkäufe zu verpassen.',
        'store_low_stock_view_product' => 'Produkt anzeigen',
        'store_verified_title' => 'Shop-Verifizierung genehmigt',
    ...
    'settings' => [
        ...
        'fee_withdrawal_amount_helper' => 'Betrag oder Prozentsatz, der bei Auszahlungsanfragen von Händlern berechnet wird.',
        'withdrawal_fee_type' => 'Auszahlungsgebührentyp',
        'withdrawal_fee_type_helper' => 'Wählen Sie, ob die Auszahlungsgebühr ein fester Betrag oder ein Prozentsatz der Auszahlung ist.',
        'withdrawal_fee_types' => [
            'fixed' => 'Fester Betrag',
            'percentage' => 'Prozentsatz',
        ],
        'check_valid_signature' => 'Gültige Signatur in Verkäufereinnahmen prüfen',
        'check_valid_signature_helper' => 'Wenn aktiviert, überprüft das System die Integrität der Händler-Einnahmenaufzeichnungen, um Manipulationen zu verhindern.',
        ...
        'enable_stores_page' => 'Shop-Übersichtsseite aktivieren?',
        'enable_stores_page_helper' => 'Wenn deaktiviert, gibt die Shop-Übersichtsseite (z.B. /stores) einen 404-Fehler zurück.',
        'hide_store_phone_number' => 'Shop-Telefonnummer ausblenden?',
        'hide_store_phone_number_helper' => 'Wenn aktiviert, wird die Telefonnummer des Geschäfts auf der öffentlichen Geschäftsseite ausgeblendet.',
        'hide_store_email' => 'Shop-E-Mail ausblenden?',
        'hide_store_email_helper' => 'Wenn aktiviert, wird die E-Mail des Geschäfts auf der öffentlichen Geschäftsseite ausgeblendet.',
        'hide_store_address' => 'Shop-Adresse ausblenden?',
        'hide_store_address_helper' => 'Wenn aktiviert, wird die Adresse des Geschäfts auf der öffentlichen Geschäftsseite ausgeblendet.',
        'hide_store_social_links' => 'Shop-Social-Links ausblenden?',
        'hide_store_social_links_helper' => 'Wenn aktiviert, werden die sozialen Links des Geschäfts auf der öffentlichen Geschäftsseite ausgeblendet.',
        'hide_store_info_in_invoice' => 'Shop-Informationen auf Rechnung ausblenden?',
        'hide_store_info_in_invoice_helper' => 'Wenn aktiviert, verwenden Rechnungen die Hauptseiteninformationen anstelle der Verkäufer-/Shop-Informationen.',
        ...
        'max_upload_filesize_helper' => 'Maximale Dateigröße in Megabyte, die Händler hochladen können.',
        'max_product_images_upload_by_vendor' => 'Maximale Anzahl von Bildern pro Produkt',
        'max_product_images_upload_by_vendor_helper' => 'Begrenzen Sie die Anzahl der Bilder, die Händler pro Produkt hochladen können.',
        ...
        'allow_vendor_manage_product_currency' => 'Ermöglichen Sie Anbietern, die Produktwährung zu verwalten',
        'allow_vendor_manage_product_currency_description' => 'Wenn diese Option aktiviert ist, können Anbieter eine Währung für ihre Produkte auswählen. Die Preise werden zur Anzeige in die Standardwährung umgerechnet.',
        ...
        'allow_vendor_digital_products' => 'Händlern erlauben, digitale Produkte zu verkaufen',
        'allow_vendor_digital_products_helper' => 'Aktivieren Sie dies, um Händlern zu ermöglichen, digitale/herunterladbare Produkte zu erstellen und zu verkaufen.',
        'low_stock_threshold' => 'Schwellenwert für niedrigen Lagerbestand',
        'low_stock_threshold_helper' => 'Wenn die Produktmenge auf diese Zahl oder darunter fällt, erhält der Verkäufer eine E-Mail-Benachrichtigung. Standard ist 5.',
    ],
    'theme_options' => [
        'name' => 'Marktplatz',
    ...
    'forms' => [
        'back' => 'Zurück',
        'drop_files_here_or_click_to_upload' => 'Dateien hier ablegen oder zum Hochladen klicken',
        'check' => 'Prüfen',
        'error' => 'Fehler',
        'confirm_delete_image' => 'Möchten Sie dieses Bild wirklich löschen?',
        'character_remain' => 'Zeichen übrig',
    ],
    ...
    'drop_certificate_here' => 'Gründungsurkunde hier ablegen oder zum Hochladen klicken',
    'government_id' => 'Ausweis',
    'drop_government_id_here' => 'Ausweis hier ablegen oder zum Hochladen klicken',
    'documents' => 'Dokumente',
    ...
    'already_vendor' => 'Sie sind bereits Verkäufer.',
    'updated_registration_successfully' => 'Registrierungsinformationen erfolgreich aktualisiert!',
    'updated_registration_info_successfully' => 'Registrierungsinformationen erfolgreich aktualisiert!',
    ...
    'choose_product_type_to_create' => 'Wählen Sie den Produkttyp aus, den Sie erstellen möchten:',
    ...
    'go_to_customer_dashboard' => 'Kunden-Dashboard',
