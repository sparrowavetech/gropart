...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => 'Powiadomienie o niskim stanie magazynowym',
        'store_low_stock_description' => 'Wyślij e-mail do sprzedawcy, gdy stan magazynowy produktu spadnie poniżej progu',
        'store_low_stock_subject' => 'Alert niskiego stanu: {{ product_name }} się kończy',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => 'Alert niskiego stanu magazynowego',
        'store_low_stock_message' => 'Twój produkt <strong>:product_name</strong> ma niski stan magazynowy - pozostało tylko <strong>:product_quantity</strong> szt. Próg niskiego stanu magazynowego jest ustawiony na <strong>:low_stock_threshold</strong>.',
        'store_low_stock_restock' => 'Uzupełnij zapasy tego produktu, aby nie tracić sprzedaży.',
        'store_low_stock_view_product' => 'Zobacz produkt',
        'store_verified_title' => 'Weryfikacja Sklepu Zatwierdzona',
    ...
    'settings' => [
        ...
        'fee_withdrawal_amount_helper' => 'Kwota lub procent pobierany, gdy sprzedawcy żądają wypłaty.',
        'withdrawal_fee_type' => 'Typ opłaty za wypłatę',
        'withdrawal_fee_type_helper' => 'Wybierz, czy opłata za wypłatę jest stałą kwotą czy procentem wypłaty.',
        'withdrawal_fee_types' => [
            'fixed' => 'Stała kwota',
            'percentage' => 'Procent',
        ],
        'check_valid_signature' => 'Sprawdź ważny podpis w zarobkach sprzedawcy',
        'check_valid_signature_helper' => 'Jeśli włączone, system zweryfikuje integralność rekordów zarobków sprzedawców, aby zapobiec manipulacji.',
        ...
        'enable_stores_page' => 'Włączyć stronę z listą sklepów?',
        'enable_stores_page_helper' => 'Jeśli wyłączone, strona z listą sklepów (np. /stores) zwróci błąd 404.',
        'hide_store_phone_number' => 'Ukryć numer telefonu sklepu?',
        'hide_store_phone_number_helper' => 'Jeśli włączone, numer telefonu sklepu będzie ukryty na publicznej stronie sklepu.',
        'hide_store_email' => 'Ukryć e-mail sklepu?',
        'hide_store_email_helper' => 'Jeśli włączone, email sklepu będzie ukryty na publicznej stronie sklepu.',
        'hide_store_address' => 'Ukryć adres sklepu?',
        'hide_store_address_helper' => 'Jeśli włączone, adres sklepu będzie ukryty na publicznej stronie sklepu.',
        'hide_store_social_links' => 'Ukryć linki społecznościowe sklepu?',
        'hide_store_social_links_helper' => 'Jeśli włączone, linki społecznościowe sklepu będą ukryte na publicznej stronie sklepu.',
        'hide_store_info_in_invoice' => 'Ukryć informacje o sklepie na fakturze?',
        'hide_store_info_in_invoice_helper' => 'Jeśli włączone, faktury będą korzystać z informacji głównej witryny zamiast informacji o sprzedawcy/sklepie.',
        ...
        'max_upload_filesize_helper' => 'Maksymalny rozmiar pliku w megabajtach, który sprzedawcy mogą przesłać.',
        'max_product_images_upload_by_vendor' => 'Maksymalna liczba zdjęć dla każdego produktu',
        'max_product_images_upload_by_vendor_helper' => 'Ogranicz liczbę zdjęć, które sprzedawcy mogą przesłać na produkt.',
        ...
        'allow_vendor_manage_product_currency' => 'Zezwalaj dostawcom na zarządzanie walutą produktu',
        'allow_vendor_manage_product_currency_description' => 'Jeśli ta opcja jest włączona, dostawcy mogą wybrać walutę dla swoich produktów. Ceny zostaną przeliczone na domyślną walutę do wyświetlenia.',
        ...
        'allow_vendor_digital_products' => 'Zezwól sprzedawcom na sprzedaż produktów cyfrowych',
        'allow_vendor_digital_products_helper' => 'Włącz to, aby umożliwić sprzedawcom tworzenie i sprzedaż produktów cyfrowych/do pobrania.',
        'low_stock_threshold' => 'Próg niskiego stanu magazynowego',
        'low_stock_threshold_helper' => 'Gdy ilość produktu spadnie do tej liczby lub poniżej, sprzedawca otrzyma powiadomienie e-mail. Domyślna wartość to 5.',
    ],
    'theme_options' => [
        'name' => 'Marketplace',
    ...
    'product_quantity' => 'Ilość produktu',
    'low_stock_threshold' => 'Próg niskiego stanu magazynowego',
    ...
    'forms' => [
        'back' => 'Wstecz',
        'drop_files_here_or_click_to_upload' => 'Upuść pliki tutaj lub kliknij, aby przesłać',
        'check' => 'Sprawdź',
        'error' => 'Błąd',
        'confirm_delete_image' => 'Czy na pewno chcesz usunąć ten obraz?',
    ...
    'certificate_of_incorporation' => 'Zaświadczenie o rejestracji',
    'drop_certificate_here' => 'Upuść zaświadczenie o rejestracji tutaj lub kliknij, aby przesłać',
    'government_id' => 'Dokument tożsamości',
    'drop_government_id_here' => 'Upuść dokument tożsamości tutaj lub kliknij, aby przesłać',
    'documents' => 'Dokumenty',
    ...
    'already_vendor' => 'Jesteś już sprzedawcą.',
    'updated_registration_successfully' => 'Rejestracja zaktualizowana pomyślnie',
    'updated_registration_info_successfully' => 'Informacje rejestracyjne zostały pomyślnie zaktualizowane!',
    ...
    'fees' => 'Opłaty',
    'congratulations_vendor' => 'Gratulujemy bycia sprzedawcą w :site_title',
    'attract_customers_message' => 'Przyciągnijmy klientów, dodając Twój pierwszy produkt.',
    'choose_product_type_to_create' => 'Wybierz rodzaj produktu, który chcesz stworzyć:',
    'create_new_product_here' => 'Utwórz nowy produkt <a href=":url">tutaj</a>',
    'no_orders_yet_message' => 'Masz :total produktów, ale nie masz jeszcze żadnych zamówień',
    'view_your_store_here' => 'Zobacz swój sklep <a href=":url">tutaj</a>',
    ...
    'go_to_customer_dashboard' => 'Panel Klienta',
