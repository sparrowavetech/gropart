...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => 'Notification de stock faible',
        'store_low_stock_description' => 'Envoyer un e-mail au vendeur lorsque le stock d\'un produit descend en dessous du seuil',
        'store_low_stock_subject' => 'Alerte stock faible : {{ product_name }} est bientôt épuisé',
    ...
    'settings' => [
        ...
        'fee_withdrawal_amount_helper' => 'Montant ou pourcentage à facturer lorsque les vendeurs demandent un retrait.',
        'withdrawal_fee_type' => 'Type de frais de retrait',
        'withdrawal_fee_type_helper' => 'Choisissez si les frais de retrait sont un montant fixe ou un pourcentage du retrait.',
        'withdrawal_fee_types' => [
            'fixed' => 'Montant fixe',
            'percentage' => 'Pourcentage',
        ],
        'check_valid_signature' => 'Vérifier la signature valide dans les gains du fournisseur',
        'check_valid_signature_helper' => 'Si activé, le système vérifiera l\'intégrité des enregistrements de gains des vendeurs pour empêcher la falsification.',
        ...
        'enable_stores_page' => 'Activer la page de liste des magasins ?',
        'enable_stores_page_helper' => 'Si désactivé, la page de liste des magasins (ex. /stores) retournera une erreur 404.',
        'hide_store_phone_number' => 'Masquer le numéro de téléphone du magasin ?',
        'hide_store_phone_number_helper' => 'Si activé, le numéro de téléphone du magasin sera masqué de la page publique du magasin.',
        'hide_store_email' => 'Masquer l\'e-mail du magasin ?',
        'hide_store_email_helper' => 'Si activé, l\'email du magasin sera masqué de la page publique du magasin.',
        ...
        'max_upload_filesize_helper' => 'Taille maximale du fichier en mégaoctets que les vendeurs peuvent télécharger.',
        'max_product_images_upload_by_vendor' => 'Nombre maximum d\'images pour chaque produit',
        'max_product_images_upload_by_vendor_helper' => 'Limitez le nombre d\'images que les vendeurs peuvent télécharger par produit.',
        ...
        'allow_vendor_digital_products' => 'Autoriser les vendeurs à vendre des produits numériques',
        'allow_vendor_digital_products_helper' => 'Activez ceci pour permettre aux vendeurs de créer et vendre des produits numériques/téléchargeables.',
        'low_stock_threshold' => 'Seuil de stock faible',
        'low_stock_threshold_helper' => 'Lorsque la quantité d\'un produit atteint ce nombre ou moins, le vendeur recevra une notification par e-mail. La valeur par défaut est 5.',
    ],
    'theme_options' => [
        'name' => 'Marché',
