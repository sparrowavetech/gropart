...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => 'Notifikation om lav lagerbeholdning',
        'store_low_stock_description' => 'Send e-mail til sælger, når et produkts lagerbeholdning falder under tærsklen',
        'store_low_stock_subject' => 'Advarsel om lav lagerbeholdning: {{ product_name }} er ved at løbe tør',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => 'Advarsel om lav lagerbeholdning',
        'store_low_stock_message' => 'Dit produkt <strong>:product_name</strong> har lav lagerbeholdning med kun <strong>:product_quantity</strong> stk. tilbage. Tærsklen for lav lagerbeholdning er sat til <strong>:low_stock_threshold</strong>.',
        'store_low_stock_restock' => 'Genopfyld venligst dette produkt for at undgå mistede salg.',
        'store_low_stock_view_product' => 'Se produkt',
        'store_verified_title' => 'Butikverificering godkendt',
    ...
    'settings' => [
        ...
        'fixed_commission_fee' => 'Fast kommissionsgebyr (pr. ordre)',
        'fixed_commission_fee_helper' => 'Et fast beløb tilføjet til kommissionen, opkrævet én gang pr. forhandlerordre oven i procentsatsen ovenfor. Nyttigt til at dække den faste del af betalingsgebyrer (f.eks. Stripe/PayPal €0.25). Lad være 0 for at deaktivere.',
        ...
        'enable_stores_page' => 'Aktiver butiksoversigtsside?',
        'enable_stores_page_helper' => 'Hvis deaktiveret, vil butiksoversigten (f.eks. /stores) returnere en 404-fejl.',
        ...
        'hide_store_info_in_invoice' => 'Skjul butiksoplysninger på faktura?',
        'hide_store_info_in_invoice_helper' => 'Hvis aktiveret, vil fakturaer bruge hovedsidens oplysninger i stedet for sælger/butiksoplysninger.',
        ...
        'allow_vendor_manage_product_currency' => 'Tillad leverandører at administrere produktvaluta',
        'allow_vendor_manage_product_currency_description' => 'Hvis det er aktiveret, kan leverandører vælge en valuta for deres produkter. Priserne vil blive konverteret til standardvalutaen til visning.',
        ...
        'low_stock_threshold' => 'Tærskel for lav lagerbeholdning',
        'low_stock_threshold_helper' => 'Når et produkts antal falder til eller under dette tal, vil sælgeren modtage en e-mail-notifikation. Standard er 5.',
    ],
    'theme_options' => [
        'name' => 'Markedsplads',
    ...
    'forms' => [
        'back' => 'Tilbage',
        'drop_files_here_or_click_to_upload' => 'Slip filer her eller klik for at uploade',
        'check' => 'Tjek',
        'error' => 'Fejl',
        'confirm_delete_image' => 'Er du sikker på, at du vil slette dette billede?',
    ...
    'certificate_of_incorporation' => 'Stiftelsesattest',
    'drop_certificate_here' => 'Slip stiftelsesattest her eller klik for at uploade',
    'government_id' => 'Offentlig ID',
    'drop_government_id_here' => 'Slip offentlig ID her eller klik for at uploade',
    ...
    'already_vendor' => 'Du er allerede forhandler.',
    'updated_registration_successfully' => 'Registreringsoplysninger opdateret!',
    'updated_registration_info_successfully' => 'Registreringsoplysninger opdateret med succes!',
    ...
    'choose_product_type_to_create' => 'Vælg den type produkt, du vil oprette:',
    ...
    'go_to_customer_dashboard' => 'Kunde Dashboard',
