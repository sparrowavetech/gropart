...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => 'Notifica scorte basse',
        'store_low_stock_description' => 'Invia email al venditore quando le scorte del prodotto scendono sotto la soglia',
        'store_low_stock_subject' => 'Avviso scorte basse: {{ product_name }} sta per esaurirsi',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => 'Avviso scorte basse',
        'store_low_stock_message' => 'Il tuo prodotto <strong>:product_name</strong> ha scorte basse con solo <strong>:product_quantity</strong> pezzi rimanenti. La soglia di scorte basse è impostata su <strong>:low_stock_threshold</strong>.',
        'store_low_stock_restock' => 'Rifornisci questo prodotto per evitare di perdere vendite.',
        'store_low_stock_view_product' => 'Visualizza prodotto',
        'store_verified_title' => 'Verifica Negozio Approvata',
    ...
    'settings' => [
        ...
        'fee_withdrawal_amount_helper' => 'Importo o percentuale da addebitare quando i venditori richiedono un prelievo.',
        'withdrawal_fee_type' => 'Tipo commissione prelievo',
        'withdrawal_fee_type_helper' => 'Scegli se la commissione di prelievo è un importo fisso o una percentuale del prelievo.',
        'withdrawal_fee_types' => [
            'fixed' => 'Importo fisso',
            'percentage' => 'Percentuale',
        ],
        'check_valid_signature' => 'Controlla firma valida nei guadagni del venditore',
        'check_valid_signature_helper' => 'Se abilitato, il sistema verificherà l\'integrità dei record di guadagno dei venditori per prevenire manomissioni.',
        ...
        'enable_stores_page' => 'Abilitare la pagina elenco negozi?',
        'enable_stores_page_helper' => 'Se disabilitato, la pagina elenco negozi (es. /stores) restituirà un errore 404.',
        'hide_store_phone_number' => 'Nascondere numero telefono negozio?',
        'hide_store_phone_number_helper' => 'Se abilitato, il numero di telefono del negozio sarà nascosto dalla pagina pubblica del negozio.',
        'hide_store_email' => 'Nascondere email negozio?',
        'hide_store_email_helper' => 'Se abilitato, l\'email del negozio sarà nascosta dalla pagina pubblica del negozio.',
        'hide_store_address' => 'Nascondere indirizzo negozio?',
        'hide_store_address_helper' => 'Se abilitato, l\'indirizzo del negozio sarà nascosto dalla pagina pubblica del negozio.',
        'hide_store_social_links' => 'Nascondere link social negozio?',
        'hide_store_social_links_helper' => 'Se abilitato, i link social del negozio saranno nascosti dalla pagina pubblica del negozio.',
        'hide_store_info_in_invoice' => 'Nascondi le informazioni del negozio nella fattura?',
        'hide_store_info_in_invoice_helper' => 'Se abilitato, le fatture utilizzeranno le informazioni del sito principale invece di quelle del venditore/negozio.',
        ...
        'max_upload_filesize_helper' => 'Dimensione massima del file in megabyte che i venditori possono caricare.',
        'max_product_images_upload_by_vendor' => 'Numero massimo di immagini per ogni prodotto',
        'max_product_images_upload_by_vendor_helper' => 'Limita il numero di immagini che i venditori possono caricare per prodotto.',
        ...
        'allow_vendor_manage_product_currency' => 'Consenti ai fornitori di gestire la valuta del prodotto',
        'allow_vendor_manage_product_currency_description' => 'Se abilitato, i fornitori possono selezionare una valuta per i loro prodotti. I prezzi verranno convertiti nella valuta predefinita per la visualizzazione.',
        ...
        'allow_vendor_digital_products' => 'Consenti ai venditori di vendere prodotti digitali',
        'allow_vendor_digital_products_helper' => 'Abilita questo per consentire ai venditori di creare e vendere prodotti digitali/scaricabili.',
        'low_stock_threshold' => 'Soglia scorte basse',
        'low_stock_threshold_helper' => 'Quando la quantità del prodotto scende a questo numero o al di sotto, il venditore riceverà una notifica via email. Il valore predefinito è 5.',
    ],
    'theme_options' => [
        'name' => 'Marketplace',
    ...
    'forms' => [
        'back' => 'Indietro',
        'drop_files_here_or_click_to_upload' => 'Trascina i file qui o clicca per caricare',
        'check' => 'Verifica',
        'error' => 'Errore',
    ...
    'drop_certificate_here' => 'Trascina il certificato di costituzione qui o clicca per caricare',
    'government_id' => 'Documento di identità',
    'drop_government_id_here' => 'Trascina il documento di identità qui o clicca per caricare',
    'documents' => 'Documenti',
    ...
    'already_vendor' => 'Sei già un venditore.',
    'updated_registration_successfully' => 'Informazioni di registrazione aggiornate con successo!',
    'updated_registration_info_successfully' => 'Informazioni di registrazione aggiornate con successo!',
    ...
    'choose_product_type_to_create' => 'Scegli la tipologia di prodotto che vuoi realizzare:',
    ...
    'go_to_customer_dashboard' => 'Cruscotto cliente',
