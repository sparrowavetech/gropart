...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => 'Notificação de estoque baixo',
        'store_low_stock_description' => 'Enviar e-mail ao vendedor quando o estoque do produto cair abaixo do limite',
        'store_low_stock_subject' => 'Alerta de estoque baixo: {{ product_name }} está acabando',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => 'Alerta de estoque baixo',
        'store_low_stock_message' => 'O seu produto <strong>:product_name</strong> tem estoque baixo com apenas <strong>:product_quantity</strong> unidade(s) restante(s). O limite de estoque baixo está definido em <strong>:low_stock_threshold</strong>.',
        'store_low_stock_restock' => 'Por favor, reponha o estoque deste produto para evitar perder vendas.',
        'store_low_stock_view_product' => 'Ver produto',
        'store_verified_title' => 'Verificação da Loja Aprovada',
    ...
    'settings' => [
        ...
        'fixed_commission_fee_helper' => 'Um valor fixo adicionado à comissão, cobrado uma vez por pedido do vendedor além da percentagem acima. Útil para cobrir a parte fixa das taxas do gateway de pagamento (ex.: Stripe/PayPal €0,25). Deixe 0 para desativar.',
        ...
        'fee_withdrawal_amount_helper' => 'Valor ou porcentagem a cobrar quando os vendedores solicitam um saque.',
        'withdrawal_fee_type' => 'Tipo de taxa de retirada',
        'withdrawal_fee_type_helper' => 'Escolha se a taxa de saque é um valor fixo ou uma porcentagem do saque.',
        'withdrawal_fee_types' => [
            'fixed' => 'Valor fixo',
            'percentage' => 'Porcentagem',
        ],
        'check_valid_signature' => 'Verifique a assinatura válida nos ganhos do fornecedor',
        'check_valid_signature_helper' => 'Se ativado, o sistema verificará a integridade dos registros de ganhos dos vendedores para evitar adulteração.',
        ...
        'enable_stores_page' => 'Ativar página de listagem de lojas?',
        'enable_stores_page_helper' => 'Se desativado, a página de listagem de lojas (ex. /stores) retornará um erro 404.',
        'hide_store_phone_number' => 'Ocultar o número de telefone da loja?',
        'hide_store_phone_number_helper' => 'Se ativado, o número de telefone da loja será ocultado da página pública da loja.',
        'hide_store_email' => 'Ocultar e-mail da loja?',
        'hide_store_email_helper' => 'Se ativado, o email da loja será ocultado da página pública da loja.',
        'hide_store_address' => 'Ocultar endereço da loja?',
        'hide_store_address_helper' => 'Se ativado, o endereço da loja será ocultado da página pública da loja.',
        'hide_store_social_links' => 'Ocultar links sociais da loja?',
        'hide_store_social_links_helper' => 'Se ativado, os links sociais da loja serão ocultados da página pública da loja.',
        'hide_store_info_in_invoice' => 'Ocultar informações da loja na fatura?',
        'hide_store_info_in_invoice_helper' => 'Se ativado, as faturas usarão as informações do site principal em vez das informações do fornecedor/loja.',
        ...
        'max_upload_filesize_helper' => 'Tamanho máximo do arquivo em megabytes que os vendedores podem enviar.',
        'max_product_images_upload_by_vendor' => 'Número máximo de imagens para cada produto',
        'max_product_images_upload_by_vendor_helper' => 'Limite o número de imagens que os vendedores podem enviar por produto.',
        ...
        'allow_vendor_manage_product_currency' => 'Permitir que os fornecedores gerenciem a moeda do produto',
        'allow_vendor_manage_product_currency_description' => 'Se ativado, os fornecedores poderão selecionar uma moeda para seus produtos. Os preços serão convertidos para a moeda padrão para exibição.',
        ...
        'allow_vendor_digital_products' => 'Permitir que vendedores vendam produtos digitais',
        'allow_vendor_digital_products_helper' => 'Ative isso para permitir que vendedores criem e vendam produtos digitais/baixáveis.',
        'low_stock_threshold' => 'Limite de estoque baixo',
        'low_stock_threshold_helper' => 'Quando a quantidade do produto cair para este número ou abaixo, o vendedor receberá uma notificação por e-mail. O padrão é 5.',
    ],
    'theme_options' => [
        'name' => 'Mercado',
    ...
    'already_vendor' => 'Você já é um vendedor.',
    ...
    'fees' => 'Taxas',
    'congratulations_vendor' => 'Parabéns por ser um fornecedor da :site_title',
    'attract_customers_message' => 'Vamos atrair clientes adicionando seu primeiro produto.',
    'choose_product_type_to_create' => 'Escolha o tipo de produto que deseja criar:',
    'create_new_product_here' => 'Crie um novo produto <a href=":url">aqui</a>',
    'no_orders_yet_message' => 'Você tem :total produto(s), mas nenhum pedido ainda',
    ...
    'go_to_customer_dashboard' => 'Painel do cliente',
