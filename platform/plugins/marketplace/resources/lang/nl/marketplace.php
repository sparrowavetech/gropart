...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => 'Melding lage voorraad',
        'store_low_stock_description' => 'Stuur een e-mail naar de verkoper wanneer de productvoorraad onder de drempelwaarde daalt',
        'store_low_stock_subject' => 'Waarschuwing lage voorraad: {{ product_name }} raakt op',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => 'Waarschuwing lage voorraad',
        'store_low_stock_message' => 'Uw product <strong>:product_name</strong> heeft een lage voorraad met nog slechts <strong>:product_quantity</strong> stuks. De drempelwaarde voor lage voorraad is ingesteld op <strong>:low_stock_threshold</strong>.',
        'store_low_stock_restock' => 'Vul de voorraad van dit product aan om geen verkopen mis te lopen.',
        'store_low_stock_view_product' => 'Product bekijken',
        'store_verified_title' => 'Winkel Verificatie Goedgekeurd',
    ...
    'settings' => [
        ...
        'fee_withdrawal_amount_helper' => 'Bedrag of percentage dat in rekening wordt gebracht wanneer verkopers een opname aanvragen.',
        'withdrawal_fee_type' => 'Opname kosten type',
        'withdrawal_fee_type_helper' => 'Kies of de opnamekosten een vast bedrag of een percentage van de opname zijn.',
        'withdrawal_fee_types' => [
            'fixed' => 'Vast bedrag',
            'percentage' => 'Percentage',
        ],
        'check_valid_signature' => 'Controleer geldige handtekening in verkoper verdiensten',
        'check_valid_signature_helper' => 'Indien ingeschakeld, zal het systeem de integriteit van verkopersinkomenrecords verifiëren om manipulatie te voorkomen.',
        ...
        'enable_stores_page' => 'Winkeloverzichtspagina inschakelen?',
        'enable_stores_page_helper' => 'Indien uitgeschakeld, zal de winkeloverzichtspagina (bijv. /stores) een 404-fout retourneren.',
        'hide_store_phone_number' => 'Winkel telefoonnummer verbergen?',
        'hide_store_phone_number_helper' => 'Indien ingeschakeld, wordt het telefoonnummer van de winkel verborgen op de openbare winkelpagina.',
        'hide_store_email' => 'Winkel e-mail verbergen?',
        'hide_store_email_helper' => 'Indien ingeschakeld, wordt het e-mailadres van de winkel verborgen op de openbare winkelpagina.',
        'hide_store_address' => 'Winkel adres verbergen?',
        'hide_store_address_helper' => 'Indien ingeschakeld, wordt het adres van de winkel verborgen op de openbare winkelpagina.',
        'hide_store_social_links' => 'Winkel sociale links verbergen?',
        'hide_store_social_links_helper' => 'Indien ingeschakeld, worden de sociale links van de winkel verborgen op de openbare winkelpagina.',
        'hide_store_info_in_invoice' => 'Winkelinformatie op de factuur verbergen?',
        'hide_store_info_in_invoice_helper' => 'Indien ingeschakeld, worden op facturen de gegevens van de hoofdsite gebruikt in plaats van de gegevens van de verkoper/winkel.',
        ...
        'max_upload_filesize_helper' => 'Maximale bestandsgrootte in megabytes die verkopers kunnen uploaden.',
        'max_product_images_upload_by_vendor' => 'Max aantal afbeeldingen per product',
        'max_product_images_upload_by_vendor_helper' => 'Beperk het aantal afbeeldingen dat verkopers per product kunnen uploaden.',
        ...
        'allow_vendor_manage_product_currency' => 'Geef leveranciers de mogelijkheid om de productvaluta te beheren',
        'allow_vendor_manage_product_currency_description' => 'Indien ingeschakeld kunnen leveranciers een valuta voor hun producten selecteren. Prijzen worden voor weergave omgezet naar de standaardvaluta.',
        ...
        'allow_vendor_digital_products' => 'Verkopers toestaan digitale producten te verkopen',
        'allow_vendor_digital_products_helper' => 'Schakel dit in om verkopers in staat te stellen digitale/downloadbare producten te maken en verkopen.',
        'low_stock_threshold' => 'Drempelwaarde lage voorraad',
        'low_stock_threshold_helper' => 'Wanneer de producthoeveelheid daalt tot dit getal of lager, ontvangt de verkoper een e-mailmelding. Standaard is 5.',
    ],
    'theme_options' => [
        'name' => 'Marktplaats',
    ...
    'forms' => [
        'back' => 'Terug',
        'drop_files_here_or_click_to_upload' => 'Sleep bestanden hierheen of klik om te uploaden',
        'check' => 'Controleren',
        'error' => 'Fout',
        'confirm_delete_image' => 'Weet je zeker dat je deze afbeelding wilt verwijderen?',
        'character_remain' => 'tekens over',
    ],
    ...
    'drop_certificate_here' => 'Sleep oprichtingsakte hierheen of klik om te uploaden',
    'government_id' => 'Identiteitsbewijs',
    'drop_government_id_here' => 'Sleep identiteitsbewijs hierheen of klik om te uploaden',
    ...
    'notices' => [
        'file_not_found' => 'Het bestand kon niet worden gevonden.',
    ],
    ...
    'already_vendor' => 'Je bent al verkoper.',
    'updated_registration_successfully' => 'Registratie succesvol bijgewerkt',
    'updated_registration_info_successfully' => 'Registratiegegevens succesvol bijgewerkt!',
    ...
    'fees' => 'Kosten',
    'congratulations_vendor' => 'Gefeliciteerd met uw positie als leverancier bij :site_title',
    'attract_customers_message' => 'Laten we klanten aantrekken door uw eerste product toe te voegen.',
    'choose_product_type_to_create' => 'Kies het type product dat u wilt maken:',
    'create_new_product_here' => 'Creëer een nieuw product <a href=":url">hier</a>',
    'no_orders_yet_message' => 'Je hebt :total product(en) maar nog geen bestellingen',
    'view_your_store_here' => 'Bekijk uw winkel <a href=":url">hier</a>',
    ...
    'go_to_customer_dashboard' => 'Klantendashboard',
