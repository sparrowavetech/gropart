...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => 'Obvestilo o nizkih zalogah',
        'store_low_stock_description' => 'Pošlji e-pošto prodajalcu, ko zaloga izdelka pade pod prag',
        'store_low_stock_subject' => 'Opozorilo o nizkih zalogah: {{ product_name }} se izteka',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => 'Opozorilo o nizkih zalogah',
        'store_low_stock_message' => 'Vaš izdelek <strong>:product_name</strong> ima nizke zaloge, preostalo je le <strong>:product_quantity</strong> kosov. Prag nizkih zalog je nastavljen na <strong>:low_stock_threshold</strong>.',
        'store_low_stock_restock' => 'Prosimo, dopolnite zaloge tega izdelka, da ne boste zamudili prodaje.',
        'store_low_stock_view_product' => 'Ogled izdelka',
        'store_verified_title' => 'Verifikacija trgovine odobrena',
    ...
    'settings' => [
        ...
        'fixed_commission_fee' => 'Fiksna provizija (na naročilo)',
        'fixed_commission_fee_helper' => 'Fiksni znesek, dodan proviziji, zaračunan enkrat na naročilo prodajalca poleg zgornjega odstotka. Uporabno za pokrivanje fiksnega dela stroškov plačilnega prehoda (npr. Stripe/PayPal €0,25). Pustite 0 za onemogočenje.',
        ...
        'fee_withdrawal_amount_helper' => 'Amount or percentage to charge when vendors request a withdrawal.',
        'withdrawal_fee_type' => 'Vrsta provizije za dvig',
        'withdrawal_fee_type_helper' => 'Choose whether the withdrawal fee is a fixed amount or a percentage of the withdrawal.',
        'withdrawal_fee_types' => [
            'fixed' => 'Fiksni znesek',
            'percentage' => 'Odstotek',
        ],
        'check_valid_signature' => 'Preveri veljaven podpis v dohodkih prodajalca',
        'check_valid_signature_helper' => 'If enabled, the system will verify the integrity of vendor earning records to prevent tampering.',
        ...
        'enable_stores_page' => 'Omogoči stran s seznamom trgovin?',
        'enable_stores_page_helper' => 'Če je onemogočeno, bo stran s seznamom trgovin (npr. /stores) vrnila napako 404.',
        ...
        'hide_store_email_helper' => 'If enabled, the store email will be hidden from the public store page.',
        ...
        'hide_store_info_in_invoice' => 'Skrij informacije o trgovini na računu?',
        'hide_store_info_in_invoice_helper' => 'Če je omogočeno, bodo računi namesto informacij o prodajalcu/trgovini uporabljali informacije na glavnem spletnem mestu.',
        ...
        'max_upload_filesize_helper' => 'Maximum file size in megabytes that vendors can upload.',
        'max_product_images_upload_by_vendor' => 'Največje število slik za vsak izdelek',
        'max_product_images_upload_by_vendor_helper' => 'Limit the number of images vendors can upload per product.',
        ...
        'allow_vendor_manage_product_currency' => 'Dovolite prodajalcem, da upravljajo valuto izdelka',
        'allow_vendor_manage_product_currency_description' => 'Če je omogočeno, lahko prodajalci izberejo valuto za svoje izdelke. Cene bodo pretvorjene v privzeto valuto za prikaz.',
        ...
        'low_stock_threshold' => 'Prag nizkih zalog',
        'low_stock_threshold_helper' => 'Ko količina izdelka pade na to število ali nižje, bo prodajalec prejel obvestilo po e-pošti. Privzeto je 5.',
    ],
    'theme_options' => [
        'name' => 'Tržnica',
    ...
    'product_quantity' => 'Količina izdelka',
    'low_stock_threshold' => 'Prag nizkih zalog',
    ...
    'forms' => [
        'back' => 'Nazaj',
        'drop_files_here_or_click_to_upload' => 'Spustite datoteke sem ali kliknite za nalaganje',
        'check' => 'Preveri',
        'error' => 'Napaka',
        'confirm_delete_image' => 'Ali ste prepričani, da želite izbrisati to sliko?',
        'character_remain' => 'znakov ostalo',
    ],
    ...
    'drop_certificate_here' => 'Spustite potrdilo o ustanovitvi sem ali kliknite za nalaganje',
    'government_id' => 'Osebni dokument',
    'drop_government_id_here' => 'Spustite osebni dokument sem ali kliknite za nalaganje',
    'documents' => 'Dokumenti',
    ...
    'already_vendor' => 'Že ste prodajalec.',
    'updated_registration_successfully' => 'Registracija uspešno posodobljena',
    'updated_registration_info_successfully' => 'Registracijski podatki uspešno posodobljeni!',
    ...
    'fees' => 'Pristojbine',
    'congratulations_vendor' => 'Čestitamo, ker ste prodajalec pri :site_title',
    'attract_customers_message' => 'Privabimo stranke z dodajanjem vašega prvega izdelka.',
    'choose_product_type_to_create' => 'Izberite vrsto izdelka, ki ga želite ustvariti:',
    'create_new_product_here' => 'Ustvari nov izdelek <a href=":url">tukaj</a>',
    'no_orders_yet_message' => 'Imate :total izdelek(-e), vendar še nimate naročil',
    'view_your_store_here' => 'Oglejte si svojo trgovino <a href=":url">tukaj</a>',
    ...
    'go_to_customer_dashboard' => 'Nadzorna plošča stranke',
