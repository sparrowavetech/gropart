...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => '재고 부족 알림',
        'store_low_stock_description' => '제품 재고가 임계값 아래로 떨어지면 판매자에게 이메일 전송',
        'store_low_stock_subject' => '재고 부족 경고: {{ product_name }} 재고가 부족합니다',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => '재고 부족 경고',
        'store_low_stock_message' => '제품 <strong>:product_name</strong>의 재고가 부족하여 <strong>:product_quantity</strong>개만 남았습니다. 재고 부족 임계값은 <strong>:low_stock_threshold</strong>으로 설정되어 있습니다.',
        'store_low_stock_restock' => '판매 기회를 놓치지 않도록 이 제품을 재입고해 주세요.',
        'store_low_stock_view_product' => '제품 보기',
        'store_verified_title' => '스토어 인증 승인됨',
    ...
    'settings' => [
        ...
        'fee_withdrawal_amount_helper' => '판매자가 출금을 요청할 때 부과할 금액 또는 비율.',
        'withdrawal_fee_type' => '출금 수수료 유형',
        'withdrawal_fee_type_helper' => '출금 수수료가 고정 금액인지 출금 금액의 비율인지 선택하세요.',
        'withdrawal_fee_types' => [
            'fixed' => '고정 금액',
            'percentage' => '백분율',
        ],
        'check_valid_signature' => '판매자 수익에서 유효한 서명 확인',
        'check_valid_signature_helper' => '활성화하면 시스템이 조작을 방지하기 위해 판매자 수익 기록의 무결성을 확인합니다.',
        ...
        'enable_stores_page' => '스토어 목록 페이지 활성화?',
        'enable_stores_page_helper' => '비활성화하면 스토어 목록 페이지(예: /stores)가 404 오류를 반환합니다.',
        'hide_store_phone_number' => '스토어 전화번호 숨기기?',
        'hide_store_phone_number_helper' => '활성화하면 스토어 전화번호가 공개 스토어 페이지에서 숨겨집니다.',
        'hide_store_email' => '스토어 이메일 숨기기?',
        'hide_store_email_helper' => '활성화하면 스토어 이메일이 공개 스토어 페이지에서 숨겨집니다.',
        'hide_store_address' => '스토어 주소 숨기기?',
        'hide_store_address_helper' => '활성화하면 스토어 주소가 공개 스토어 페이지에서 숨겨집니다.',
        'hide_store_social_links' => '스토어 소셜 링크 숨기기?',
        'hide_store_social_links_helper' => '활성화하면 스토어 소셜 링크가 공개 스토어 페이지에서 숨겨집니다.',
        'hide_store_info_in_invoice' => '송장에 상점 정보를 숨기시겠습니까?',
        'hide_store_info_in_invoice_helper' => '활성화되면 송장에는 공급업체/상점 정보 대신 기본 사이트 정보가 사용됩니다.',
        ...
        'max_upload_filesize_helper' => '판매자가 업로드할 수 있는 최대 파일 크기(메가바이트).',
        'max_product_images_upload_by_vendor' => '상품당 최대 이미지 수',
        'max_product_images_upload_by_vendor_helper' => '판매자가 제품당 업로드할 수 있는 이미지 수를 제한합니다.',
        ...
        'allow_vendor_manage_product_currency' => '공급업체가 제품 통화를 관리하도록 허용',
        'allow_vendor_manage_product_currency_description' => '활성화되면 공급업체는 제품에 대한 통화를 선택할 수 있습니다. 가격은 표시를 위해 기본 통화로 변환됩니다.',
        ...
        'allow_vendor_digital_products' => '판매자가 디지털 제품을 판매하도록 허용',
        'allow_vendor_digital_products_helper' => '이를 활성화하면 판매자가 디지털/다운로드 가능한 제품을 만들고 판매할 수 있습니다.',
        'low_stock_threshold' => '재고 부족 임계값',
        'low_stock_threshold_helper' => '제품 수량이 이 숫자 이하로 떨어지면 판매자에게 이메일 알림이 전송됩니다. 기본값은 5입니다.',
    ],
    'theme_options' => [
        'name' => '마켓플레이스',
    ...
    'forms' => [
        'back' => '뒤로',
        'drop_files_here_or_click_to_upload' => '여기에 파일을 끌어다 놓거나 클릭하여 업로드',
        'check' => '확인',
        'error' => '오류',
        'confirm_delete_image' => '이 이미지를 삭제하시겠습니까?',
        'character_remain' => '자 남음',
    ],
    ...
    'drop_certificate_here' => '여기에 법인등기부등본을 끌어다 놓거나 클릭하여 업로드',
    'government_id' => '신분증',
    'drop_government_id_here' => '여기에 신분증을 끌어다 놓거나 클릭하여 업로드',
    'documents' => '서류',
    ...
    'already_vendor' => '이미 판매자입니다.',
    'updated_registration_successfully' => '등록 정보가 성공적으로 업데이트되었습니다!',
    'updated_registration_info_successfully' => '등록 정보가 성공적으로 업데이트되었습니다!',
    ...
    'choose_product_type_to_create' => '생성하려는 제품 유형을 선택하세요.',
    ...
    'go_to_customer_dashboard' => '고객 대시보드',
    'recent_orders' => '최근 주문',
    'no_orders' => '주문 없음!',
