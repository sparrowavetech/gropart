...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => 'Обавештење о ниским залихама',
        'store_low_stock_description' => 'Пошаљи имејл продавцу када залихе производа падну испод прага',
        'store_low_stock_subject' => 'Упозорење о ниским залихама: {{ product_name }} понестаје',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => 'Упозорење о ниским залихама',
        'store_low_stock_message' => 'Ваш производ <strong>:product_name</strong> има ниске залихе са само <strong>:product_quantity</strong> преосталих комада. Праг ниских залиха је постављен на <strong>:low_stock_threshold</strong>.',
        'store_low_stock_restock' => 'Молимо допуните залихе овог производа да не бисте пропустили продаје.',
        'store_low_stock_view_product' => 'Погледај производ',
        'store_verified_title' => 'Verifikacija prodavnice odobrena',
    ...
    'settings' => [
        ...
        'enable_stores_page' => 'Omogući stranicu sa listom prodavnica?',
        'enable_stores_page_helper' => 'Ako je onemogućeno, stranica sa listom prodavnica (npr. /stores) vratiće grešku 404.',
        ...
        'hide_store_info_in_invoice' => 'Sakrij informacije o prodavnici na fakturi?',
        'hide_store_info_in_invoice_helper' => 'Ako je omogućeno, fakture će koristiti informacije o glavnom sajtu umesto informacija o prodavcu/prodavnici.',
        ...
        'allow_vendor_manage_product_currency' => 'Дозволите продавцима да управљају валутом производа',
        'allow_vendor_manage_product_currency_description' => 'Ако је омогућено, продавци могу да изаберу валуту за своје производе. Цене ће бити конвертоване у подразумевану валуту за приказ.',
        ...
        'low_stock_threshold' => 'Праг ниских залиха',
        'low_stock_threshold_helper' => 'Када количина производа падне на овај број или ниже, продавац ће примити обавештење путем имејла. Подразумевано је 5.',
    ],
    'theme_options' => [
        'name' => 'Tržište',
    ...
    'product_quantity' => 'Количина производа',
    'low_stock_threshold' => 'Праг ниских залиха',
    ...
    'forms' => [
        'back' => 'Назад',
        'drop_files_here_or_click_to_upload' => 'Превуците датотеке овде или кликните за отпремање',
        'check' => 'Провери',
        'error' => 'Грешка',
        'confirm_delete_image' => 'Да ли сте сигурни да желите да обришете ову слику?',
        'character_remain' => 'преосталих знакова',
    ],
    ...
    'certificate_of_incorporation' => 'Потврда о регистрацији',
    'drop_certificate_here' => 'Превуците потврду о регистрацији овде или кликните за отпремање',
    'government_id' => 'Лични документ',
    'drop_government_id_here' => 'Превуците лични документ овде или кликните за отпремање',
    'documents' => 'Dokumenta',
    ...
    'already_vendor' => 'Већ сте продавац.',
    'updated_registration_successfully' => 'Registracija uspešno ažurirana',
    'updated_registration_info_successfully' => 'Регистрациони подаци успешно ажурирани!',
    ...
    'fees' => 'Takse',
    'congratulations_vendor' => 'Честитамо што сте продавац на :site_title',
    'attract_customers_message' => 'Hajde da privučemo kupce dodavanjem vašeg prvog proizvoda.',
    'choose_product_type_to_create' => 'Изаберите тип производа који желите да направите:',
    'create_new_product_here' => 'Направите нови производ <a href=":url">овде</a>',
    'no_orders_yet_message' => 'Имате :total производе, али још немате поруџбине',
    'view_your_store_here' => 'Погледајте своју продавницу <a href=":url">овде</a>',
    ...
    'go_to_customer_dashboard' => 'Цустомер Дасхбоард',
