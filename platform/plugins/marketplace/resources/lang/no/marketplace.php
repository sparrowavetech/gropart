...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => 'Varsling om lav lagerbeholdning',
        'store_low_stock_description' => 'Send e-post til selger når produktbeholdningen faller under terskelen',
        'store_low_stock_subject' => 'Lav lagerbeholdning: {{ product_name }} er i ferd med å gå tom',
    ...
    'email_templates' => [
        ...
        'store_low_stock_message' => 'Produktet ditt <strong>:product_name</strong> har lav lagerbeholdning med bare <strong>:product_quantity</strong> igjen. Terskelen for lav lagerbeholdning er satt til <strong>:low_stock_threshold</strong>.',
        'store_low_stock_restock' => 'Vennligst fyll på dette produktet for å unngå tapte salg.',
    ...
    'settings' => [
        ...
        'enable_stores_page' => 'Aktiver butikkoversiktsside?',
        'enable_stores_page_helper' => 'Hvis deaktivert, vil butikkoversiktssiden (f.eks. /stores) returnere en 404-feil.',
        ...
        'hide_store_info_in_invoice' => 'Skjul butikkinformasjon på faktura?',
        'hide_store_info_in_invoice_helper' => 'Hvis aktivert, vil fakturaer bruke hovednettstedets informasjon i stedet for leverandørens/butikkens informasjon.',
        ...
        'allow_vendor_manage_product_currency' => 'Tillat leverandører å administrere produktvaluta',
        'allow_vendor_manage_product_currency_description' => 'Hvis aktivert, kan leverandører velge en valuta for produktene sine. Prisene vil bli konvertert til standardvalutaen for visning.',
        ...
        'low_stock_threshold' => 'Terskel for lav lagerbeholdning',
        'low_stock_threshold_helper' => 'Når produktmengden faller til dette tallet eller lavere, vil selgeren motta en e-postvarsling. Standard er 5.',
    ],
    'theme_options' => [
        'name' => 'Markedsplass',
    ...
    'forms' => [
        'back' => 'Tilbake',
        'drop_files_here_or_click_to_upload' => 'Slipp filer her eller klikk for å laste opp',
        'check' => 'Sjekk',
        'error' => 'Feil',
        'confirm_delete_image' => 'Er du sikker på at du vil slette dette bildet?',
    ...
    'drop_certificate_here' => 'Slipp registreringsbevis her eller klikk for å laste opp',
    'government_id' => 'Offentlig ID',
    'drop_government_id_here' => 'Slipp offentlig ID her eller klikk for å laste opp',
    ...
    'already_vendor' => 'Du er allerede selger.',
    'updated_registration_successfully' => 'Registrering oppdatert',
    'updated_registration_info_successfully' => 'Registreringsinformasjon oppdatert!',
    ...
    'fees' => 'Avgifter',
    'congratulations_vendor' => 'Gratulerer med å være leverandør på :site_title',
    'attract_customers_message' => 'La oss tiltrekke oss kunder ved å legge til ditt første produkt.',
    'choose_product_type_to_create' => 'Velg typen produkt du vil lage:',
    'create_new_product_here' => 'Opprett et nytt produkt <a href=":url">her</a>',
    'no_orders_yet_message' => 'Du har :total produkt(er), men ingen bestillinger ennå',
    'view_your_store_here' => 'Se butikken din <a href=":url">her</a>',
