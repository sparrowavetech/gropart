...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => '庫存不足通知',
        'store_low_stock_description' => '當產品庫存低於閾值時向賣家發送郵件',
        'store_low_stock_subject' => '庫存不足警告：{{ product_name }} 即將售罄',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => '庫存不足警告',
        'store_low_stock_message' => '您的產品 <strong>:product_name</strong> 庫存不足，僅剩 <strong>:product_quantity</strong> 件。低庫存閾值設置為 <strong>:low_stock_threshold</strong>。',
        'store_low_stock_restock' => '請及時補貨以免錯過銷售機會。',
        'store_low_stock_view_product' => '查看產品',
        'store_verified_title' => '商店驗證已批准',
    ...
    'settings' => [
        ...
        'fee_withdrawal_amount_helper' => '當賣家請求提款時收取的金額或百分比。',
        'withdrawal_fee_type' => '提款手續費類型',
        'withdrawal_fee_type_helper' => '選擇提款費用是固定金額還是提款金額的百分比。',
        'withdrawal_fee_types' => [
            'fixed' => '固定金額',
            'percentage' => '百分比',
        ],
        'check_valid_signature' => '檢查賣家收入中的有效簽名',
        'check_valid_signature_helper' => '如果啟用，系統將驗證賣家收入記錄的完整性以防止篡改。',
        ...
        'enable_stores_page' => '啟用商店列表頁面？',
        'enable_stores_page_helper' => '如果停用，商店列表頁面（如 /stores）將返回404錯誤。',
        'hide_store_phone_number' => '隱藏商店電話號碼?',
        'hide_store_phone_number_helper' => '如果啟用，商店電話號碼將從公共商店頁面隱藏。',
        'hide_store_email' => '隱藏商店電郵?',
        'hide_store_email_helper' => '如果啟用，商店郵箱將從公共商店頁面隱藏。',
        'hide_store_address' => '隱藏商店地址?',
        'hide_store_address_helper' => '如果啟用，商店地址將從公共商店頁面隱藏。',
        'hide_store_social_links' => '隱藏商店社交連結?',
        'hide_store_social_links_helper' => '如果啟用，商店社交連結將從公共商店頁面隱藏。',
        'hide_store_info_in_invoice' => '發票中隱藏店舖資訊？',
        'hide_store_info_in_invoice_helper' => '如果啟用，發票將使用主站的資訊而不是賣家/店舖資訊。',
        ...
        'max_upload_filesize_helper' => '賣家可以上傳的最大文件大小（兆字節）。',
        'max_product_images_upload_by_vendor' => '每件產品的最大圖片數量',
        'max_product_images_upload_by_vendor_helper' => '限制賣家每個產品可以上傳的圖片數量。',
        ...
        'allow_vendor_manage_product_currency' => '允許供應商管理產品貨幣',
        'allow_vendor_manage_product_currency_description' => '如果啟用，供應商可以為其產品選擇貨幣。價格將轉換為預設貨幣進行顯示。',
        ...
        'allow_vendor_digital_products' => '允許賣家銷售數字產品',
        'allow_vendor_digital_products_helper' => '啟用此選項以允許賣家創建和銷售數字/可下載產品。',
        'low_stock_threshold' => '低庫存閾值',
        'low_stock_threshold_helper' => '當產品數量降至此數字或以下時，賣家將收到郵件通知。默認值為5。',
    ],
    'theme_options' => [
        'name' => '市集',
        'description' => '市集的主題選項',
    ...
    'forms' => [
        'back' => '返回',
        'drop_files_here_or_click_to_upload' => '將檔案拖到此處或點擊上傳',
        'check' => '檢查',
        'error' => '錯誤',
        'confirm_delete_image' => '您確定要刪除這張圖片嗎？',
        'character_remain' => '剩餘字元',
    ],
    ...
    'drop_certificate_here' => '將公司註冊證書拖到此處或點擊上傳',
    'government_id' => '政府簽發的身份證件',
    'drop_government_id_here' => '將政府簽發的身份證件拖到此處或點擊上傳',
    'documents' => '文件',
    'store_products' => '商店產品',
    'store_orders' => '商店訂單',
    'total_revenue' => '總收入',
    ...
    'specification_groups' => '規格組',
    'specification_attributes' => '規格屬性',
    'specification_tables' => '規格表',
    'register_as' => '註冊為',
    'register' => '註冊',
    'i_am_customer' => '我是顧客',
    'i_am_vendor' => '我是賣家',
    ...
    'send_message_successfully' => '發送訊息成功！',
    'cannot_send_message_to_own_store' => 'You cannot send a message to your own store.',
    'vendor_account_not_verified' => '供應商帳戶未經驗證。',
    'invalid_signature' => '供應商資訊簽名無效',
    'file_not_found' => '未找到文件！',
    'notices' => [
        'file_not_found' => '找不到該檔案。',
    ],
    'update_successfully' => '更新成功！',
    'shop_url_exists' => '商店網址已存在。請選擇另一項！',
    'insufficient_balance' => '餘額不足或沒有銀行信息',
    'total_amount_exceeds_balance' => '總金額（含費用）超過您目前的餘額',
    'registered_successfully' => '註冊成功！',
    'already_vendor' => '您已經是賣家了。',
    'updated_registration_successfully' => '註冊資訊更新成功！',
    'updated_registration_info_successfully' => '註冊資訊更新成功！',
    'missing_documentations' => '缺少文檔！請上傳您的公司註冊證書和政府身分證件以繼續。',
    'only_add_products_from_same_store' => '您只能將同一家商店的產品加入購物車。',
    'checkout_only_one_store' => '一次只能結帳一家商店的產品。請先移除其他商店的商品，然後再繼續。',
    'coupon_code_invalid' => '優惠券代碼無效或不適用於產品',
    'recovered_from_previous_orders' => '您已從先前的訂單中恢復過來！',
    'not_available' => '無法使用',
    'available' => '可用的',
    'stores_seo_title' => '商店清單頁面 SEO 標題',
    'stores_seo_description' => '商店列表頁面 SEO 描述',
    'leave_empty_for_default' => '將其留空以使用預設描述。',
    'stores' => '商店',
    'total_products_found' => ':total 找到產品',
    'language' => '語言',
    'save_settings' => '儲存設定',
    'payout_info' => '付款資訊',
    'payment_method' => '付款方式',
    ...
    'account_number' => '帳號',
    'upi_id' => '統一識別碼',
    'upi_id_helper' => '它是可選的。如果您有 UPI ID，可以在此處提供。了解更多：https://support.google.com/pay/india/answer/10331134?hl=en',
    'description' => '描述',
    'paypal_id' => '貝寶 ID',
    'pickup_location' => '接送地點',
    'pickup_location_helper' => '您想在哪裡領取現金付款？',
    'contact_name' => '聯絡人姓名',
    'contact_phone' => '聯絡電話',
    'business_name' => '公司名稱',
    'tax_id' => '稅號',
    ...
    'conversion_rate' => '轉換率',
    'avg_order_value' => '平均。訂單價值',
    'fulfillment_rate' => '履行率',
    'store_visibility' => '商店可見度',
    'active' => '積極的',
    'sales_reports' => '銷售報告',
    'revenues_in_label' => '收入:label',
    'earnings_in_label' => '收入:label',
    'fees' => '費用',
    'congratulations_vendor' => '恭喜您成為 :site_title 的供應商',
    'attract_customers_message' => '用最好的產品吸引您的客戶。',
    'choose_product_type_to_create' => '選擇您要建立的產品類型：',
    'create_new_product_here' => '建立新產品<a href=":url">此處</a>',
    'no_orders_yet_message' => '您有 :total 產品，但還沒有訂單',
    'view_your_store_here' => '查看您的商店<a href=":url">此處</a>',
    'includes_order_statuses' => '包括已完成、待處理和處理狀態',
    'wait_for_approval' => '等待批准',
    'uploaded_certificate' => '已上傳證書',
    'uploaded_government_id' => '上傳的政府身分證件',
    'store' => '店鋪',
    'tax_info' => '稅務資訊',
    'joined_on_date' => '已加入:date',
    'view_your_store' => '查看您的商店',
    'go_to_homepage' => '前往首頁',
    'go_to_customer_dashboard' => '客戶儀表板',
    'recent_orders' => '最近訂單',
    'no_orders' => '沒有訂單！',
    'view_full_orders' => '查看完整訂單',
    'customer_reviews' => '顧客評價',
    'no_reviews_yet' => '還沒有評論',
    'reviews_require_ecommerce' => '評論功能需要電子商務插件',
    'view_all_products' => '查看所有產品',
    'top_selling_products' => '暢銷產品',
    'no_products' => '沒有產品！',
    'view_full_products' => '查看完整產品',
