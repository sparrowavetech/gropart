...
return [
    ...
    'email' => [
        ...
        'store_low_stock_title' => 'Ilmoitus vähäisestä varastosta',
        'store_low_stock_description' => 'Lähetä sähköposti myyjälle, kun tuotteen varasto laskee alle kynnysarvon',
        'store_low_stock_subject' => 'Varastovaroitus: {{ product_name }} on loppumassa',
    ...
    'email_templates' => [
        ...
        'store_low_stock_title' => 'Varastovaroitus',
        'store_low_stock_message' => 'Tuotteesi <strong>:product_name</strong> varasto on vähissä, vain <strong>:product_quantity</strong> kpl jäljellä. Vähäisen varaston kynnysarvo on <strong>:low_stock_threshold</strong>.',
        'store_low_stock_restock' => 'Täydennä tämän tuotteen varastoa, jotta et menetä myyntiä.',
        'store_low_stock_view_product' => 'Näytä tuote',
        'store_verified_title' => 'Kaupan vahvistus hyväksytty',
    ...
    'settings' => [
        ...
        'enable_stores_page' => 'Ota kauppaluettelosivu käyttöön?',
        'enable_stores_page_helper' => 'Jos poistettu käytöstä, kauppaluettelosivu (esim. /stores) palauttaa 404-virheen.',
        ...
        'hide_store_info_in_invoice' => 'Piilota kaupan tiedot laskussa?',
        'hide_store_info_in_invoice_helper' => 'Jos otettu käyttöön, laskut käyttävät pääsivuston tietoja myyjän/kaupan tietojen sijaan.',
        ...
        'allow_vendor_manage_product_currency' => 'Salli myyjien hallita tuotevaluuttaa',
        'allow_vendor_manage_product_currency_description' => 'Jos tämä on käytössä, toimittajat voivat valita tuotteilleen valuutan. Hinnat muunnetaan näytön oletusvaluutaksi.',
        ...
        'low_stock_threshold' => 'Vähäisen varaston kynnysarvo',
        'low_stock_threshold_helper' => 'Kun tuotteen määrä laskee tähän numeroon tai sen alle, myyjä saa sähköposti-ilmoituksen. Oletusarvo on 5.',
    ],
    'theme_options' => [
        'name' => 'Markkinapaikka',
    ...
    'forms' => [
        'back' => 'Takaisin',
        'drop_files_here_or_click_to_upload' => 'Pudota tiedostot tähän tai napsauta ladataksesi',
        'check' => 'Tarkista',
        'error' => 'Virhe',
        'confirm_delete_image' => 'Haluatko varmasti poistaa tämän kuvan?',
        'character_remain' => 'merkkiä jäljellä',
    ],
    ...
    'certificate_of_incorporation' => 'Perustamiskirja',
    'drop_certificate_here' => 'Pudota perustamiskirja tähän tai napsauta ladataksesi',
    'government_id' => 'Virallinen henkilöllisyystodistus',
    'drop_government_id_here' => 'Pudota henkilöllisyystodistus tähän tai napsauta ladataksesi',
    ...
    'already_vendor' => 'Olet jo myyjä.',
    'updated_registration_successfully' => 'Rekisteröintitiedot päivitetty onnistuneesti!',
    'updated_registration_info_successfully' => 'Rekisteröintitiedot päivitetty onnistuneesti!',
    ...
    'choose_product_type_to_create' => 'Valitse luotavan tuotteen tyyppi:',
    ...
    'go_to_customer_dashboard' => 'Asiakashallintapaneeli',
