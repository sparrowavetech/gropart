    ...
    <header class="main-header navbar">
        ...
        <div class="col-nav">
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a
                        class="requestfullscreen nav-link btn-icon"
                        href="#"
                    ><i class="material-icons md-cast"></i></a>
                </li>
                <li class="dropdown nav-item">
                    ...
                    >
                        ...
                        />
                        <span class="d-none d-sm-inline-block vendor-name">{{ auth('customer')->user()->name }}:
                            {{ __('Earning') }}:
                            {{ format_price(auth('customer')->user()->vendorInfo->balance) }}</span>
                    </a>
                    <div
                    ...
                    >
                        ...
                        ><i class="material-icons md-perm_identity"></i>{{ __('My Account') }}</a>
                        <div class="dropdown-divider"></div>
                        <a
                            class="dropdown-item text-danger"
                            href="{{ route('customer.logout') }}"
                        ><i class="material-icons md-exit_to_app"></i>{{ __('Sign out') }}</a>
                    </div>
                </li>
            </ul>
        </div>
