                        ...
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                @forelse ($data['orders'] as $order)
                                    <tr>
                                        <td><a
                                                href="{{ route('marketplace.vendor.orders.edit', $order->id) }}">{{ $order->code }}</a>
                                        </td>
                            ...
                            <tbody>
                                @forelse ($data['products'] as $product)
                                    <tr>
                                        <td>{{ $product->id }}</td>
                                        <td><a
                                                href="{{ route('marketplace.vendor.products.edit', $product->original_product->id) }}"><strong>{{ $product->original_product->name }}</strong></a>
                                        </td>
