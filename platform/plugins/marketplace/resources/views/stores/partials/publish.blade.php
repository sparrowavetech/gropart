<x-core::card>
    ...
    <x-core::card.body>
        <div class="mb-3">
            <label class="form-label" for="status">{{ trans('core/base::tables.status') }}</label>
            {!! Form::customSelect('status', \Botble\Base\Enums\BaseStatusEnum::labels(), $model->status ?: \Botble\Base\Enums\BaseStatusEnum::PUBLISHED) !!}
        </div>
