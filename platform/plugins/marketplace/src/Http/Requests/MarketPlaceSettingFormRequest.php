...
class MarketPlaceSettingFormRequest extends BaseProductRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'low_stock_threshold' => 'sometimes|min:1|numeric|integer',
            'allow_vendor_digital_products' => [new OnOffRule()],
            ...
            'hide_store_info_in_invoice' => [new OnOffRule()],
            'allow_vendor_manage_product_currency' => [new OnOffRule()],
