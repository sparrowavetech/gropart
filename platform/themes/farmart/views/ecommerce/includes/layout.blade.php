    ...
    <div class="catalog-toolbar__view d-flex align-items-center">
        ...
        <div class="toolbar-view__icon">
            <a
                ...
                data-class-remove="row-cols-md-2 row-cols-1 shop-products-listing__list"
                data-class-add="row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-2"
                href="#"
            >
                <span class="svg-icon">
                    <svg>
            ...
            <a
                ...
                data-layout="list"
                data-target=".shop-products-listing"
                data-class-add="row-cols-md-2 row-cols-1 shop-products-listing__list"
                data-class-remove="row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-2"
                href="#"
            >
                <span class="svg-icon">
                    <svg>
