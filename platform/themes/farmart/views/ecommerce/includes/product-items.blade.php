...
>
<div
    class="row @if (request()->input('layout') == 'list') row-cols-md-2 row-cols-1 shop-products-listing__list @else row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-2 @endif shop-products-listing g-0">
