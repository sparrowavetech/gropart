                                    ...
                                    <tr class="cart-form__cart-item cart_item">
                                        <td class="product-thumbnail">
                                            ...
                                            <a href="{{ $product->original_product->url }}"
                                                ...
                                                <img class="mx-auto" src="{{ RvMedia::getImageUrl($cartItem->options->image, 'thumb', false, RvMedia::getDefaultImage()) }}"
                                            ...
                                            <div class="box-price">
                                                ...
                                                <span class="quantity">
                                                    <span class="price-amount amount">
                                                        <bdi class="fs-5">{{ format_price($cartItem->price) }} @if ($product->front_sale_price != $product->price)
                                        ...
                                        <td class="product-subtotal product-md d-md-table-cell d-block" data-title="{{ __('Total') }}">
                                            <div class="box-price">
                                                ...
                                                <span class="fw-bold amount">
                                                    <span class="price-current fs-5">{{ format_price($cartItem->price * $cartItem->qty) }}</span>
                                                </span>
                                            </div>
                                        </td>
                    ...
                    @else
                        <div class="col-coupon form-coupon-wrapper">
                            <div class="coupon">
                                ...
                                <div class="coupon-input input-group mt-1 mb-3">
