            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-8 ps-4 product-details-content">
                    <div class="product-details js-product-content">
                        ...
                        @if (Botble\Ecommerce\Facades\FlashSale::isEnabled() && ($flashSale = Botble\Ecommerce\Facades\FlashSale::getFlashSaleForProduct($product)))
                ...
                <div class="col-lg-3 col-md-4">
                    @if (theme_option('product_page_vendor_info_position', 'before') == 'before')
                        {!! Theme::partial('marketplace.product-vendor-info-box', compact('product')) !!}
                    @endif
                    {!! dynamic_sidebar('product_detail_sidebar') !!}
                    @if (theme_option('product_page_vendor_info_position', 'before') == 'after')
                        {!! Theme::partial('marketplace.product-vendor-info-box', compact('product')) !!}
                    @endif
                </div>
            </div>
