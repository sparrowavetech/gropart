        ...
        <div class="row">
            ...
            @if ($shortcode->app_enabled)
                <div class="col-lg-4 py-4 py-lg-0">
                    <div class="widget-wrapper widget-mobile-apps h-100 lazyload" @if ($shortcode->app_bg) data-bg="{{ RvMedia::getImageUrl($shortcode->app_bg) }}" @endif>
