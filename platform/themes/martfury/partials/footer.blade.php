                ...
                <aside class="widget widget_footer widget_contact-us">
                    ...
                    <div class="widget_content">
                        @if (theme_option('hotline'))
                            <p>{{ __('Call us 24/7') }}</p>
                            <a href="tel:{{ theme_option('hotline') }}"><h3><i class="fa fa-phone"></i> {{ theme_option('hotline') }}</h3></a>
                        @endif
                        <p><i class="fa fa-map-marker"></i> {{ theme_option('address') }}<br><a href="mailto:{{ theme_option('email') }}"><i class="fa fa-envelope-o"></i> {{ theme_option('email') }}</a></p>
