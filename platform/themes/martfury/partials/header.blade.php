                ...
                <div class="row">
                    <div class="col-sm-6 col-12">
                        <ul class="nav">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" href="tel:{{ theme_option('hotline') }}"><i class="fa fa-phone"></i>  {{ theme_option('hotline') }}</a>
                          </li>
                          @endif
                          @if (theme_option('email'))
                          <li class="nav-item">
                            <a class="nav-link" href="mailto:{{ theme_option('email') }}"><i class="fa fa-envelope-o"></i> {{ theme_option('email') }}</a>
                          </li>
                          @endif
                        </ul>
                    </div>
