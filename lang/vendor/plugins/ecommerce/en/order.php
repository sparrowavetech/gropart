...
return [
    ...
    'paid_at' => 'Paid Time',
    'coupon_code_lable' => 'Coupon Discount',
    ...
    'order_was_sent_to_shipping_team' => 'Order was sent to delivery team',
    'by_username' => 'by %user_name%',
    'shipping_was_created_from' => 'Delivery was created from order %order_id%',
    'shipping_was_canceled_success' => 'Delivery was cancelled successfully!',
    'shipping_was_canceled_by' => 'Delivery was cancelled by %user_name%',
    'update_shipping_address_success' => 'Update delivery address successfully!',
    ...
    'sku' => 'SKU',
    'warehouse' => 'Warehouse',
    'sub_amount' => 'Product Total Amount (Excl. Tax)',
    ...
    'send' => 'Send',
    'update' => 'Update',
    'cancel_shipping_confirmation' => 'Cancel delivery confirmation?',
    'cancel_shipping_confirmation_description' => 'Cancel delivery confirmation?',
    ...
    'order_note_placeholder' => 'Note about order, ex: time or delivery instruction.',
    ...
    'discount' => 'Discount',
    'add_shipping_fee' => 'Add delivery charge',
    'delivery' => 'delivery',
    ...
    'how_to_select_configured_shipping' => 'How to select configured delivery?',
    'please_add_customer_information_with_the_complete_shipping_address_to_see_the_configured_shipping_rates' => 'Please add customer information with the complete delivery address to see the configured delivery rates',
    'please_products_and_customer_address_to_see_the_shipping_rates' => 'Please add products and customer information with the complete delivery address to see the configured delivery rates',
    'shipping_method_not_found' => 'Delivery method not found',
    ...
    'update_shipping_status_notifications' => [
        'update_shipping_status' => 'Update delivery status',
        'description' => 'Order :order had changed delivery status :description',
    ],
