...
return [
    ...
    'configuration_instruction' => 'კონფიგურაციის ინსტრუქცია :name-სთვის',
    'configuration_requirement' => ':name-ის გამოსაყენებლად, თქვენ გჭირდებათ',
    'service_registration' => 'დარეგისტრირდით :name-თან',
    'after_service_registration_msg' => ':name-ზე რეგისტრაციის შემდეგ, თქვენ მიიღებთ API გასაღებს',
    ...
    'parcel' => 'Parcel',
    'estimated_days' => 'სავარაუდო მიწოდება :day დღეში',
    'from_address' => 'From address',
    'to_address' => 'To address',
    'check_validate_token' => 'Check validate token?',
    'saved_shipping_settings_success' => 'Saved settings successfully!',
    'token_name_is_required' => ':name აუცილებელია ინტეგრაციის მუშაობისთვის',
    'token_name_is_invalid' => ':name არასწორია',
    ...
    'view_other_exchange_rates' => 'იხილეთ :count სხვა გაცვლითი კურსი',
