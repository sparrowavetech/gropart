...
return [
    ...
    'note_2' => 'Habilitado "Carregar países, estados, cidades da localização do plugin?" e "Ativar CEP?" para Shipmozo funcionar corretamente',
    ...
    'note_5' => 'Shipmozo só permite criar transações com remessa/taxa dentro de 24 horas, se for mais de 24 horas, atualize a taxa novamente',
    ...
    'activate' => 'Ativar',
    'disabled_in_demo_mode' => 'Você não pode atualizar as configurações do Shipmozo no modo de demonstração!',
    'parcel' => 'Parcela',
    ...
    'not_available_in_cod_payment_method' => 'As opções do Shipmozo não serão mostradas se o método de pagamento selecionado for COD!',
