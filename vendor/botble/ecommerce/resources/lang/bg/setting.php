...
return [
  ...
  [
    ...
    [
      ...
      'store_name_placeholder' => 'Моят магазин',
      'store_name_helper' => 'Името на вашия магазин ще се показва в имейли, фактури и из целия сайт.',
      'store_company' => 'Име на фирмата',
      'store_company_placeholder' => 'Моята фирма ЕООД',
      'store_company_helper' => 'Юридическо име на фирмата за фактури и официални документи.',
      'store_phone' => 'Телефонен номер',
      'store_phone_placeholder' => '+359 2 123 4567',
      'store_phone_helper' => 'Телефон за контакт, показван на клиенти и във фактури.',
      'store_email' => 'Имейл на магазина',
      'store_email_placeholder' => 'contact@mystore.com',
      'store_email_helper' => 'Основен имейл за контакт за запитвания от клиенти и показване във фактури.',
      'store_address' => 'Адрес',
      'store_address_placeholder' => 'ул. Главна 123, 1000 София',
      'store_address_helper' => 'Физически адрес, показван във фактури и за изчисляване на доставка.',
      'store_vat_number' => 'ЕИК / ДДС номер / VAT',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'Данъчен идентификационен номер на вашата фирма за фактури.',
      'admin_notification_email' => 'Имейли за известия на администратора',
      'admin_notification_email_helper' => 'Имейли за получаване на известия за поръчки, връщания и др. Ако е празно, известията ще се изпращат на имейлите на администратора по подразбиране.',
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'Активиране на допълнителни продукти',
      'is_enabled_up_sale_products_helper' => 'Показване на предложения за допълнителни продукти за насърчаване на покупка на по-скъпи варианти.',
      ...
      'delete_product_images_when_deleting' => 'Изтриване на изображенията на продукта при изтриване',
      'delete_product_images_when_deleting_helper' => 'При активиране всички изображения, свързани с продукта (включително основно изображение, галерия и изображения на вариации), ще бъдат окончателно изтрити от медийната библиотека при изтриване на продукта.',
      'enable_product_currency_selection' => 'Активиране на избор на валута за продукт',
      'enable_product_currency_selection_helper' => 'Позволява избор на валута за всеки продукт. Цените ще бъдат конвертирани в валутата по подразбиране за показване.',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'Максимален размер на файл в мегабайти за всяко качено изображение на отзив',
        'max_file_number' => 'Максимален брой файлове за отзив',
        'max_file_number_help' => 'Максимален брой изображения, които клиент може да качи към отзив',
      ],
      'review_comment_required' => 'Изискване на коментар към отзива',
      'review_comment_required_help' => 'При деактивиране клиентите могат да изпратят оценка със звезди без писане на коментар',
      'only_allow_customers_purchased_to_review' => 'Само клиенти, които са закупили продукта, могат да оставят отзив за продукта',
      'only_allow_customers_purchased_to_review_help' => 'При активиране само клиенти с изпълнена поръчка, съдържаща продукта, могат да оставят отзив',
      'review_need_to_be_approved' => 'Отзивът трябва да бъде одобрен преди да се покаже на страницата на продукта',
      'review_need_to_be_approved_help' => 'При активиране новите отзиви ще бъдат скрити, докато администратор не ги одобри',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'Активиране на изтриване на поръчки',
      'enable_order_deletion_helper' => 'Ако е активирано, администраторите могат да изтриват поръчки. Ако е деактивирано, поръчките могат само да променят статус и не могат да бъдат изтрити. Деактивирайте тази опция, за да запазите всички поръчки за одит, отчетност и правни цели.',
  ...
  [
    ...
    [
      ...
      'enable_order_notes_at_checkout' => 'Активиране на бележки към поръчката при плащане',
      'enable_order_notes_at_checkout_helper' => 'Ако е активирано, клиентите могат да добавят незадължителни бележки към поръчката си на страницата за плащане (напр. специални инструкции за доставка).',
    ],
  ],
  'return' =>
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'Позволяване на клиенти да качват изображения',
      'allow_customer_upload_image_help' => 'Позволява на клиентите да качват снимки при подаване на заявка за връщане.',
      'max_file_size' => 'Максимален размер на файл (MB)',
      'max_file_size_help' => 'Максимален размер на файл с изображение в мегабайти.',
      'max_file_number' => 'Максимален брой изображения',
    ],
  ],
  'invoice' =>
  [
    ...
    [
      ...
      'company_name_helper' => 'Името на вашия бизнес или компания, което ще се показва на всички фактури, изпратени до клиентите.',
      'company_address' => 'Адрес на компанията',
      'company_address_placeholder' => '123 Business Street, Suite 100, New York, NY 10001, USA',
      'company_address_helper' => 'Пълният адрес на вашата компания, включително улица, град, щат и държава. Той ще се показва на фактурите.',
      'company_zipcode' => 'Пощенски код на компанията',
      'company_zipcode_placeholder' => '10001',
      'company_zipcode_helper' => 'Пощенски код на адреса на вашата компания.',
      'company_email' => 'Имейл на компанията',
      'company_email_placeholder' => 'billing@company.com',
      'company_email_helper' => 'Имейл адрес за бизнес запитвания. Клиентите могат да го използват за въпроси, свързани с фактури.',
      'company_phone' => 'Телефон на компанията',
      'company_phone_placeholder' => '+1 (555) 123-4567',
      'company_phone_helper' => 'Телефон за контакт, който ще се показва на фактурите за поддръжка на клиенти.',
      'company_logo' => 'Лого на компанията',
      'company_logo_helper' => 'Логото на вашата компания, което ще се показва в горната част на фактурите. Препоръчителен размер: 200x60 пиксела.',
      'company_tax_id' => 'Данъчен номер на компанията',
      'company_tax_id_placeholder' => 'VAT123456789',
      'company_tax_id_helper' => 'Данъчният идентификационен номер на вашия бизнес (ДДС, GST, EIN и др.) за данъчно съответствие.',
      'invoice_code_prefix' => 'Префикс на код на фактура',
      'invoice_code_prefix_placeholder' => 'INV-',
      'invoice_code_prefix_helper' => 'Префикс, добавен преди номерата на фактурите (напр. INV- ще създаде кодове като INV-001, INV-002).',
      'using_custom_font_for_invoice' => 'Използване на персонализиран шрифт за фактура',
      'using_custom_font_for_invoice_helper' => 'Активирайте, за да използвате персонализиран Google Font за PDF фактурите вместо шрифта по подразбиране.',
      'invoice_font_family' => 'Семейство шрифтове на фактура (Работи само за латински език)',
      'invoice_font_family_helper' => 'Изберете Google Font за използване в PDF фактурите. Работи само с латински набори от символи.',
      'enable_invoice_stamp' => 'Активиране на печат на фактура',
      'enable_invoice_stamp_helper' => 'Добавете печат PAID към фактурите, когато плащането на поръчката е завършено.',
      'add_language_support' => 'Добавяне на езикова поддръжка',
      'add_language_support_helper' => 'Изберете допълнителна поддръжка на набори от символи за нелатински езици в PDF фактурите.',
      'invoice_processing_library' => 'Библиотека за обработка на фактури',
      'invoice_processing_library_helper' => 'Изберете библиотека за генериране на PDF. DomPDF е по-бърз, но с ограничени функции. mPDF поддържа повече езици и функции, но може да е по-бавен.',
      ...
      'disable_order_invoice_until_order_confirmed_helper' => 'Когато е активирано, фактурите ще бъдат достъпни само след потвърждаване на поръчките, а не веднага след подаването им.',
      'date_format' => 'Формат на дата',
      'date_format_helper' => 'Изберете как ще се показват датите на фактурите (напр. F d, Y показва January 01, 2024).',
      'languages' =>
      [
        'arabic' => 'Арабски',
  ...
  [
    ...
    'go_to_taxes' => 'Електронна търговия → Данъци',
    'form' =>
    [
      ...
      'display_item_tax_at_checkout' => 'Показване на данък на артикул при плащане',
      'display_item_tax_at_checkout_helper' => 'Показва сумата на данъка (напр. "Данък: $10.00") за всеки артикул на страницата за плащане.',
      'tax_on_shipping_fee' => 'Прилагане на данък върху таксата за доставка',
      'tax_on_shipping_fee_helper' => 'Когато е активирано, ставката по подразбиране ще се прилага върху таксите за доставка. Уверете се, че е конфигурирана ставка по подразбиране в Електронна търговия → Данъци.',
    ],
  ],
  'customer' =>
  [
  ...
  [
    ...
    [
      ...
      'end_with' => 'Завършва с',
      'start_number' => 'Начален номер',
      'start_number_description' => 'Номерацията на поръчки ще започне от тази стойност',
      'order_number_length' => 'Дължина на номера на поръчката',
      'order_number_length_description' => 'Минимален брой цифри в номера на поръчката (напр. 3 ще форматира 1 като 001)',
  ...
  'display_bank_info_at_the_checkout_success_page' => 'Показване на банкова информация на страницата за успешно плащане?',
  'display_bank_info_at_the_checkout_success_page_helper' => 'Когато е активирано, клиентите ще видят данните на банковата ви сметка на страницата за потвърждение на поръчката. Това им помага да знаят къде да преведат плащането.',
