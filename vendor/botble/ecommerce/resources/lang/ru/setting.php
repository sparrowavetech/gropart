...
return [
  ...
  [
    ...
    [
      ...
      'store_name_placeholder' => 'Мой магазин',
      'store_name_helper' => 'Название вашего магазина будет отображаться в электронных письмах, счетах и на сайте.',
      'store_company' => 'Название компании',
      'store_company_placeholder' => 'ООО «Моя компания»',
      'store_company_helper' => 'Юридическое название компании для счетов и официальных документов.',
      'store_phone' => 'Номер телефона',
      'store_phone_placeholder' => '+7 123 456 7890',
      'store_phone_helper' => 'Контактный номер, отображаемый для клиентов и в счетах.',
      'store_email' => 'Email магазина',
      'store_email_placeholder' => 'contact@mystore.com',
      'store_email_helper' => 'Основной контактный email для обращений клиентов и отображения в счетах.',
      'store_address' => 'Адрес',
      'store_address_placeholder' => 'ул. Главная, д. 123, офис 100',
      'store_address_helper' => 'Физический адрес, отображаемый в счетах и для расчёта доставки.',
      'store_vat_number' => 'ИНН / Tax ID / VAT',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'Идентификационный номер налогоплательщика для счетов.',
      'admin_notification_email' => 'Email для уведомлений администратора',
      'admin_notification_email_helper' => 'Адреса для получения уведомлений о заказах, возвратах и т.д. Если не указано, уведомления будут отправляться на email администратора по умолчанию.',
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'Включить сопутствующие товары',
      'is_enabled_up_sale_products_helper' => 'Отображать предложения сопутствующих товаров для стимулирования покупок более дорогих вариантов.',
      ...
      'delete_product_images_when_deleting' => 'Удалять изображения товара при его удалении',
      'delete_product_images_when_deleting_helper' => 'При включении все изображения, связанные с товаром (включая главное изображение, галерею и изображения вариаций), будут безвозвратно удалены из медиатеки при удалении товара.',
      'enable_product_currency_selection' => 'Включить выбор валюты товара',
      'enable_product_currency_selection_helper' => 'Позволяет выбирать валюту для каждого товара. Цены будут конвертированы в валюту по умолчанию для отображения.',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'Максимальный размер файла в мегабайтах для каждого загруженного изображения отзыва',
        'max_file_number' => 'Максимальное количество файлов в отзыве',
        'max_file_number_help' => 'Максимальное количество изображений, которые клиент может загрузить к отзыву',
      ],
      'review_comment_required' => 'Обязательный комментарий к отзыву',
      'review_comment_required_help' => 'При отключении клиенты могут оставить только оценку без написания комментария',
      'only_allow_customers_purchased_to_review' => 'Только клиенты, купившие товар, могут оставлять отзывы о товаре',
      'only_allow_customers_purchased_to_review_help' => 'При включении только клиенты с выполненным заказом, содержащим товар, смогут оставить отзыв',
      'review_need_to_be_approved' => 'Отзыв должен быть одобрен перед показом на странице товара',
      'review_need_to_be_approved_help' => 'При включении новые отзывы будут скрыты до одобрения администратором',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'Включить удаление заказов',
      'enable_order_deletion_helper' => 'Если включено, администраторы могут удалять заказы. Если отключено, заказы можно только менять по статусу, но нельзя удалять. Отключите для сохранения всех заказов в целях аудита, отчётности и соответствия законодательству.',
  ...
  [
    ...
    [
      ...
      'enable_order_notes_at_checkout' => 'Включить заметки к заказу при оформлении',
      'enable_order_notes_at_checkout_helper' => 'Если включено, клиенты могут добавлять необязательные заметки к своему заказу на странице оформления (например, специальные инструкции по доставке).',
    ],
  ],
  'return' =>
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'Разрешить клиентам загружать изображения',
      'allow_customer_upload_image_help' => 'Позволяет клиентам загружать фотографии при подаче заявки на возврат.',
      'max_file_size' => 'Максимальный размер файла (МБ)',
      'max_file_size_help' => 'Максимальный размер файла изображения в мегабайтах.',
      'max_file_number' => 'Максимальное количество изображений',
    ],
  ],
  'invoice' =>
  [
  ...
  [
    ...
    'go_to_taxes' => 'Электронная коммерция → Налоги',
    'form' =>
    [
      ...
      'display_item_tax_at_checkout' => 'Показывать налог на товар при оформлении заказа',
      'display_item_tax_at_checkout_helper' => 'Отображать сумму налога (например, «Налог: $10.00») для каждого товара на странице оформления заказа.',
      'tax_on_shipping_fee' => 'Применить налог к стоимости доставки',
      'tax_on_shipping_fee_helper' => 'При включении ставка налога по умолчанию будет применяться к стоимости доставки. Убедитесь, что ставка налога по умолчанию настроена в Электронная коммерция → Налоги.',
    ],
  ],
  'customer' =>
  [
  ...
  [
    ...
    [
      ...
      'google_ads_conversion_id_helper' => 'Введите ваш идентификатор конверсии Google Ads (формат: AW-123456789/AbC-D_efG-h1_ijk-lmN) для отслеживания конверсий покупок на странице благодарности.',
    ],
    'validation' =>
    [
  ...
  [
    ...
    [
      ...
      'start_number_description' => 'Нумерация заказов начнётся с этого значения',
      'order_number_length' => 'Длина номера заказа',
      'order_number_length_description' => 'Минимальное количество цифр в номере заказа (например, 3 отформатирует 1 как 001)',
  ...
  'display_bank_info_at_the_checkout_success_page' => 'Отображать банковскую информацию на странице успешного оформления заказа?',
  'display_bank_info_at_the_checkout_success_page_helper' => 'При включении клиенты увидят реквизиты вашего банковского счёта на странице подтверждения заказа после оформления покупки. Это поможет им узнать, куда перевести оплату.',
