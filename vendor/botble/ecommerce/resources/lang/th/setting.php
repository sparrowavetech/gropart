...
return [
  ...
  [
    ...
    [
      ...
      'store_name_placeholder' => 'ร้านค้าของฉัน',
      'store_name_helper' => 'ชื่อร้านค้าของคุณจะแสดงในอีเมล ใบแจ้งหนี้ และทั่วทั้งเว็บไซต์',
      'store_company' => 'ชื่อบริษัท',
      'store_company_placeholder' => 'บริษัท ของฉัน จำกัด',
      'store_company_helper' => 'ชื่อธุรกิจตามกฎหมายสำหรับใบแจ้งหนี้และเอกสารทางการ',
      'store_phone' => 'หมายเลขโทรศัพท์',
      'store_phone_placeholder' => '+1 234 567 890',
      'store_phone_helper' => 'หมายเลขติดต่อที่แสดงให้ลูกค้าเห็นและบนใบแจ้งหนี้',
      'store_email' => 'อีเมลร้านค้า',
      'store_email_placeholder' => 'contact@mystore.com',
      'store_email_helper' => 'อีเมลติดต่อหลักสำหรับการสอบถามของลูกค้าและแสดงบนใบแจ้งหนี้',
      'store_address' => 'ที่อยู่',
      'store_address_placeholder' => '123 ถนนหลัก ห้อง 100',
      'store_address_helper' => 'ที่อยู่จริงที่แสดงบนใบแจ้งหนี้และสำหรับการคำนวณค่าจัดส่ง',
      'store_vat_number' => 'เลขประจำตัวผู้เสียภาษี / หมายเลข VAT',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'หมายเลขประจำตัวผู้เสียภาษีของธุรกิจคุณสำหรับใบแจ้งหนี้',
      'admin_notification_email' => 'อีเมลแจ้งเตือนผู้ดูแลระบบ',
      'admin_notification_email_helper' => 'อีเมลสำหรับรับการแจ้งเตือนอีคอมเมิร์ซ (คำสั่งซื้อใหม่ การคืนสินค้า ฯลฯ) หากว่างเปล่า การแจ้งเตือนจะถูกส่งไปยังอีเมลผู้ดูแลระบบเริ่มต้น',
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'เปิดใช้สินค้าขายเพิ่ม',
      'is_enabled_up_sale_products_helper' => 'แสดงคำแนะนำสินค้าขายเพิ่มเพื่อกระตุ้นการอัปเกรดระดับพรีเมียม',
      ...
      'delete_product_images_when_deleting' => 'ลบรูปภาพสินค้าเมื่อลบสินค้า',
      'delete_product_images_when_deleting_helper' => 'เมื่อเปิดใช้ รูปภาพทั้งหมดที่เกี่ยวข้องกับสินค้า (รวมถึงรูปภาพหลัก รูปภาพแกลเลอรี และรูปภาพตัวเลือก) จะถูกลบออกจากคลังสื่ออย่างถาวรเมื่อลบสินค้า',
      'enable_product_currency_selection' => 'เปิดใช้การเลือกสกุลเงินสินค้า',
      'enable_product_currency_selection_helper' => 'อนุญาตให้เลือกสกุลเงินสำหรับแต่ละสินค้า ราคาจะถูกแปลงเป็นสกุลเงินเริ่มต้นสำหรับการแสดงผล',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'ขนาดไฟล์สูงสุดเป็นเมกะไบต์สำหรับแต่ละรูปภาพรีวิวที่อัปโหลด',
        'max_file_number' => 'จำนวนไฟล์สูงสุดสำหรับรีวิว',
        'max_file_number_help' => 'จำนวนรูปภาพสูงสุดที่ลูกค้าสามารถอัปโหลดต่อรีวิว',
      ],
      'review_comment_required' => 'ต้องมีความคิดเห็นรีวิว',
      'review_comment_required_help' => 'เมื่อปิดใช้ ลูกค้าสามารถส่งการให้คะแนนดาวโดยไม่ต้องเขียนความคิดเห็น',
      'only_allow_customers_purchased_to_review' => 'อนุญาตเฉพาะลูกค้าที่ซื้อสินค้าแล้วให้รีวิวสินค้าได้',
      'only_allow_customers_purchased_to_review_help' => 'เมื่อเปิดใช้ เฉพาะลูกค้าที่มีคำสั่งซื้อที่เสร็จสมบูรณ์ซึ่งมีสินค้าดังกล่าวเท่านั้นที่สามารถเขียนรีวิวได้',
      'review_need_to_be_approved' => 'รีวิวจำเป็นต้องได้รับการอนุมัติก่อนแสดงในหน้าสินค้า',
      'review_need_to_be_approved_help' => 'เมื่อเปิดใช้ รีวิวใหม่จะถูกซ่อนจนกว่าผู้ดูแลระบบจะอนุมัติ',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'เปิดใช้การลบคำสั่งซื้อ',
      'enable_order_deletion_helper' => 'หากเปิดใช้ ผู้ดูแลระบบสามารถลบคำสั่งซื้อได้ หากปิดใช้ คำสั่งซื้อสามารถเปลี่ยนสถานะได้เท่านั้นและไม่สามารถลบได้ ปิดตัวเลือกนี้เพื่อเก็บคำสั่งซื้อทั้งหมดสำหรับการตรวจสอบ การรายงาน และวัตถุประสงค์ทางกฎหมาย',
  ...
  [
    ...
    [
      ...
      'enable_order_notes_at_checkout' => 'เปิดใช้งานบันทึกการสั่งซื้อเมื่อชำระเงิน',
      'enable_order_notes_at_checkout_helper' => 'หากเปิดใช้งาน ลูกค้าสามารถเพิ่มบันทึกเสริมในการสั่งซื้อได้ในหน้าชำระเงิน (เช่น คำแนะนำพิเศษในการจัดส่ง)',
    ],
  ],
  'return' =>
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'อนุญาตให้ลูกค้าอัปโหลดรูปภาพ',
      'allow_customer_upload_image_help' => 'อนุญาตให้ลูกค้าอัปโหลดรูปถ่ายเมื่อส่งคำขอคืนสินค้า',
      'max_file_size' => 'ขนาดไฟล์สูงสุด (MB)',
      'max_file_size_help' => 'ขนาดสูงสุดต่อไฟล์รูปภาพเป็นเมกะไบต์',
      'max_file_number' => 'จำนวนรูปภาพสูงสุด',
    ],
  ],
  'invoice' =>
  [
    ...
    'company_settings' => 'การตั้งค่าใบแจ้งหนี้',
    'company_settings_description' => 'ข้อมูลบริษัท การเรียงลำดับเลข ฟอนต์ PDF และตราประทับการชำระเงิน',
    'form' =>
    [
      'company_name' => 'ชื่อบริษัท',
      'company_name_placeholder' => 'Acme Corporation',
      'company_name_helper' => 'ชื่อธุรกิจหรือบริษัทของคุณที่จะปรากฏบนใบแจ้งหนี้ทั้งหมดที่ส่งถึงลูกค้า',
      'company_address' => 'ที่อยู่บริษัท',
      'company_address_placeholder' => '123 Business Street, Suite 100, New York, NY 10001, USA',
      'company_address_helper' => 'ที่อยู่เต็มของบริษัทรวมถึงถนน เมือง จังหวัด และประเทศ ข้อมูลนี้จะปรากฏบนใบแจ้งหนี้',
      'company_zipcode' => 'รหัสไปรษณีย์บริษัท',
      'company_zipcode_placeholder' => '10001',
      'company_zipcode_helper' => 'รหัสไปรษณีย์ของที่อยู่บริษัทของคุณ',
      'company_email' => 'อีเมลบริษัท',
      'company_email_placeholder' => 'billing@company.com',
      'company_email_helper' => 'ที่อยู่อีเมลสำหรับการสอบถามทางธุรกิจ ลูกค้าอาจใช้สำหรับคำถามเกี่ยวกับใบแจ้งหนี้',
      'company_phone' => 'โทรศัพท์บริษัท',
      'company_phone_placeholder' => '+1 (555) 123-4567',
      'company_phone_helper' => 'หมายเลขโทรศัพท์ติดต่อที่จะแสดงบนใบแจ้งหนี้สำหรับฝ่ายสนับสนุนลูกค้า',
      'company_logo' => 'โลโก้บริษัท',
      'company_logo_helper' => 'โลโก้บริษัทของคุณที่จะแสดงที่ด้านบนของใบแจ้งหนี้ ขนาดแนะนำ: 200x60 พิกเซล',
      'company_tax_id' => 'หมายเลขภาษีบริษัท',
      'company_tax_id_placeholder' => 'VAT123456789',
      'company_tax_id_helper' => 'หมายเลขประจำตัวผู้เสียภาษีของธุรกิจ (VAT, GST, EIN ฯลฯ) สำหรับการปฏิบัติตามภาษี',
      'invoice_code_prefix' => 'คำนำหน้ารหัสใบแจ้งหนี้',
      'invoice_code_prefix_placeholder' => 'INV-',
      'invoice_code_prefix_helper' => 'คำนำหน้าที่เพิ่มก่อนหมายเลขใบแจ้งหนี้ (เช่น INV- จะสร้างรหัสใบแจ้งหนี้เป็น INV-001, INV-002)',
      'using_custom_font_for_invoice' => 'ใช้ฟอนต์กำหนดเองสำหรับใบแจ้งหนี้',
      'using_custom_font_for_invoice_helper' => 'เปิดใช้งานเพื่อใช้ Google Font แบบกำหนดเองสำหรับ PDF ใบแจ้งหนี้แทนแบบอักษรเริ่มต้น',
      'invoice_font_family' => 'ตระกูลฟอนต์ใบแจ้งหนี้ (ใช้งานได้เฉพาะภาษาละติน)',
      'invoice_font_family_helper' => 'เลือก Google Font สำหรับใช้ใน PDF ใบแจ้งหนี้ ใช้งานได้เฉพาะกับชุดอักขระละติน',
      'enable_invoice_stamp' => 'เปิดใช้งานตราประทับใบแจ้งหนี้',
      'enable_invoice_stamp_helper' => 'เพิ่มตราประทับ PAID บนใบแจ้งหนี้เมื่อการชำระเงินของคำสั่งซื้อเสร็จสมบูรณ์',
      'add_language_support' => 'เพิ่มการสนับสนุนภาษา',
      'add_language_support_helper' => 'เลือกการรองรับชุดอักขระเพิ่มเติมสำหรับภาษาที่ไม่ใช่ละตินใน PDF ใบแจ้งหนี้',
      'invoice_processing_library' => 'ไลบรารี่ประมวลผลใบแจ้งหนี้',
      'invoice_processing_library_helper' => 'เลือกไลบรารีสร้าง PDF DomPDF เร็วกว่าแต่มีฟีเจอร์จำกัด mPDF รองรับภาษาและฟีเจอร์มากกว่าแต่อาจช้ากว่า',
      ...
      'disable_order_invoice_until_order_confirmed_helper' => 'เมื่อเปิดใช้งาน ใบแจ้งหนี้จะพร้อมใช้งานหลังจากยืนยันคำสั่งซื้อแล้วเท่านั้น ไม่ใช่ทันทีหลังจากสั่งซื้อ',
      'date_format' => 'รูปแบบวันที่',
      'date_format_helper' => 'เลือกรูปแบบการแสดงวันที่บนใบแจ้งหนี้ (เช่น F d, Y จะแสดงเป็น January 01, 2024)',
      'languages' =>
      [
        'arabic' => 'อารบิก',
        'bangladesh' => 'เบงกาลี',
  ...
  [
    'name' => 'ภาษี',
    'description' => 'การคำนวณภาษี ตัวเลือกการแสดงผล และช่องใบแจ้งหนี้ที่ชำระเงิน',
    ...
    'tax_setting' => 'การแสดงภาษีและการชำระเงิน',
    'tax_setting_description' => 'กำหนดค่าวิธีแสดงภาษีบนสินค้าและหน้าชำระเงิน',
    'tax_management' => 'การจัดการภาษี',
    'tax_management_description' => 'ดูและจัดการภาษีของคุณ',
    'manage_taxes_info' => 'หากต้องการจัดการภาษีและตั้งค่าอัตราภาษีเริ่มต้น กรุณาไปที่',
    'go_to_taxes' => 'อีคอมเมิร์ซ → ภาษี',
    'form' =>
    [
      ...
      'display_item_tax_at_checkout' => 'แสดงภาษีสินค้าที่หน้าชำระเงิน',
      'display_item_tax_at_checkout_helper' => 'แสดงจำนวนภาษี (เช่น "ภาษี: $10.00") สำหรับแต่ละรายการในหน้าชำระเงิน',
      'tax_on_shipping_fee' => 'เรียกเก็บภาษีค่าจัดส่ง',
      'tax_on_shipping_fee_helper' => 'เมื่อเปิดใช้งาน อัตราภาษีเริ่มต้นจะถูกนำไปใช้กับค่าจัดส่ง ตรวจสอบให้แน่ใจว่าได้กำหนดอัตราภาษีเริ่มต้นในอีคอมเมิร์ซ → ภาษี',
    ],
  ],
  'customer' =>
  [
  ...
  [
    'name' => 'Webhooks',
    'description' => 'ส่งเหตุการณ์คำสั่งซื้อไปยังบริการภายนอกผ่าน HTTP',
    'webhook_setting' => 'Webhook เหตุการณ์คำสั่งซื้อ',
    'webhook_setting_description' => 'กำหนดค่า URL เพื่อรับการแจ้งเตือนเมื่อสั่งซื้อ อัปเดต หรือจัดส่ง',
    'form' =>
    [
  ...
  [
    ...
    [
      ...
      'google_ads_conversion_id_helper' => 'ป้อน ID การแปลง Google Ads ของคุณ (รูปแบบ: AW-123456789/AbC-D_efG-h1_ijk-lmN) เพื่อติดตามการแปลงการซื้อในหน้าขอบคุณ',
    ],
    'validation' =>
    [
  ...
  [
    ...
    [
      ...
      'start_number_description' => 'หมายเลขคำสั่งซื้อจะเริ่มจากค่านี้',
      'order_number_length' => 'ความยาวหมายเลขคำสั่งซื้อ',
      'order_number_length_description' => 'จำนวนหลักขั้นต่ำสำหรับหมายเลขคำสั่งซื้อ (เช่น 3 จะจัดรูปแบบ 1 เป็น 001)',
  ...
  'display_bank_info_at_the_checkout_success_page' => 'แสดงข้อมูลธนาคารในหน้าชำระเงินสำเร็จ?',
  'display_bank_info_at_the_checkout_success_page_helper' => 'เมื่อเปิดใช้งาน ลูกค้าจะเห็นรายละเอียดบัญชีธนาคารของคุณในหน้ายืนยันคำสั่งซื้อหลังจากสั่งซื้อ ช่วยให้พวกเขาทราบว่าต้องโอนเงินไปที่ไหน',
