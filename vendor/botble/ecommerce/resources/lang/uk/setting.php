...
return [
  ...
  [
    ...
    [
      ...
      'store_name_placeholder' => 'Мій магазин',
      'store_name_helper' => 'Назва вашого магазину відображатиметься в електронних листах, рахунках та на сайті.',
      'store_company' => 'Назва компанії',
      'store_company_placeholder' => 'ТОВ «Моя компанія»',
      'store_company_helper' => 'Юридична назва компанії для рахунків та офіційних документів.',
      'store_phone' => 'Номер телефону',
      'store_phone_placeholder' => '+380 12 345 6789',
      'store_phone_helper' => 'Контактний номер, який відображається для клієнтів та в рахунках.',
      'store_email' => 'Email магазину',
      'store_email_placeholder' => 'contact@mystore.com',
      'store_email_helper' => 'Основний контактний email для запитів клієнтів та відображення в рахунках.',
      'store_address' => 'Адреса',
      'store_address_placeholder' => 'вул. Головна, 123, офіс 100',
      'store_address_helper' => 'Фізична адреса, що відображається в рахунках та для розрахунку доставки.',
      'store_vat_number' => 'ІПН / Tax ID / VAT',
      'store_vat_number_placeholder' => 'VAT123456789',
      'store_vat_number_helper' => 'Ідентифікаційний номер платника податків для рахунків.',
      'admin_notification_email' => 'Email для сповіщень адміністратора',
      'admin_notification_email_helper' => 'Адреси для отримання сповіщень про замовлення, повернення тощо. Якщо не вказано, сповіщення надсилатимуться на email адміністратора за замовчуванням.',
  ...
  [
    ...
    [
      ...
      'is_enabled_up_sale_products' => 'Увімкнути супутні товари',
      'is_enabled_up_sale_products_helper' => 'Відображати пропозиції супутніх товарів для стимулювання покупок дорожчих варіантів.',
      ...
      'delete_product_images_when_deleting' => 'Видаляти зображення товару при його видаленні',
      'delete_product_images_when_deleting_helper' => 'При увімкненні всі зображення, пов\'язані з товаром (включаючи головне зображення, галерею та зображення варіацій), будуть назавжди видалені з медіатеки при видаленні товару.',
      'enable_product_currency_selection' => 'Увімкнути вибір валюти товару',
      'enable_product_currency_selection_helper' => 'Дозволяє обирати валюту для кожного товару. Ціни будуть конвертовані у валюту за замовчуванням для відображення.',
    ],
  ],
  'product_search' =>
  [
  ...
  [
    ...
    [
      ...
      [
        ...
        'max_file_size_help' => 'Максимальний розмір файлу в мегабайтах для кожного завантаженого зображення відгуку',
        'max_file_number' => 'Макс. кількість файлів відгуку',
        'max_file_number_help' => 'Максимальна кількість зображень, які клієнт може завантажити до відгуку',
      ],
      'review_comment_required' => 'Обов\'язковий коментар до відгуку',
      'review_comment_required_help' => 'При вимкненні клієнти можуть залишити лише оцінку без написання коментаря',
      'only_allow_customers_purchased_to_review' => 'Тільки клієнти, які придбали товар, можуть залишати відгук про товар',
      'only_allow_customers_purchased_to_review_help' => 'При увімкненні лише клієнти з виконаним замовленням, що містить товар, зможуть залишити відгук',
      'review_need_to_be_approved' => 'Відгук потрібно схвалити перед показом на сторінці товару',
      'review_need_to_be_approved_help' => 'При увімкненні нові відгуки будуть приховані до схвалення адміністратором',
  ...
  [
    ...
    [
      ...
      'enable_order_deletion' => 'Увімкнути видалення замовлень',
      'enable_order_deletion_helper' => 'Якщо увімкнено, адміністратори можуть видаляти замовлення. Якщо вимкнено, замовлення можна лише змінювати за статусом, але не видаляти. Вимкніть для збереження всіх замовлень з метою аудиту, звітності та відповідності законодавству.',
  ...
  [
    ...
    [
      ...
      'enable_order_notes_at_checkout' => 'Увімкнути примітки до замовлення при оформленні',
      'enable_order_notes_at_checkout_helper' => 'Якщо увімкнено, клієнти можуть додавати необов\'язкові примітки до свого замовлення на сторінці оформлення (наприклад, спеціальні інструкції з доставки).',
    ],
  ],
  'return' =>
  [
    ...
    [
      ...
      'allow_customer_upload_image' => 'Дозволити клієнтам завантажувати зображення',
      'allow_customer_upload_image_help' => 'Дозволяє клієнтам завантажувати фотографії при подачі заявки на повернення.',
      'max_file_size' => 'Максимальний розмір файлу (МБ)',
      'max_file_size_help' => 'Максимальний розмір файлу зображення в мегабайтах.',
      'max_file_number' => 'Максимальна кількість зображень',
    ],
  ],
  'invoice' =>
  [
    ...
    'company_settings' => 'Налаштування рахунків',
    'company_settings_description' => 'Дані компанії, нумерація, шрифти PDF та штамп оплати',
    'form' =>
    [
      'company_name' => 'Назва компанії',
      'company_name_placeholder' => 'Acme Corporation',
      'company_name_helper' => 'Назва вашого бізнесу або компанії, яка відображатиметься на всіх рахунках, надісланих клієнтам.',
      'company_address' => 'Адреса компанії',
      'company_address_placeholder' => '123 Business Street, Suite 100, New York, NY 10001, USA',
      'company_address_helper' => 'Повна адреса вашої компанії, включаючи вулицю, місто, штат і країну. Вона відображатиметься на рахунках.',
      'company_zipcode' => 'Поштовий індекс компанії',
      'company_zipcode_placeholder' => '10001',
      'company_zipcode_helper' => 'Поштовий індекс адреси вашої компанії.',
      'company_email' => 'Email компанії',
      'company_email_placeholder' => 'billing@company.com',
      'company_email_helper' => 'Електронна адреса для ділових запитів. Клієнти можуть використовувати її для питань щодо рахунків.',
      'company_phone' => 'Телефон компанії',
      'company_phone_placeholder' => '+1 (555) 123-4567',
      'company_phone_helper' => 'Контактний номер телефону, який відображатиметься на рахунках для підтримки клієнтів.',
      'company_logo' => 'Логотип компанії',
      'company_logo_helper' => 'Логотип вашої компанії, який відображатиметься у верхній частині рахунків. Рекомендований розмір: 200x60 пікселів.',
      'company_tax_id' => 'Податковий номер компанії',
      'company_tax_id_placeholder' => 'VAT123456789',
      'company_tax_id_helper' => 'Податковий ідентифікаційний номер вашого бізнесу (ПДВ, GST, EIN тощо) для дотримання податкового законодавства.',
      'invoice_code_prefix' => 'Префікс коду рахунку',
      'invoice_code_prefix_placeholder' => 'INV-',
      'invoice_code_prefix_helper' => 'Префікс, що додається перед номерами рахунків (наприклад, INV- створить коди рахунків на кшталт INV-001, INV-002).',
      'using_custom_font_for_invoice' => 'Використовувати користувацький шрифт для рахунку',
      'using_custom_font_for_invoice_helper' => 'Увімкніть, щоб використовувати власний Google Font для PDF рахунків замість шрифту за замовчуванням.',
      'invoice_font_family' => 'Сімейство шрифтів рахунку (Тільки для латинської мови)',
      'invoice_font_family_helper' => 'Виберіть Google Font для використання в PDF рахунках. Працює лише з латинськими наборами символів.',
      'enable_invoice_stamp' => 'Увімкнути штамп рахунку',
      'enable_invoice_stamp_helper' => 'Додайте штамп PAID на рахунки, коли оплату замовлення завершено.',
      'add_language_support' => 'Додати підтримку мови',
      'add_language_support_helper' => 'Виберіть додаткову підтримку наборів символів для нелатинських мов у PDF рахунках.',
      'invoice_processing_library' => 'Бібліотека обробки рахунків',
      'invoice_processing_library_helper' => 'Виберіть бібліотеку генерації PDF. DomPDF швидший, але має обмежені можливості. mPDF підтримує більше мов і функцій, але може бути повільнішим.',
      ...
      'disable_order_invoice_until_order_confirmed_helper' => 'Коли увімкнено, рахунки будуть доступні лише після підтвердження замовлень, а не одразу після оформлення.',
      'date_format' => 'Формат дати',
      'date_format_helper' => 'Виберіть, як відображатимуться дати на рахунках (наприклад, F d, Y показує January 01, 2024).',
      'languages' =>
      [
        'arabic' => 'Арабська',
  ...
  [
    'name' => 'Податок',
    'description' => 'Розрахунок податків, опції відображення та поля рахунку при оформленні',
    ...
    'tax_setting' => 'Відображення податків та оформлення',
    'tax_setting_description' => 'Налаштуйте відображення податків на сторінках товарів та оформлення замовлення',
    'tax_management' => 'Управління податками',
    'tax_management_description' => 'Переглянути та керувати вашими податками',
    'manage_taxes_info' => 'Для керування податками та встановлення ставки податку за замовчуванням перейдіть до',
    'go_to_taxes' => 'Електронна комерція → Податки',
    'form' =>
    [
      ...
      'display_item_tax_at_checkout' => 'Показувати податок на товар при оформленні замовлення',
      'display_item_tax_at_checkout_helper' => 'Відображати суму податку (наприклад, «Податок: $10.00») для кожного товару на сторінці оформлення замовлення.',
      'tax_on_shipping_fee' => 'Застосувати податок на вартість доставки',
      'tax_on_shipping_fee_helper' => 'Коли увімкнено, ставка податку за замовчуванням буде застосована до вартості доставки. Переконайтеся, що ставка податку за замовчуванням налаштована в Електронна комерція → Податки.',
    ],
  ],
  'customer' =>
  [
  ...
  [
    'name' => 'Вебхуки',
    'description' => 'Надсилання подій замовлень до зовнішніх сервісів через HTTP',
    'webhook_setting' => 'Вебхуки подій замовлень',
    'webhook_setting_description' => 'Налаштуйте URL для отримання сповіщень при створенні, оновленні або відправці замовлень',
    'form' =>
    [
  ...
  [
    ...
    [
      ...
      'start_number' => 'Початковий номер',
      'start_number_description' => 'Нумерація замовлень починатиметься з цього значення',
      'order_number_length' => 'Довжина номера замовлення',
      'order_number_length_description' => 'Мінімальна кількість цифр у номері замовлення (наприклад, 3 відформатує 1 як 001)',
  ...
  'display_bank_info_at_the_checkout_success_page' => 'Відображати банківську інформацію на сторінці успіху оформлення?',
  'display_bank_info_at_the_checkout_success_page_helper' => 'Коли увімкнено, клієнти бачитимуть реквізити вашого банківського рахунку на сторінці підтвердження замовлення після оформлення. Це допомагає їм знати, куди переказати оплату.',
